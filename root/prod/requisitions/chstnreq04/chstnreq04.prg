...
;    *028 06/25/19 ccummin4				added new ambulatory positions		*
;     029 08/20/2019 Dawn Greer, DBA    Fix Future Orders Org Name blank    *
;                                       and fixing diagnosis issue          *
;~DE~************************************************************************
 
drop program chstnreq04:dba go
create program chstnreq04:dba
...
;028 start
declare 88_AMBULATORYPHYSICIANCARDIOLOGY_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANCARDIOLOGY"))

declare 88_AMBULATORYPHYSICIANCARDIOVASSURGERY_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANCARDIOVASSURGERY"))

declare 88_AMBULATORYPHYSICIANNEUROLOGY_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANNEUROLOGY"))

declare 88_AMBULATORYPHYSICIANGASTROENTEROLOGY_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANGASTROENTEROLOGY"))

declare 88_AMBULATORYPHYSICIANGENERALSURGERY_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANGENERALSURGERY"))

declare 88_AMBULATORYPHYSICIANNEUROSURGERY_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANNEUROSURGERY"))

declare 88_AMBULATORYPHYSICIANUROLOGY_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANUROLOGY"))

declare 88_AMBULATORYPHYSICIANPULMONOLOGY_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANPULMONOLOGY"))

declare 88_AMBULATORYPHYSICIANINFECTIOUSDIS_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANINFECTIOUSDIS"))

declare 88_AMBULATORYPHYSICIANWOMENSHEALTH_CD= f8 with protect, 
constant(uar_get_code_by ("DISPLAYKEY", 88,"AMBULATORYPHYSICIANWOMENSHEALTH"))

call echo(build(^88_AMBULATORYPHYSICIANCARDIOLOGY_CD=^,88_AMBULATORYPHYSICIANCARDIOLOGY_CD))
call echo(build(^88_AMBULATORYPHYSICIANCARDIOVASSURGERY_CD=^,88_AMBULATORYPHYSICIANCARDIOVASSURGERY_CD))
call echo(build(^88_AMBULATORYPHYSICIANNEUROLOGY_CD=^,88_AMBULATORYPHYSICIANNEUROLOGY_CD))
call echo(build(^88_AMBULATORYPHYSICIANGASTROENTEROLOGY_CD=^,88_AMBULATORYPHYSICIANGASTROENTEROLOGY_CD))
call echo(build(^88_AMBULATORYPHYSICIANGENERALSURGERY_CD=^,88_AMBULATORYPHYSICIANGENERALSURGERY_CD))
call echo(build(^88_AMBULATORYPHYSICIANNEUROSURGERY_CD=^,88_AMBULATORYPHYSICIANNEUROSURGERY_CD))
call echo(build(^88_AMBULATORYPHYSICIANUROLOGY_CD=^,88_AMBULATORYPHYSICIANUROLOGY_CD))
call echo(build(^88_AMBULATORYPHYSICIANPULMONOLOGY_CD=^,88_AMBULATORYPHYSICIANPULMONOLOGY_CD))
call echo(build(^88_AMBULATORYPHYSICIANINFECTIOUSDIS_CD=^,88_AMBULATORYPHYSICIANINFECTIOUSDIS_CD))
call echo(build(^88_AMBULATORYPHYSICIANWOMENSHEALTH_CD=^,88_AMBULATORYPHYSICIANWOMENSHEALTH_CD))
...
/* 029 - Fixing Future Order not showing Org Name */
/******************************************************************************
...
head o.order_id
 ...
 ;029 - Setting diag_code to blank if Future Order (will be updated later)
  If (o.encntr_id = 0.00)
    orders->qual[ord_cnt].diag_code = " "
  endif
     ...
     if(o.CATALOG_TYPE_CD = 6000_AMBULATORYPROCEDURES_CD)
        ...
        and pl2.POSITION_CD in (88_PHYSICIANCARDIOLOGY_CD
                   ...
                   orders->qual[ord_cnt].elec_signby=build2(orders->qual[ord_cnt].order_dr,"  NPI #:",orders->qual[ord_cnt].ord_npi)
                                ...
                                88_PHYSNEUROHOSPITALIST_CD,
                                88_PHYSGYNECOLOGYONCOLOGY_CD,
                                88_AMBULATORYPHYSICIANCARDIOLOGY_CD,
								88_AMBULATORYPHYSICIANCARDIOVASSURGERY_CD,
								88_AMBULATORYPHYSICIANNEUROLOGY_CD,
								88_AMBULATORYPHYSICIANGASTROENTEROLOGY_CD,
								88_AMBULATORYPHYSICIANGENERALSURGERY_CD,
								88_AMBULATORYPHYSICIANNEUROSURGERY_CD,
								88_AMBULATORYPHYSICIANUROLOGY_CD,
								88_AMBULATORYPHYSICIANPULMONOLOGY_CD,
								88_AMBULATORYPHYSICIANINFECTIOUSDIS_CD,							
								88_AMBULATORYPHYSICIANWOMENSHEALTH_CD
...
PLAN d1
JOIN ner WHERE ner.parent_entity_id = orders->qual[d1.seq].order_id
...
NER.parent_entity_id
 CALL ECHO (BUILD("Diag_Code ", orders->qual[d1.seq].diag_code))
 CALL ECHO (BUILD("Diag_Display ", diag.diagnosis_display))
	...
	IF (orders->qual[d1.seq].diag_code = " ")
		...
		ELSE orders->qual[d1.seq].diag_code = BUILD(diag.diagnosis_display, " (", nom.source_identifier, ")")
		ENDIF
	ELSE
		IF (diag.diagnosis_display = " ")
