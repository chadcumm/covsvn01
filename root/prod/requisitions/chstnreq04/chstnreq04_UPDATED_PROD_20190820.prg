...
head o.order_id
 ...
 ;023 start
 call echo(build2(^^))
 if (o.order_mnemonic = "DME *")
 	call echo(build2(^if (o.order_mnemonic = "DME *")^))
 	orders->dme_ind = 1
...
execute cpm_create_file_name "chstnormreq04","dat"
...
#exit_script
set last_mod = "026 08/20/2019 DG - Fix Future Orders Org Name blank and fixing diagnosis issue "
end
go
