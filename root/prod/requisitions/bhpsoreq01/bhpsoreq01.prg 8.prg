...
for (x = 1 to order_cnt)
	set orders->qual[x].elec_signby=build2(orders->qual[x].order_dr,"  NPI #:",orders->qual[x].ord_npi)
	set orders->qual[x].elec_signby2=build2(orders->qual[x].order_dr,"  NPI #:",orders->qual[x].ord_npi)
endfor
/******************************************************************************
