...
Tables Updated: Nonet
 
Scripts Executed: None
**************************************************************/
drop program idn_st_amb_meds_admin:dba go
create program idn_st_amb_meds_admin:dba
...
( 1 data[*]
    ...
    2 event_id = f8
    2 text = vc
    2 amb_lot_nbr = vc ;v4.0
    2 manufact = vc
    2 amb_substance_expire_date = vc ;v4.0
    2 admin_date = vc
    2 admin_dose = vc
    2 admin_dose_unt = vc
    2 admin_route = vc
...
;and cx.field_value != "1"
join od
where od.catalog_cd = cv.code_value
...
;  medsadmin_struc->data[medsCnt].amb_lot_nbr = trim(ce2.result_val)
;  medsadmin_struc->data[medsCnt].amb_substance_expire_date = trim(ce.result_val)
  ...
  medsadmin_struc->data[medsCnt].admin_start_tm = format(c.admin_start_dt_tm, "mm/dd/yyyy hh:mm")
  medsadmin_struc->data[medsCnt].admin_end_tm = format(c.admin_end_dt_tm, "mm/dd/yyyy hh:mm")
;   medsadmin_struc->data[medsCnt].event_cd = trim(ce.event_cd)
