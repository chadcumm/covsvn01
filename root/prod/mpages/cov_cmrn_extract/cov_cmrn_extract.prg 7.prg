...
set output_format = cnvtstring($OUTFMT)
...
elseif (output_format = 2)
	...
	select into $OUTDEV
		 alias 		= t_rec->qual[cnt].cmrn
		,last_name 	= t_rec->qual[cnt].name_last
		,first_name = t_rec->qual[cnt].name_first
		,middle_name= t_rec->qual[cnt].name_middle
		,birth_dt	= format(t_rec->qual[cnt].birth_dt_tm,"mm/dd/yy;;d")
		,person_id	= cnvtstring(t_rec->qual[cnt].person_id) 
	from
