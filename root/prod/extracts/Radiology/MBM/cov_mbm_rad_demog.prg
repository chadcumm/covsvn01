...
* -------	--- ----------	----------	-------------------------------------------------------------------------------*
			...
			008	07/06/2021	TAB			Adjusted default date range.
 
************************* END OF ALL MODCONTROL BLOCKS *****************************************************************/
 
 
DROP PROGRAM 	COV_MBM_RAD_DEMOG:dba GO
CREATE PROGRAM 	COV_MBM_RAD_DEMOG:dba
...
if (VALIDATE(request->batch_selection) = 1)
	SET iOpsInd = 1
 	SET START_DATE = DATETIMEFIND(CNVTDATETIME(CURDATE-1, 000000),'D','B','B') ;008
	SET END_DATE   = DATETIMEFIND(CNVTDATETIME(CURDATE-1, 235959),'D','B','E') ;008
else
