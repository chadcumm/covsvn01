...
******************************************************************************
	...
	Source file name:	cov_rm_PCP_Admit_Listing.prg
	Object name:		cov_rm_PCP_Admit_Listing
	Request #:			11991, 12488
 
	Program purpose:	Provides data for all admit patients.
 
	Executing from:		CCL
 
 	Special Notes:		Adopted from STAR SQL:
 							- QBCC_ADMIT_BY_PCP_RPT
...
DROP PROGRAM cov_rm_PCP_Admit_Listing:dba GO
CREATE PROGRAM cov_rm_PCP_Admit_Listing:dba
...
declare file_var			= vc with noconstant(build("admit_by_pcp_ccl", ".asc"))
...
where
	...
	and efh.encntr_type_cd not in (contract_var, prereg_var, scheduled_var, ed_var, quick_ed_var)
...
head page
	...
	row + 2
 	...
 	title = build2("Primary Care Physician Listing of All Admits for ", " ", start_date)
