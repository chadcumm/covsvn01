...
***********************************************************************************************
 ...
 0012  11/02/2021     Dawn Greer, DBA        CR 10902 - Added code to break out FLPC Walk In (FLPCW) clinic from
                                             Fort Loudoun Primary Care (FLPC).  This is based on the 
                                             resource.  Process was running an hour.  Split the Provider Group
                                             to get the Specialty to be a separate query.  This made the process
                                             run faster.
***********************************************************************************************/
