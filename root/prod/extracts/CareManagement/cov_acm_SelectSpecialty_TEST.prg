...
******************************************************************************
 	...
 	----------	--------------------	--------------------------------------
001	02/15/20222	Todd A. Blanchard		Changed qualifying timeframe from five
										to four days. 
******************************************************************************/
 
drop program cov_acm_SelectSpecialty_TEST:DBA go
create program cov_acm_SelectSpecialty_TEST:DBA
