ALTER PROCEDURE cov_ng_bcbs_shadow_supp_export_sp    
----------------------------------------------------------------------------------------------------------                                                                       
---                                                                        
--- Name: cov_ng_bcbs_shadow_supp_export_sp (was cov_humana_claim_recon_sp)                  
---                                                                        
--- Customer: Covenant                                                                        
...
---  09/01/2020 - DG - Changed the procedure name to cov_ng_bcbs_shadow_supp_export_sp from  
---  cov_ng_Humana_shadow_supp_export_sp   
...
WHERE c.claim_payer_name IN  ('BCBS Blue Advantage Medicare','BCBS Federal Employee Program',        
 'BCBS Medicare Supplement','BCBS Tn Bluecard Out Of State',                      
 'BCBS TN Network E','BCBS Tn Network K','BCBS TN Network P Exchange',        
 'BCBS TN Network S Exchange','BCBS Tn Preferred Network P','BCBS Tn Select Network S',        
 'Bluecare','Medicare Blue Advantage','Medicare BlueChoice Plus',                      
 'Blue Cross Cover TN','Blue Cross Of TN')                            
