...
******************************************************************************
	...
	Solution:			Ambulatory
	Source file name:	cov_humana_shadow_supp_export.prg
	Object name:		cov_humana_shadow_supp_export
	Request #:			7847
 
	Program purpose:	Export 48 Diagnosis to send to
						Humana for claim reconciliation.
...
******************************************************************************
 ...
 004 09/03/2020 Dawn Greer, DBA         Changed the file name
                                        from covenant_humana_cerner_shadow_supp_export
                                        to cov_cerner_humana_shadow_supp_export
 005 01/06/2021 Dawn Greer, DBA         Setup to run monthly for the previous month.
******************************************************************************/
 
drop program cov_humana_shadow_supp_export go
create program cov_humana_shadow_supp_export
...
DECLARE file_var			= vc WITH noconstant("cov_cerner_humana_shadow_supp_export_")
...
SET startdate = CNVTDATETIME('01-JAN-2020 00:00')
SET enddate = CNVTDATETIME(CURDATE-1,235959)
 
;  Set astream path
SET filepath_var = "/cerner/w_custom/p0665_cust/to_client_site/Extracts/Humana/Shadow_Supp/"
...
FROM ENCOUNTER enc
	...
	, (LEFT JOIN CHARGE_MOD cmmod ON (cmmod.charge_item_id = c.charge_item_id
