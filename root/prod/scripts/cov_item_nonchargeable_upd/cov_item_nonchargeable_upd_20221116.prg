...
006   11/16/2022   Dawn Greer, DBA      CR 13959 - Removed Instruments, Equipment,
                                        Medications, Procedure Charge from the 
                                        moim.class_name list.  Added 831200 Surgical 
                                        Instruments to the cvsub.display list.
******************************************************************************/
...
AND cvsub.display NOT IN ('800800' /*SUPPLIES - IMPLANT*/,
	...
	'831200' /*SURGICAL INSTRUMENTS*/)
AND moim.item_master_Id = im.item_id
AND moim.class_name IN ('IMPLANT','SUPPLY','SUPPLIES','TDC','SOLUTION')
AND id.active_ind = 1
