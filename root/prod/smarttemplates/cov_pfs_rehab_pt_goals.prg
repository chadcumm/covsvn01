...
******************************************************************************
	...
	Source file name:		cov_pfs_rehab_pt_goals.prg
	Object name:		cov_pfs_rehab_pt_goals
 
	Request#:			951(part of)
	Program purpose:		Alteration/Customization on Cerner source code as per Covenants need
 
	Executing from:		Smart template - PT Goals/PowerForm
 
 	Special Notes:      	Original Cerner Source : pfs_rehab_PT_goals
...
; Transfers were not showing up with old code...   
DECLARE tfr_g1_desc = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #1 Assist Level')), PROTECT
DECLARE tfr_g1_lvl = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #1 Comment')), PROTECT
DECLARE tfr_g1_dev = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #1 Descriptors')), PROTECT
DECLARE tfr_g1_stat = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #1 Device Utilized')), PROTECT
DECLARE tfr_g1_cmt = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #1 Status')), PROTECT
DECLARE tfr_g2_desc = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #2 Assist Level')), PROTECT
DECLARE tfr_g2_lvl = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #2 Comment')), PROTECT
DECLARE tfr_g2_dev = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #2 Descriptors')), PROTECT
DECLARE tfr_g2_stat = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #2 Device Utilized')), PROTECT
DECLARE tfr_g2_cmt = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #2 Status')), PROTECT
DECLARE tfr_g3_desc = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #3 Assist Level')), PROTECT
DECLARE tfr_g3_lvl = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #3 Comment')), PROTECT
DECLARE tfr_g3_dev = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #3 Descriptors')), PROTECT
DECLARE tfr_g3_stat = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #3 Device Utilized')), PROTECT
DECLARE tfr_g3_cmt = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #3 Status')), PROTECT
DECLARE tfr_g4_desc = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #4 Assist Level')), PROTECT
DECLARE tfr_g4_lvl = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #4 Comment')), PROTECT
DECLARE tfr_g4_dev = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #4 Descriptors')), PROTECT
DECLARE tfr_g4_stat = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #4 Device Utilized')), PROTECT
DECLARE tfr_g4_cmt = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #4 Status')), PROTECT
DECLARE tfr_g5_desc = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #5 Assist Level')), PROTECT
DECLARE tfr_g5_lvl = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #5 Comment')), PROTECT
DECLARE tfr_g5_dev = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #5 Descriptors')), PROTECT
DECLARE tfr_g5_stat = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #5 Device Utilized')), PROTECT
DECLARE tfr_g5_cmt = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #5 Status')), PROTECT
DECLARE tfr_g6_desc = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #6 Assist Level')), PROTECT
DECLARE tfr_g6_lvl = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #6 Comment')), PROTECT
DECLARE tfr_g6_dev = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #6 Descriptors')), PROTECT
DECLARE tfr_g6_stat = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #6 Device Utilized')), PROTECT
DECLARE tfr_g6_cmt = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #6 Status')), PROTECT
DECLARE tfr_g7_desc = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #7 Assist Level')), PROTECT
DECLARE tfr_g7_lvl = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #7 Comment')), PROTECT
DECLARE tfr_g7_dev = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #7 Descriptors')), PROTECT
DECLARE tfr_g7_stat = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #7 Device Utilized')), PROTECT
DECLARE tfr_g7_cmt = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #7 Status')), PROTECT
DECLARE tfr_g8_desc = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #8 Assist Level')), PROTECT
DECLARE tfr_g8_lvl = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #8 Comment')), PROTECT
DECLARE tfr_g8_dev = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #8 Descriptors')), PROTECT
DECLARE tfr_g8_stat = f8 WITH public ,constant (uar_get_code_by('DISPLAY', 72, 'Transfer Goal #8 Device Utilized')), PROTECT
DECLARE tfr_g8_cmt = f8 WITH public ,constant (uar_get_code_by ('DISPLAY', 72, 'Transfer Goal #8 Status')), PROTECT
 ...
 DECLARE rom_g1_rng    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL1RANGE')), PROTECT
 DECLARE rom_g1_rat    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL1RATIONALE')), PROTECT
 DECLARE rom_g1_tmfrm  = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL1TIMEFRAME')), PROTECT
 DECLARE rom_g1_stat   = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL1STATUS')), PROTECT
 DECLARE rom_g1_dtmet  = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL1DATEMET')), PROTECT
 DECLARE rom_g1_cmt    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL1COMMENTS')), PROTECT
 DECLARE rom_g2_desc   = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL2DESCRIPTOR')), PROTECT
 DECLARE rom_g2_astlvl = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL2ASSISTLEVEL')), PROTECT
 DECLARE rom_g2_rng    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL2RANGE')), PROTECT
 DECLARE rom_g2_rat    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL2RATIONALE')), PROTECT
 DECLARE rom_g2_tmfrm  = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL2TIMEFRAME')), PROTECT
 DECLARE rom_g2_stat   = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL2STATUS')), PROTECT
 DECLARE rom_g2_dtmet  = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL2DATEMET')), PROTECT
 DECLARE rom_g2_cmt    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL2COMMENTS')), PROTECT
 DECLARE rom_g3_desc   = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL3DESCRIPTOR')), PROTECT
 DECLARE rom_g3_astlvl = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL3ASSISTLEVEL')), PROTECT
 DECLARE rom_g3_rng    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL3RANGE')), PROTECT
 DECLARE rom_g3_rat    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL3RATIONALE')), PROTECT
 DECLARE rom_g3_tmfrm  = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL3TIMEFRAME')), PROTECT
 DECLARE rom_g3_stat   = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL3STATUS')), PROTECT
 DECLARE rom_g3_dtmet  = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL3DATEMET')), PROTECT
 DECLARE rom_g3_cmt    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'ROMGOAL3COMMENTS')), PROTECT
 DECLARE pte_g1_type   = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'PTTHERAPEUTICEXERCISEGOALTYPE1')), PROTECT
 DECLARE pte_g1_astlvl = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'PTTHERAPEUTICEXERCISEGOALASSIST1')), PROTECT
 DECLARE pte_g1_reps   = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'PTTHERAPEUTICEXERCISEGOALREPS1')), PROTECT
 DECLARE pte_g1_tmfrm  = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'PTTHERAPEUTICEXERCISEGOALTIMEFRAME1')), PROTECT
 DECLARE pte_g1_stat   = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'PTTHERAPEUTICEXERCISEGOALSTATUS1')), PROTECT
 DECLARE pte_g1_dtmet  = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'PTTHERAPEUTICEXERCISEGOALDATEMET1')), PROTECT
 DECLARE pte_g1_cmt    = f8 WITH CONSTANT(UAR_GET_CODE_BY('DISPLAYKEY', 72,'PTTHERAPEUTICEXERCISEGOALCOMMENT1')), PROTECT
  ...
  DETAIL
   IF ((first_dttm = "Y" ) )
    ...
    IF ((skip_flag = "N" ) )
     ...
     ENDIF
 	 ,  	;------- CR 951
     IF ((ce.event_cd IN (rom_g1_desc ,rom_g1_astlvl, rom_g1_rng, rom_g1_rat, rom_g1_tmfrm, rom_g1_stat, rom_g1_dtmet, rom_g1_cmt)))
     	CASE (ce.event_cd)
			OF rom_g1_desc :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[1].desc = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[1].desc = trim(ce.result_val)
		        ENDIF
			OF rom_g1_astlvl :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[1].astlvl = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[1].astlvl = trim(ce.result_val)
		        ENDIF
			OF rom_g1_rng :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[1].rng = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[1].rng = trim(ce.result_val)
		        ENDIF
			OF rom_g1_rat :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[1].rat = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[1].rat = trim(ce.result_val)
		        ENDIF
			OF rom_g1_tmfrm :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[1].tmfrm = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[1].tmfrm = trim(ce.result_val)
		        ENDIF
			OF rom_g1_stat :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[1].stat = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[1].stat = trim(ce.result_val)
		        ENDIF
			OF rom_g1_dtmet :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[1].dtmet = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[1].dtmet = trim(ce.result_val)
		        ENDIF
			OF rom_g1_cmt :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[1]cmt = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[1].cmt = trim(ce.result_val)
		        ENDIF
     	ENDCASE
     ENDIF
 	 ,
     IF ((ce.event_cd IN (rom_g2_desc ,rom_g2_astlvl, rom_g2_rng, rom_g2_rat, rom_g2_tmfrm, rom_g2_stat, rom_g2_dtmet, rom_g2_cmt)))
     	CASE (ce.event_cd)
			OF rom_g2_desc :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[2].desc = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[2].desc = trim(ce.result_val)
		        ENDIF
			OF rom_g2_astlvl :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[2].astlvl = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[2].astlvl = trim(ce.result_val)
		        ENDIF
			OF rom_g2_rng :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[2].rng = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[2].rng = trim(ce.result_val)
		        ENDIF
			OF rom_g2_rat :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[2].rat = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[2].rat = trim(ce.result_val)
		        ENDIF
			OF rom_g2_tmfrm :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[2].tmfrm = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[2].tmfrm = trim(ce.result_val)
		        ENDIF
			OF rom_g2_stat :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[2].stat = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[2].stat = trim(ce.result_val)
		        ENDIF
			OF rom_g2_dtmet :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[2].dtmet = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[2].dtmet = trim(ce.result_val)
		        ENDIF
			OF rom_g2_cmt :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[2]cmt = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[2].cmt = trim(ce.result_val)
		        ENDIF
     	ENDCASE
     ENDIF
     ,
     IF ((ce.event_cd IN (rom_g3_desc ,rom_g3_astlvl, rom_g3_rng, rom_g3_rat, rom_g3_tmfrm, rom_g3_stat, rom_g3_dtmet, rom_g3_cmt)))
     	CASE (ce.event_cd)
			OF rom_g3_desc :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[3].desc = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[3].desc = trim(ce.result_val)
		        ENDIF
			OF rom_g3_astlvl :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[3].astlvl = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[3].astlvl = trim(ce.result_val)
		        ENDIF
			OF rom_g3_rng :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[3].rng = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[3].rng = trim(ce.result_val)
		        ENDIF
			OF rom_g3_rat :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[3].rat = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[3].rat = trim(ce.result_val)
		        ENDIF
			OF rom_g3_tmfrm :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[3].tmfrm = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[3].tmfrm = trim(ce.result_val)
		        ENDIF
			OF rom_g3_stat :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[3].stat = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[3].stat = trim(ce.result_val)
		        ENDIF
			OF rom_g3_dtmet :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[3].dtmet = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[3].dtmet = trim(ce.result_val)
		        ENDIF
			OF rom_g3_cmt :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->rom[3].cmt = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->rom[3].cmt = trim(ce.result_val)
		        ENDIF
     	ENDCASE
     ENDIF
     ,
     IF ((ce.event_cd IN (pte_g1_type, pte_g1_astlvl, pte_g1_reps, pte_g1_tmfrm, pte_g1_stat, pte_g1_dtmet, pte_g1_cmt)))
     	CASE (ce.event_cd)
			OF pte_g1_type :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->pte[1].type = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->pte[1].type = trim(ce.result_val)
		        ENDIF
			OF pte_g1_astlvl :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->pte[1].astlvl = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->pte[1].astlvl = trim(ce.result_val)
		        ENDIF
			OF pte_g1_reps :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->pte[1].reps = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->pte[1].reps = trim(ce.result_val)
		        ENDIF
			OF pte_g1_tmfrm :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->pte[1].tmfrm = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->pte[1].tmfrm = trim(ce.result_val)
		        ENDIF
			OF pte_g1_stat :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->pte[1].stat = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->pte[1].stat = trim(ce.result_val)
		        ENDIF
			OF pte_g1_dtmet :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->pte[1].dtmet = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->pte[1].dtmet = trim(ce.result_val)
		        ENDIF
			OF pte_g1_cmt :
	            IF ((ce.result_status_cd IN (altered, modified ) ) )
	            	 out->pte[1].cmt = concat(trim(ce.result_val), " (modified)" )
		        ELSE
		             out->pte[1].cmt = trim(ce.result_val)
		        ENDIF
			ENDCASE
		ENDIF
    ;---------------------- 951
 ...
 ;Cov 951 ------------
 FOR (a = 1 to 3)
	  IF ((((out->rom[a].desc > "" )) OR ((((out->rom[a].astlvl > "" )) OR ((((out->rom[a ].rng > "" ))
 	  	OR ((((out->rom[a ].rat > "" )) OR ((((out->rom[a ].tmfrm > "" )) OR ((((out->rom[a ].stat > "" ))
 	  	OR ((((out->rom[a ].dtmet > "" )) OR ((out->rom[a ].cmt > "" ) )) )) )) )) )) )) )) )
 
		SET first = "Y"
		SET reply->text = concat(reply->text ,wb ,"ROM Goal #" ,cnvtstring (a ,1 ,0 ,l ) ,":" )
		...
		ENDIF
  	    IF ((out->rom[a].astlvl > "" ) )
		    IF ((first = "Y" ) )
		     ...
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->rom[a].astlvl )
		    ENDIF
	    ENDIF
  	    IF ((out->rom[a].rng > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->rom[a].rng )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->rom[a].rng )
		    ENDIF
	    ENDIF
  	    IF ((out->rom[a].rat > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->rom[a].rat )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->rom[a].rat )
		    ENDIF
	    ENDIF
  	    IF ((out->rom[a].tmfrm > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->rom[a].tmfrm )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->rom[a].tmfrm )
		    ENDIF
	    ENDIF
  	    IF ((out->rom[a].stat > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->rom[a].stat )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->rom[a].stat )
		    ENDIF
	    ENDIF
  	    IF ((out->rom[a].dtmet > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->rom[a].dtmet )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->rom[a].dtmet )
		    ENDIF
	    ENDIF
  	    IF ((out->rom[a].cmt > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->rom[a].cmt )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->rom[a].cmt )
		    ENDIF
	    ENDIF
		SET reply->text = CONCAT(reply->text, reol)
	ENDIF
  ...
  FOR(a = 1 TO 1)
	IF ((((out->pte[a].type > "" )) OR ((((out->pte[a].astlvl > "" ))
 	  	OR ((((out->pte[a].reps > "" )) OR ((((out->pte[a].tmfrm > "" )) OR ((((out->pte[a].stat > "" ))
 	  	OR ((((out->pte[a].dtmet > "" )) OR ((out->pte[a].cmt > "" ) )) )) )) )) )) )) )
 
		SET first = "Y"
		SET reply->text = concat(reply->text ,wb ,"Therap Ex Goal #" ,cnvtstring (a ,1 ,0 ,l ) ,":" )
 
		IF ((out->pte[a].type > "" ) )
			SET reply->text = concat (reply->text ," " ,wr ,out->pte[a].type )
		    SET first = "N"
		ENDIF
  	    IF ((out->pte[a].astlvl > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->pte[a].astlvl )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->pte[a].astlvl )
		    ENDIF
	    ENDIF
  	    IF ((out->pte[a].reps > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->pte[a].reps )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->pte[a].reps )
		    ENDIF
	    ENDIF
  	    IF ((out->pte[a].tmfrm > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->pte[a].tmfrm )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->pte[a].tmfrm )
		    ENDIF
	    ENDIF
  	    IF ((out->pte[a].stat > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->pte[a].stat )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->pte[a].stat )
		    ENDIF
	    ENDIF
  	    IF ((out->pte[a].dtmet > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->pte[a].dtmet )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->pte[a].dtmet )
		    ENDIF
	    ENDIF
  	    IF ((out->pte[a].cmt > "" ) )
		    IF ((first = "Y" ) )
		     SET reply->text = concat (reply->text ," " ,wr ,out->pte[a].cmt )
		     SET first = "N"
		    ELSE
		     SET reply->text = concat (reply->text ,"; " ,out->pte[a].cmt )
		    ENDIF
	    ENDIF
		SET reply->text = concat(reply->text, reol)
	ENDIF
