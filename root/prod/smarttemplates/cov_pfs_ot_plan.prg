...
******************************************************************************
	...
	Source file name:	cov_pfs_ot_plan.prg
	Object name:		cov_pfs_ot_plan
	...
	Executing from:		Smart template - Plan Review/PowerForm
 	...
 	Special Notes:      Original Cerner Source : pfs_OT_plan
...
DROP PROGRAM cov_pfs_ot_plan :dba GO
CREATE PROGRAM cov_pfs_ot_plan :dba
 ...
 ;---CR 951 update
 DECLARE frequency_acute  = f8 WITH public ,constant (uar_get_code_by("DISPLAY", 72, 'OT Frequency Rehab Acute'))
 DECLARE duration_acute   = f8 WITH public ,constant (uar_get_code_by("DISPLAY", 72, 'OT Duration Acute') )
 DECLARE treatment_acute  = f8 WITH public ,constant (uar_get_code_by("DISPLAY", 72, 'OT Anticipated Treatments, Needs Acute') )
 ;-------------------
