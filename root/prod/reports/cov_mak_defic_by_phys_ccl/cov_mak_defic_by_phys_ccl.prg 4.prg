...
with OUTDEV, ORGANIZATIONS, PHYSICIANS, DEF_CHECK
...
if (t_rec->def_check = 0) or (t_rec->def_check = 1))
...
detail
	...
	if (validate(data->qual[d.seq]->defic_qual[ddefic.seq]->order_qual[1]->order_notif_order_notification_id) = 1)
...
select into "nl:"
	...
	,discharge_dt_tm = t_rec->qual[d.seq].discharge_dt_tm
