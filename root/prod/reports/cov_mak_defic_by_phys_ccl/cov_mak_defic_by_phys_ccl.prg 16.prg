...
select into $OUTDEV ;into "nl:"
	...
	,physician_name = substrin(1,50,t_rec->qual[d.seq].physician_name)
	...
	,ordering_prsnl = t_rec->qual[d.seq].ordering_prsnl_name
	,ordering_comm_type = t_rec->qual[d.seq].communication_type
