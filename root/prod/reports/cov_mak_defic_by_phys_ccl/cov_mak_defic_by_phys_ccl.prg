...
from
    ...
    ,prsnl_alias pa
plan d
where data->qual[d.seq].disch_dt_tm between cnvtdatetime($start_datetime) and cnvtdatetime($end_datetime) ;002
join pa
...
and data->qual[d.seq].disch_dt_tm between cnvtdatetime($start_datetime) and cnvtdatetime($end_datetime)) ;002
...
and data->qual[d1.seq].disch_dt_tm between cnvtdatetime($start_datetime) and cnvtdatetime($end_datetime) ;002
