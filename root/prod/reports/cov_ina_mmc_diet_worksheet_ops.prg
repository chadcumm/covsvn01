...
drop program cov_ina_mmc_ws_ops:dba go
create program cov_ina_mmc_ws_ops:dba
...
declare filename_var = vc WITH noconstant(CONCAT('cer_temp:', 'mmc_diet_worksheet.pdf')), PROTECT
declare ccl_filepath_var = vc WITH noconstant(CONCAT('$cer_temp/', 'mmc_diet_worksheet.pdf')), PROTECT
...
if(iOpsInd = 1)
	execute cov_ina_diet_worksheet_lyt VALUE(filename_var), VALUE(2552503613.00)
