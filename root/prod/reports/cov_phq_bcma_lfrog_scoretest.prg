...
******************************************************************************
	...
	Executing from:		DA2
 	Special Notes:		Copy of above report to test - 5/10/22
...
05/03/22    Geetha       CR#10558 - Exclude patients own home meds - Removed from script for testing - 05/10/22
 
******************************************************************************/
 
drop program cov_phq_bcma_lfrog_scoretest:DBA go
create program cov_phq_bcma_lfrog_scoretest:DBA
