...
drop program ccummin4_cpoe_report_prsnl2:dba go
create program ccummin4_cpoe_report_prsnl2:dba
...
with OUTDEV, start_datetime, end_datetime, prsnl
...
; ,2576706321.00	;Per Nutrition Policy No Cosign
	...
	and p2.username =$prsnl; specific Dr.
