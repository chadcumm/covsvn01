...
******************************************************************************
	...
	Source file name:  	cov_pain_reassessment_4hrs.prg
	Object name:		cov_pain_reassessment_4hrs
	Request#:			1201
...
drop program cov_pain_reassessment_4hrs:DBA go
create program cov_pain_reassessment_4hrs:DBA
...
,(	(select distinct e.person_id, e.encntr_id, nurse_unit = e.loc_nurse_unit_cd
		...
		and ce.event_end_dt_tm between cnvtdatetime($start_datetime) and cnvtdatetime($end_datetime)
	      ...
	      and od.oe_field_display_value = '*pain*'
...
select distinct into value($outdev)
	...
	, time_between_medgiven_nextpainscore = format(pain->plist[d1.seq].olist[d2.seq].diff_medgiven_painscale, "###.##:##")
