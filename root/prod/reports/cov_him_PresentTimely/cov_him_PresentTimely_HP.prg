...
drop program cov_him_PresentTimely_HP:dba go
create program cov_him_PresentTimely_HP:dba
...
;			where
;				ea.encntr_alias_type_cd = 1077.00
;				and ea.alias in (
;					"2115701544",
;					"2115211046",
;					"2115400117",
...
if (hpdata->cnt > 0) ;002
	...
	; populate record structure	
	head o.encntr_id
		hpdata->qual[d1.seq].order_id				= o.order_id
		hpdata->qual[d1.seq].catalog_cd				= o.catalog_cd
		hpdata->qual[d1.seq].oe_field_dt_tm_value	= od.oe_field_dt_tm_value
...
if (hpdata->cnt > 0) ;002
	...
	; populate record structure	
	head o.encntr_id
		if (o.catalog_cd = psoobservation_var)
			hpdata->qual[d1.seq].order_id				= o.order_id
			hpdata->qual[d1.seq].catalog_cd				= o.catalog_cd
			hpdata->qual[d1.seq].oe_field_dt_tm_value	= od.oe_field_dt_tm_value
...
;	, encntr_id				= hpdata->qual[d1.seq].encntr_id
	...
	; order
	, order_id				= hpdata->qual[d1.seq].order_id
	, catalog				= uar_get_code_display(hpdata->qual[d1.seq].catalog_cd)
	, order_dt_tm			= hpdata->qual[d1.seq].oe_field_dt_tm_value "mm/dd/yyyy hh:mm;;q"
