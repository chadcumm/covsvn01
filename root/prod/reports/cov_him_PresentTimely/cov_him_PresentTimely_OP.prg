...
drop program cov_him_PresentTimely_OP:dba go
create program cov_him_PresentTimely_OP:dba
...
declare intraoprecord_var			= f8 with constant(uar_get_code_by("DISPLAY_KEY", 93, "INTRAOPERATIVERECORD"))
declare surgicaldocs_var			= f8 with constant(uar_get_code_by("DISPLAYKEY", 93, "SURGICALDOCUMENTATION"))
declare provider_var				= f8 with constant(uar_get_code_by("DISPLAY_KEY", 254571, "PROVIDER"))
...
;	, pacu2_end_dt_tm		= ct3.case_time_dt_tm
;	, pacu2_tz				= ct3.case_time_tz	
...
;	and sc.encntr_id in (125085707, 125425623) ; TODO: TESTING
...
;	opdata->qual[cnt].surg[scnt].pacu2_end_dt_tm				= ct3.case_time_dt_tm
;	opdata->qual[cnt].surg[scnt].pacu2_tz						= ct3.case_time_tz
...
where
	...
	and maxrec(d4, opdata->qual[d1.seq].op_cnt)
	...
	if (not opdata->qual[d1.seq].is_anticipated)
		if (opdata->qual[d1.seq].has_intraop)
			if (opdata->qual[d1.seq].has_op)
				if (not opdata->qual[d1.seq].op[d4.seq].is_scanned)	
					if (opdata->qual[d1.seq].surg[d2.seq].surgeon_prsnl_id = opdata->qual[d1.seq].op[d4.seq].performed_prsnl_id)
						; for compliance
						if (opdata->qual[d1.seq].op[d4.seq].op_dt_tm < opdata->qual[d1.seq].surg[d2.seq].surg_start_dt_tm)
							opdata->qual[d1.seq].op[d4.seq].prior_to_surgery = 1
						endif
						
						if ((opdata->qual[d1.seq].op[d4.seq].op_dt_tm >= opdata->qual[d1.seq].surg[d2.seq].surg_start_dt_tm) and
							(datetimediff(opdata->qual[d1.seq].op[d4.seq].op_dt_tm, 
										  opdata->qual[d1.seq].surg[d2.seq].surg_stop_dt_tm, 3) <= 4))
										  
							opdata->qual[d1.seq].op[d4.seq].complete_within_four_hours = 1
						endif						
						
						if (opdata->qual[d1.seq].op[d4.seq].op_dt_tm < opdata->qual[d1.seq].surg[d2.seq].pacu_dt_tm)							
							opdata->qual[d1.seq].op[d4.seq].performed_prior_to_pacu = 1
						endif
	
						if (opdata->qual[d1.seq].op[d4.seq].modified_dt_tm > 0)
							if ((opdata->qual[d1.seq].op[d4.seq].modified_dt_tm >= opdata->qual[d1.seq].surg[d2.seq].surg_start_dt_tm) and
								(datetimediff(opdata->qual[d1.seq].op[d4.seq].modified_dt_tm, 
											  opdata->qual[d1.seq].surg[d2.seq].surg_stop_dt_tm, 3) <= 4))
											 
								opdata->qual[d1.seq].op[d4.seq].modified_within_four_hours = 1
							endif
							
							if (opdata->qual[d1.seq].op[d4.seq].modified_dt_tm < opdata->qual[d1.seq].surg[d2.seq].pacu_dt_tm)
								opdata->qual[d1.seq].op[d4.seq].modified_prior_to_pacu = 1
							endif
						endif

						; for display
						if (opdata->qual[d1.seq].op[d4.seq].result_dt_tm >= opdata->qual[d1.seq].surg[d2.seq].surg_start_dt_tm)
							opdata->qual[d1.seq].op[d4.seq].surg_case_id = opdata->qual[d1.seq].surg[d2.seq].surg_case_id
						endif
					endif
	
					if ((opdata->qual[d1.seq].op[d4.seq].surg_case_id = 0.0) and (opdata->qual[d1.seq].surg_cnt = 1))
						opdata->qual[d1.seq].op[d4.seq].surg_case_id = opdata->qual[d1.seq].surg[d2.seq].surg_case_id
					endif
				
					if (opdata->qual[d1.seq].op[d4.seq].surg_case_id = opdata->qual[d1.seq].surg[d2.seq].surg_case_id)
						if ((opdata->qual[d1.seq].op[d4.seq].complete_within_four_hours) or 
							(opdata->qual[d1.seq].op[d4.seq].modified_within_four_hours))
							
							opdata->qual[d1.seq].op[d4.seq].is_compliant = 1
						endif

						if ((opdata->qual[d1.seq].op[d4.seq].performed_prior_to_pacu) or 
							(opdata->qual[d1.seq].op[d4.seq].modified_prior_to_pacu))
							
							opdata->qual[d1.seq].op[d4.seq].is_tjc_compliant = 1
						endif
					endif
				endif
			endif
...
join d4
where
	opdata->qual[d1.seq].op[d4.seq].is_scanned = 0
	and opdata->qual[d1.seq].op[d4.seq].surg_case_id = opdata->qual[d1.seq].surg[d2.seq].surg_case_id
	and opdata->qual[d1.seq].op[d4.seq].performed_prsnl_id = opdata->qual[d1.seq].surg[d2.seq].surgeon_prsnl_id
;	and opdata->qual[d1.seq].op[d4.seq].op_dt >= opdata->qual[d1.seq].surg[d2.seq].surg_stop_dt
;	and (
;		datetimediff(opdata->qual[d1.seq].op[d4.seq].op_dt_tm, opdata->qual[d1.seq].surg[d2.seq].surg_stop_dt_tm, 3) <= 24
;		and (
;			opdata->qual[d1.seq].op[d4.seq].complete_within_four_hours
;			or opdata->qual[d1.seq].op[d4.seq].modified_within_four_hours
;		)
;	)
...
detail
	...
	if (opdata->qual[d1.seq].surg[d2.seq].surg_case_id = opdata->qual[d1.seq].op[d4.seq].surg_case_id)
		finaldata->qual[cnt].compliant_ind			= opdata->qual[d1.seq].op[d4.seq].is_compliant
		finaldata->qual[cnt].tjc_compliant_ind		= opdata->qual[d1.seq].op[d4.seq].is_tjc_compliant
	endif
...
;	finaldata->qual[cnt].pacu2_tz				= opdata->qual[d1.seq].surg[d2.seq].pacu2_tz
	...
	; operative
	if (opdata->qual[d1.seq].surg[d2.seq].surg_case_id = opdata->qual[d1.seq].op[d4.seq].surg_case_id)
		finaldata->qual[cnt].op_event_cd						= opdata->qual[d1.seq].op[d4.seq].event_cd
		finaldata->qual[cnt].op_performed_dt_tm					= opdata->qual[d1.seq].op[d4.seq].performed_dt_tm
		finaldata->qual[cnt].op_performed_tz					= opdata->qual[d1.seq].op[d4.seq].performed_tz
		finaldata->qual[cnt].op_performed_prsnl_id				= opdata->qual[d1.seq].op[d4.seq].performed_prsnl_id
		finaldata->qual[cnt].op_performed_by					= opdata->qual[d1.seq].op[d4.seq].performed_by
		finaldata->qual[cnt].op_modified_dt_tm					= opdata->qual[d1.seq].op[d4.seq].modified_dt_tm
		finaldata->qual[cnt].op_modified_tz						= opdata->qual[d1.seq].op[d4.seq].modified_tz
		finaldata->qual[cnt].op_modified_prsnl_id				= opdata->qual[d1.seq].op[d4.seq].modified_prsnl_id
		finaldata->qual[cnt].op_modified_by						= opdata->qual[d1.seq].op[d4.seq].modified_by
		finaldata->qual[cnt].op_result_status_cd				= opdata->qual[d1.seq].op[d4.seq].result_status_cd
		finaldata->qual[cnt].op_result_dt_tm					= opdata->qual[d1.seq].op[d4.seq].result_dt_tm
		finaldata->qual[cnt].op_result_tz						= opdata->qual[d1.seq].op[d4.seq].result_tz
		finaldata->qual[cnt].op_complete_within_four_hours		= opdata->qual[d1.seq].op[d4.seq].complete_within_four_hours
		finaldata->qual[cnt].op_modified_within_four_hours		= opdata->qual[d1.seq].op[d4.seq].modified_within_four_hours
		finaldata->qual[cnt].op_prior_to_surgery				= opdata->qual[d1.seq].op[d4.seq].prior_to_surgery
		finaldata->qual[cnt].op_performed_prior_to_pacu			= opdata->qual[d1.seq].op[d4.seq].performed_prior_to_pacu
		finaldata->qual[cnt].op_modified_prior_to_pacu			= opdata->qual[d1.seq].op[d4.seq].modified_prior_to_pacu
	endif
