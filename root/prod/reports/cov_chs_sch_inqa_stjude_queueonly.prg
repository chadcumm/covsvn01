...
Source File		:	cov_chs_sch_inqa_stjude_queueonly.prg
Object Name		:	chs_sch_inqa_stjude_queueonly
...
002		08/15/2018	Todd A. Blanchard		CR 3058
003		08/16/2018	Todd A. Blanchard		CR 3046
...
DROP PROGRAM chs_sch_inqa_stjude_queueonly :dba GO
CREATE PROGRAM chs_sch_inqa_stjude_queueonly :dba
 ...
 IF ((cs23010_disppidrl_cd > 0.0 ) )
  ...
  ;end select
 ENDIF
 SET reply->attr_qual_cnt = 30 ; limit of 30 columns
...
ENDFOR
 ...
 SELECT INTO "nl:"
  ...
  PLAN (d )
   ...
   AND (od.oe_field_id = oefieldid_authnumber ) )
 ...
 IF ((t_record->max_order_cnt > 0 ) )
  ...
  SELECT INTO "nl:"
   ...
   PLAN (d )
    ...
    AND (od.oe_field_meaning_id IN (127 ,
    3519 ,
    3520 ,
    3521 ,
    3522 ,
 ...
 IF ((pref_value_disppidrl = 1.0 ) )
  SELECT INTO "nl:"
   ...
   val_healthplan =  substring(1,25,reply->query_qual[d.seq].healthplan),
