...
**************************************************************************************************
	...
	Solution:
	Source file name:  	cov_idn_rx_active_order_rpt.prg
	Object name:		cov_idn_rx_active_order_rpt
	CR#:
...
DROP PROGRAM cov_idn_rx_active_order_rpt :dba GO
CREATE PROGRAM cov_idn_rx_active_order_rpt :dba
