...
SELECT DISTINCT into $OUTDEV
                ...
                , ACKNOWLEDGE = OD4.oe_field_display_value
                ...
                , COMPLETED_ENCNTR_TYPE = UAR_GET_CODE_DISPLAY(E.ENCNTR_TYPE_CD)
                , ORDERING_ENCNTR_TYPE = UAR_GET_CODE_DISPLAY(E2.ENCNTR_TYPE_CD)
...
JOIN E2 WHERE outerjoin (o.originating_encntr_id) = E2.encntr_id
...
and od4.oe_field_id = outerjoin (2555451309) ;ACHKNOWLEDGE
...
WITH MAXREC = 1000, NOCOUNTER, SEPARATOR=" ", FORMAT, TIME = 600
