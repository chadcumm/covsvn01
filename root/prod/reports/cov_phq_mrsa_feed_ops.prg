...
******************************************************************************
	...
	Solution:			Quality
	Source file name:	      cov_phq_mrsa_feed_ops.prg
	Object name:		cov_phq_mrsa_feed_ops
	Request#:			9964
	Program purpose:	      MRSA Reduction Project
	Executing from:		DA2
...
drop program cov_phq_mrsa_feed_ops:dba go
create program cov_phq_mrsa_feed_ops:dba
...
;Look back 3 days 
set start_date = cnvtlookbehind("3,D")
set start_date = datetimefind(start_date,"D","B","B")
set end_date   = cnvtlookahead("1,D",start_date)
set end_date   = cnvtlookbehind("1,SEC", end_date)
...
;Everyday live as of 8/06/21 (including 08/06 data);Look back 3 days from 8/18
...
;set up for data back load - completed on 8/17 (data loaded 6/1 - 8/5)
;EXECUTE cov_phq_mrsa_hist_load "mine", "21-JUL-2021 00:00:00", "05-AUG-2021 23:59:00",
;	value(2552503635.00, 21250403.00,2552503653.00,2552503639.00,2552503613.00,2552503645.00,2552503649.00), 0
