...
drop program cov_amb_bcma_pat_level:DBA go
create program cov_amb_bcma_pat_level:DBA
...
select into $outdev
 ...
 ;clinic_loc = org.org_name ;uar_get_code_description(e.location_cd)
  ;facility = trim(uar_get_code_description(l.facility_accn_prefix_cd))
   e.encntr_id ,o.order_id, op.item_id, mae.event_id
...
plan e where e.active_ind = 1
	and operator(e.organization_id, opr_clinic_var, $clinic)
	and e.active_ind = 1
...
Head mae.event_id
	...
	;bcma->plist[cnt].clinic = clinic_loc
