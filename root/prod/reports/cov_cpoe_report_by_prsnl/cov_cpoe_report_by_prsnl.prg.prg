...
with OUTDEV, START_DATETIME, END_DATETIME, NEW_PROVIDER
...
/*	and e.encntr_type_cd in(
 ...
 ,2555137051.00	Behavioral Health
	...
	*/
	...
	and e.active_ind = 1
	;UPDATED FOR AMBULATORY and e.encntr_id != 0.00
	;UPDATED FOR AMBULATORY and o.encntr_id = e.encntr_id
...
; ,2576706321.00	;Per Nutrition Policy No Cosign
	...
	and p2.person_id =$NEW_PROVIDER; specific Dr.
