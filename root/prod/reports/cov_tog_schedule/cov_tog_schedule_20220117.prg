...
(
	...
	1	qual[*]
		...
		2	home_phone		=	c15
		2	mobile_phone 	=	c15
		2   street_address1 =   c50		;003
		2   street_address2 =   c50 	;003
		2   City            =   c50		;003
		2   State           =   c2		;003
		2   zipcode         =   c10		;003
		2	insurance		=	c50
...
,Mobile_Phone = EVALUATE2(IF (SIZE(TRIM(mphone.phone_num,3)) = 10)
	...
	ELSE " " ENDIF)
,Street_Address1 = TRIM(addr.street_addr,3)
,Street_Address2 = TRIM(addr.street_addr2,3)
,City = TRIM(addr.city,3)
,State = TRIM(addr.state,3)
,Zipcode = TRIM(addr.zipcode,3)
...
DETAIL
	...
	a->qual[cnt].street_address1 =  street_address1
	a->qual[cnt].street_address2 =  street_address2
	a->qual[cnt].City           =   City
	a->qual[cnt].State          =   State
	a->qual[cnt].ZipCode       =   ZipCode
...
ELSE		;Detail Report
	...
	SELECT INTO $outdev
		...
		Street_Address_1 = a->qual[d.seq].street_address1,
		Street_Address_2 = a->qual[d.seq].street_address2,
		City = a->qual[d.seq].City,
		State = a->qual[d.seq].State,
		Zip_Code = a->qual[d.seq].ZipCode,
