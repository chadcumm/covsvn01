...
******************************************************************************
	...
	Solution:			Pharmacy
	Source file name:  	cov_pha_glucose_hist_load.prg
	Object name:		cov_pha_glucose_hist_load
	Request#:			13889
	Program purpose:	      Glucose feed set up to Strata
	Executing from:		Ops
  	Special Notes:          Historical Load
...
11/10/22   Geetha               Historical Load - only on glucose lvl
******************************************************************************/
 
drop program cov_pha_glucose_hist_load:dba go
create program cov_pha_glucose_hist_load:dba
...
declare filename_var = vc WITH constant('cer_temp:glucose_lvl_jan_nov.txt'), PROTECT
declare ccl_filepath_var = vc WITH constant('$cer_temp/glucose_lvl_jan_nov.txt'), PROTECT
...
join ce where ce.person_id = e.person_id
	...
	and ce.result_val != " "
	and ce.event_cd = glucose_lvl_var
		;in(glucose_poc_var, glucose_art_var, glucose_lvl_var, blood_glucose_var)
