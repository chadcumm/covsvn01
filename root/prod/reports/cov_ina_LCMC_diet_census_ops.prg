...
drop program cov_ina_LCMC_cs_ops:dba go
create program cov_ina_LCMC_cs_ops:dba
...
declare filename_var = vc WITH noconstant(CONCAT('cer_temp:', 'lcmc_diet_census.pdf')), PROTECT
declare ccl_filepath_var = vc WITH noconstant(CONCAT('$cer_temp/', 'lcmc_diet_census.pdf')), PROTECT
...
if(iOpsInd = 1)
	execute cov_ina_dietcensus_lb VALUE(filename_var), VALUE(2552503653.00)
