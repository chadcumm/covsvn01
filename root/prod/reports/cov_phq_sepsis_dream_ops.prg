...
******************************************************************************
	...
	Solution:			Quality
	Source file name:	      cov_phq_sepsis_dream_ops.prg
	Object name:		cov_phq_sepsis_dream_ops
	Request#:			3176
	Program purpose:	      Sepsis analysis
	Executing from:		DA2
 	Special Notes:          Feed to Spotfire
...
drop program cov_phq_sepsis_dream_ops:dba go
create program cov_phq_sepsis_dream_ops:dba
...
and l.active_ind = 1
and l.location_cd in(2552503635.00, 21250403.00,2552503653.00,2552503639.00,2552503613.00,2552503645.00,2552503649.00) ;no pbh
...
;All Facilities togather since there are not much data for sepsis (no pbh)
 
;Everyday live as of 8/12/19
EXECUTE cov_phq_sepsis_dream "mine", start_date, end_date,
	 value(2552503635.00, 21250403.00,2552503653.00,2552503639.00,2552503613.00,2552503645.00,2552503649.00), 0
 
/*;set up for data back load - new logic as of Aug'2019
EXECUTE cov_phq_sepsis_dream "mine", "01-AUG-2019 00:00:00", "11-AUG-2019 23:59:00",
	value(2552503635.00, 21250403.00,2552503653.00,2552503639.00,2552503613.00,2552503645.00,2552503649.00), 0*/
