...
******************************************************************************
	...
	Source file name:  	based on :COV_PHQ_RESTRAINT_DOCLOG.prg
	Object name:		based on :COV_PHQ_RESTRAINT_DOCLOG
	Request#:			1045
...
drop program COV_PHQ_RESTRAINT_DOCLOG:DBA go
create program COV_PHQ_RESTRAINT_DOCLOG:DBA
