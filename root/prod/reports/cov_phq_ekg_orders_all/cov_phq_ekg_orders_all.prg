...
******************************************************************************
	...
	Solution:			Quality
	Source file name:	      COV_PHQ_EKG_ORDERS_ALL.prg
	Object name:		COV_PHQ_EKG_ORDERS_ALL
	Request#:			
...
drop program COV_PHQ_EKG_ORDERS_ALL:dba go
create program COV_PHQ_EKG_ORDERS_ALL:dba
