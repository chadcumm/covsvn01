...
drop program cov_sm_Order_Appt_Modify_TEST:DBA go
create program cov_sm_Order_Appt_Modify_TEST:DBA
...
execute cov_sm_Order_Appt_TAT_TEST $OUTDEV, $start_datetime, $end_datetime, $report_type, 0
