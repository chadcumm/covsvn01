...
******************************************************************************
	...
	Solution:			Quality
	Source file name:  	cov_phq_mobile_transport_data.prg
	Object name:		cov_phq_mobile_transport_data
	Request#:			7259
 	Program purpose:	      CCL for Mobile Transport App(regular excel format to validate)
	Executing from:		DA2
  	Special Notes:
...
drop program cov_phq_mobile_transport_data:dba go
create program cov_phq_mobile_transport_data:dba
