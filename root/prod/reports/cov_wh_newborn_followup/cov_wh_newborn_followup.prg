 			...
 			where ea.alias = $FIN
				...
				and ce.event_cd in (
					...
					mom_drug_scrn_var, preg_risk_var, med_preg_var, preg_risk_other_var, preg_risk_dtl_var,
	 			  	ega_var, rubella_var, rpr_var, hepatitis_c_var, hsv_var, hiv_var, gonorhea_var, chlamydia_var, tobacco_var,
					drug_var, marijuana_var, dcs_nitified_var, rom_dt_var, rom_deli_tot_var, lngh_rom_var, deli_anes_var,
					med_labor_var, dt_norcotic_var, name_abx_var, ld_complica_var, vmin_K_var, hep_b_var, abx_eye_var, hbig_var
				  ) ;002 005
