...
******************************************************************************
	...
	Source file name:	      cov_bh_initial_psych_assment.prg
	Object name:		cov_bh_initial_psych_assment
	Request#:			10768
	Program purpose:	      Initial Psych Assessments Compliance Report
	Executing from:		DA2
 	Special Notes:
...
drop program cov_bh_initial_psych_assment:dba go
create program cov_bh_initial_psych_assment:dba
...
declare  psych_form_var      = f8 with constant(uar_get_code_by("DESCRIPTION", 72, 'Behavioral Health Initial Psych Assessment')), protect

; 2561997815.00	         72		Behavioral Health Initial Psych Assessme
...
, form = trim(uar_get_code_description(ce.event_cd)) 
, patient_type = trim(uar_get_code_display(e.encntr_type_cd))
