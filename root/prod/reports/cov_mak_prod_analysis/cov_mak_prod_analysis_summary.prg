...
******************************************************************************
	...
	Source file name:	cov_mak_prod_analysis_summary.prg
	Object name:		cov_mak_prod_analysis_summary
	Request #:			8333
 
	Program purpose:	Lists deficiency summary data.
...
DROP PROGRAM cov_mak_prod_analysis_summary GO
CREATE PROGRAM cov_mak_prod_analysis_summary
 prompt 
...
with OUTDEV, ORGANIZATIONS, STARTDATERANGE, ENDDATERANGE, USERNAMES, TASKQUEUES, 
 ...
 SUBROUTINE  initializereport (dummy )
  ...
  ELSE
   ...
   SET rptreport->m_reportname = "COV_MAK_PROD_ANALYSIS_SUMMARY"
 ...
 IF ($REPORT_GRID = 0)
	 ...
	 IF (( $7 = 1 ) )
	  SET _bsubreport = 1
	  EXECUTE cov_mak_prod_analysis_sum_grp $1, $2, $3, $4, $5, $6, $8
	  SET _bsubreport = 0
	 ENDIF
	 IF (( $7 = 0 ) )
	  SET _bsubreport = 1
	  EXECUTE cov_mak_prod_analysis_sum_ngrp $1, $2, $3, $4, $5, $6, $8
	  SET _bsubreport = 0
	 ENDIF
	 IF ((_bishtml != 0 ) )
