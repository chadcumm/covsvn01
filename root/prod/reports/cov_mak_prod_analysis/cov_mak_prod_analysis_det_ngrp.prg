...
******************************************************************************
	...
	Source file name:	cov_mak_prod_analysis_det_ngrp.prg
	Object name:		cov_mak_prod_analysis_det_ngrp
	Request #:			8333
 
	Program purpose:	Lists deficiency details ungrouped.
...
DROP PROGRAM cov_mak_prod_analysis_det_ngrp GO
CREATE PROGRAM cov_mak_prod_analysis_det_ngrp
 prompt 
...
with OUTDEV, ORGANIZATIONS, STARTDATERANGE, ENDDATERANGE, USERNAMES, TASKQUEUES, 
 ...
 SUBROUTINE  mainhtml (ndummy )
  ...
  SELECT INTO "nl:"
   ...
   HEAD REPORT
    ...
    _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo ) ,
    _htmlfileinfo->file_buf = build2 ("<colgroup span=15>" ,"<col width=94/>" ,"<col width=12/>" ,
     "<col width=44/>" ,"<col width=25/>" ,"<col width=100/>" ,"<col width=13/>" ,"<col width=6/>" ,
     "<col width=69/>" ,"<col width=31/>" ,"<col width=81/>" ,"<col width=81/>" ,"<col width=75/>" ,
     "<col width=44/>" ,"<col width=144/>" ,"<col width=165/>" ,"</colgroup>" ) ,
    _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo ) ,
    daterange = getdaterangedisplay (dates ,him_dash ) ,
    totalchartsperorganization = 0 ,
    totalchartsperuser = 0 ,
 ...
 SUBROUTINE  fieldname00html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName000' colspan='15'>" ,
 ...
 SUBROUTINE  fieldname01html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName010' colspan='15'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName0" ,
 ...
 SUBROUTINE  fieldname02html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName020' colspan='15'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName1" ,"Detailed Report" )
   ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname03html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName030' colspan='15'>" ,daterange ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname04html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='15'>" ,blank ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname05html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName050' colspan='3'>" ,
   i18ndateprinted ,"</td>" ,"<td class='FieldName051' colspan='12'>" ,vctodaydatetime ,"</td>" ,
   "</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname06html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName050' colspan='3'>" ,
   i18nuserprinted ,"</td>" ,"<td class='FieldName051' colspan='12'>" ,vcuser ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname07html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName050' colspan='3'>" ,
   i18npromptsfilters ,"</td>" ,"<td class='FieldName071' colspan='12'>" ,"" ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname08html (dummy )
  IF (i1multifacilitylogicind )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='3'>" ,"" ,
    ...
    "<td class='FieldName082' colspan='9'>" ,facilitylist ,"</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname09html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='3'>" ,"" ,"</td>"
   ,"<td class='FieldName050' colspan='3'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName5" ,"User Name(s):" ) ,"</td>" ,
   "<td class='FieldName082' colspan='9'>" ,userlist ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname010html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='3'>" ,"" ,"</td>"
   ,"<td class='FieldName050' colspan='3'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName7" ,"Task Queue(s):" ) ,"</td>" ,
   "<td class='FieldName082' colspan='9'>" ,taskqueuelist ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname011html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='3'>" ,"" ,"</td>"
   ...
   "<td class='FieldName071' colspan='9'>" ,getdaterangedisplay (dates ,him_prompt ) ,"</td>" ,
   "</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname012html (dummy )
  IF (negate (_bgeneratehtml ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0120' colspan='15'>" ,
 ...
 SUBROUTINE  fieldname013html (dummy )
  IF ((rowcount > 0 ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0130' colspan='4'>" ,
    uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName12" ,"Patient Name" ) ,
    "</td>" ,"<td class='FieldName0131' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName13" ,"MRN" ) ,"</td>" ,
    "<td class='FieldName0131' colspan='3'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName14" ,"FIN" ) ,"</td>" ,
    "<td class='FieldName0133' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName15" ,"Patient Type" ) ,"</td>" ,
    "<td class='FieldName0134' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName16" ,"Discharge Date" ) ,"</td>" ,
    "<td class='FieldName0135' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName17" ,"LOS (Days)" ) ,"</td>" ,
    "<td class='FieldName0136' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName21" ,"TAT (Discharge to Final)" ) ,"</td>" ,
    "<td class='FieldName0136' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName22" ,"TAT Task (Create to Final)" ) ,"</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname016html (dummy )
  IF (0 )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0160' colspan='15'>" ,
    uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName25" ,"" ) ,"</td>" ,
    "</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname017html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0160' colspan='1'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName23" ,"User Name:" ) ,
   "</td>" ,"<td class='FieldName071' colspan='14'>" ,usernamedisplay ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname018html (dummy )
  IF (0 )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0180' colspan='15'>" ,"" ,
    "</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname019html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0180' colspan='2'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName24" ,"Task Queue:" ) ,
   "</td>" ,"<td class='FieldName071' colspan='13'>" ,taskqueuedisplay ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname020html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0130' colspan='4'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName47" ,"Patient Name" ) ,
   "</td>" ,"<td class='FieldName0131' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName52" ,"MRN" ) ,"</td>" ,
   "<td class='FieldName0131' colspan='3'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName53" ,"FIN" ) ,"</td>" ,
   "<td class='FieldName0203' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName54" ,"Patient Type" ) ,"</td>" ,
   "<td class='FieldName0134' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName55" ,"Discharge Date" ) ,"</td>" ,
   "<td class='FieldName0135' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName56" ,"LOS (Days)" ) ,"</td>" ,
   "<td class='FieldName0136' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName59" ,"TAT (Discharge to Final)" ) ,"</td>" ,
   "<td class='FieldName0136' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName60" ,"TAT Task (Create to Final)" ) ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname021html (dummy )
  IF ((mod (rowcount ,2 ) = 1 ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0210' colspan='4'>" ,
    ...
    "<td class='FieldName0211' colspan='3'>" ,trim (fin ,3 ) ,"</td>" ,
 ...
 SUBROUTINE  fieldname022html (dummy )
  IF ((mod (rowcount ,2 ) = 0 ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0220' colspan='4'>" ,
    ...
    "<td class='FieldName0221' colspan='3'>" ,trim (fin ,3 ) ,"</td>" ,
 ...
 SUBROUTINE  fieldname023html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0230' colspan='15'>" ,"" ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname024html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0240' colspan='7'>" ,concat (
   ...
   "<td class='FieldName0241' colspan='2'>" ,totalchartsperqueuedisplay ,"</td>" ,
   "<td class='FieldName0242' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName46" ,"Total LOS:" ) ,"</td>" ,
 ...
 SUBROUTINE  fieldname025html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0250' colspan='7'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_CellName48" ,
    "Total # of Charts Analyzed - All Task Queues:" ) ,"</td>" ,
   "<td class='FieldName0241' colspan='2'>" ,totalchartsperuserdisplay ,"</td>" ,
 ...
 SUBROUTINE  fieldname027html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0270' colspan='15'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_DET_NGRP_EndOfReport" ,
    "**END OF REPORT**" ) ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  initializereport (dummy )
  IF ((_bsubreport = 0 ) )
   ...
   ELSE
    ...
    SET rptreport->m_reportname = "COV_MAK_PROD_ANALYSIS_DET_NGRP"
