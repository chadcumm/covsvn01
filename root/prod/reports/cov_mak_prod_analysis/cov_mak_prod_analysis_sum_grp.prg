...
******************************************************************************
	...
	Source file name:	cov_mak_prod_analysis_sum_grp.prg
	Object name:		cov_mak_prod_analysis_sum_grp
	Request #:			8333
 
	Program purpose:	Lists deficiency summary data grouped.
...
DROP PROGRAM cov_mak_prod_analysis_sum_grp GO
CREATE PROGRAM cov_mak_prod_analysis_sum_grp
 prompt 
...
with OUTDEV, ORGANIZATIONS, STARTDATERANGE, ENDDATERANGE, USERNAMES, TASKQUEUES, 
 ...
 RECORD finaldata (
   1 qual [* ]
     ...
     2 user_name = c100
     2 task_queue_name = c40
     2 total_charts = i4
     2 avg_los_days = i4
     2 avg_tat_create_to_final = i4
     2 avg_tat_discharge_to_final = i4
 )
 ...
 DECLARE fieldname014 ((ncalc = i2 ) ,(maxheight = f8 ) ,(bcontinue = i2 (ref ) ) ) = f8 WITH
 protect
 DECLARE fieldname014abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ,(maxheight = f8 ) ,(
  bcontinue = i2 (ref ) ) ) = f8 WITH protect
 ...
 DECLARE fieldname026 ((ncalc = i2 ) ) = f8 WITH protect
 DECLARE fieldname026abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ) = f8 WITH protect
 ...
 DECLARE fieldname028html ((dummy = i2 ) ) = null WITH protect
 DECLARE fieldname029 ((ncalc = i2 ) ) = f8 WITH protect
 DECLARE fieldname029abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ) = f8 WITH protect
 DECLARE fieldname029html ((dummy = i2 ) ) = null WITH protect
 DECLARE fieldname030 ((ncalc = i2 ) ) = f8 WITH protect
 DECLARE fieldname030abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ) = f8 WITH protect
 DECLARE fieldname030html ((dummy = i2 ) ) = null WITH protect
 DECLARE fieldname031 ((ncalc = i2 ) ,(maxheight = f8 ) ,(bcontinue = i2 (ref ) ) ) = f8 WITH
 protect
 DECLARE fieldname031abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ,(maxheight = f8 ) ,(
  bcontinue = i2 (ref ) ) ) = f8 WITH protect
 DECLARE fieldname031html ((dummy = i2 ) ) = null WITH protect
 DECLARE fieldname032 ((ncalc = i2 ) ) = f8 WITH protect
 DECLARE fieldname032abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ) = f8 WITH protect
 DECLARE fieldname032html ((dummy = i2 ) ) = null WITH protect
 DECLARE fieldname033 ((ncalc = i2 ) ) = f8 WITH protect
 DECLARE fieldname033abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ) = f8 WITH protect
 DECLARE fieldname033html ((dummy = i2 ) ) = null WITH protect
 DECLARE fieldname034 ((ncalc = i2 ) ) = f8 WITH protect
 DECLARE fieldname034abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ) = f8 WITH protect
 DECLARE fieldname034html ((dummy = i2 ) ) = null WITH protect
 DECLARE fieldname035 ((ncalc = i2 ) ) = f8 WITH protect
 DECLARE fieldname035abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ) = f8 WITH protect
 DECLARE fieldname035html ((dummy = i2 ) ) = null WITH protect
 DECLARE fieldname036 ((ncalc = i2 ) ) = f8 WITH protect
 DECLARE fieldname036abs ((ncalc = i2 ) ,(offsetx = f8 ) ,(offsety = f8 ) ) = f8 WITH protect
 DECLARE fieldname036html ((dummy = i2 ) ) = null WITH protect
 ...
 SUBROUTINE  main (dummy )
  SELECT
   ...
   HEAD REPORT
    _d0 = los_days ,
    _d1 = tat_create_to_final ,
    _d2 = tat_discharge_to_final ,
    _d3 = fin ,
    _d4 = user_name ,
    _d5 = organization_name ,
    _d6 = task_queue_name ,
    ...
    avgtatperorganization = 0 ,
    totaltattaskperorganization = 0 ,
    avgtattaskperorganization = 0 ,
    totalchartsperuser = 0 ,
    totaltatperuser = 0 ,
    avgtatperuser = 0 ,
    totaltattaskperuser = 0 ,
    avgtattaskperuser = 0 ,
    totalchartsperqueue = 0 ,
    totallengthofstayperqueue = 0 ,
    avglengthofstayperqueue = 0 ,
    totaltatperqueue = 0 ,
    avgtatperqueue = 0 ,
    totaltattaskperqueue = 0 ,
    avgtattaskperqueue = 0 ,
    detailcount = 0 ,
    rowcount = 0 ,
   ...
   HEAD user_name
    usernamehead = "" ,totalchartsperuser = 0 ,totaltatperuser = 0 ,avgtatperuser = 0 ,
    totaltattaskperuser = 0 ,avgtattaskperuser = 0 ,_fdrawheight = fieldname016 (rpt_calcheight ) ,
    IF (((_yoffset + _fdrawheight ) > _fenddetail ) )
     BREAK
    ENDIF
   ...
   HEAD user_id
    ...
    IF ((_fdrawheight > 0 ) )
     ...
     ,
     IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _bholdcontinue = 0 ,_fdrawheight = (
      _fdrawheight + fieldname019 (rpt_calcheight ,((_fenddetail - _yoffset ) - _fdrawheight ) ,
       _bholdcontinue ) ) ,
      IF ((_bholdcontinue = 1 ) ) _fdrawheight = (_fenddetail + 1 )
      ENDIF
     ENDIF
   ...
   HEAD task_queue_cd
    ...
    avglengthofstayperqueue = 0 ,totaltatperqueue = 0 ,avgtatperqueue = 0 ,totaltattaskperqueue = 0 ,
    avgtattaskperqueue = 0 ,rowcount = 0 ,_fdrawheight = fieldname021 (rpt_calcheight ) ,
    IF (((_yoffset + _fdrawheight ) > _fenddetail ) )
     BREAK
    ENDIF
   ...
   DETAIL
    detailblankrow = "" ,
    totalchartsperorganization = (totalchartsperorganization + 1 ) ,
    totaltatperorganization = (totaltatperorganization + tat_discharge_to_final ) ,
    totaltattaskperorganization = (totaltattaskperorganization + tat_create_to_final ) ,
    totalchartsperuser = (totalchartsperuser + 1 ) ,
    totaltatperuser = (totaltatperuser + tat_discharge_to_final ) ,
    totaltattaskperuser = (totaltattaskperuser + tat_create_to_final ) ,
    totalchartsperqueue = (totalchartsperqueue + 1 ) ,
    totallengthofstayperqueue = (totallengthofstayperqueue + los_days ) ,
    totaltatperqueue = (totaltatperqueue + tat_discharge_to_final ) ,
    totaltattaskperqueue = (totaltattaskperqueue + tat_create_to_final ) ,
   ...
   FOOT  patient_type_name
    row + 0
   FOOT  task_queue_cd
    usernamerowone = user_name ,rowcount = (rowcount + 1 ) ,totalchartsrowone = build (
     totalchartsperqueue ) ,avglosdisplayrowone = trim (build ((totallengthofstayperqueue /
      totalchartsperqueue ) ) ,3 ) ,usernamerowtwo = user_name ,totalchartsrowtwo = build (
     totalchartsperqueue ) ,avglosdisplayrowtwo = trim (build ((totallengthofstayperqueue /
      totalchartsperqueue ) ) ,3 ) ,_bcontfieldname023 = 0 ,bfirsttime = 1 ,
    WHILE ((((_bcontfieldname023 = 1 ) ) OR ((bfirsttime = 1 ) )) )
     ...
     IF ((((_bholdcontinue = 1 ) ) OR ((_fdrawheight > 0 ) )) )
      IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _bholdcontinue = 0 ,_fdrawheight = (
       _fdrawheight + fieldname024 (rpt_calcheight ,((_fenddetail - _yoffset ) - _fdrawheight ) ,
        _bholdcontinue ) ) ,
       IF ((_bholdcontinue = 1 ) ) _fdrawheight = (_fenddetail + 1 )
       ENDIF
      ENDIF
     ...
     AND (_bcontfieldname023 = 0 ) )
      BREAK
     ENDIF
     ,dummy_val = fieldname023 (rpt_render ,(_fenddetail - _yoffset ) ,_bcontfieldname023 ) ,
     bfirsttime = 0
    ENDWHILE
   ...
   FOOT  user_id
    ...
    IF ((totalchartsperuser > 0 ) ) avgtatperuserdisplay = build (cnvtminstodayshoursmins ((
       totaltatperuser / totalchartsperuser ) ) )
    ELSE avgtatperuserdisplay = build (cnvtminstodayshoursmins (0 ) )
    ENDIF
    ,
    IF ((totalchartsperuser > 0 ) ) avgtattaskperuserdisplay = build (cnvtminstodayshoursmins ((
       totaltattaskperuser / totalchartsperuser ) ) )
    ELSE avgtattaskperuserdisplay = build (cnvtminstodayshoursmins (0 ) )
    ENDIF
    ,_fdrawheight = fieldname025 (rpt_calcheight ) ,
    IF ((_fdrawheight > 0 ) )
     IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname026 (
       rpt_calcheight ) )
     ENDIF
     ,
     IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname027 (
       rpt_calcheight ) )
     ENDIF
     ,
     IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname028 (
       rpt_calcheight ) )
     ENDIF
     ,
     IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname029 (
       rpt_calcheight ) )
     ENDIF
     ,
     IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname030 (
       rpt_calcheight ) )
     ENDIF
    ENDIF
    ,
   ...
   FOOT  organization_id
    ...
    IF ((totalchartsperorganization > 0 ) ) avgtatperorgdisplay = build (cnvtminstodayshoursmins ((
       totaltatperorganization / totalchartsperorganization ) ) )
    ELSE avgtatperorgdisplay = build (cnvtminstodayshoursmins (0 ) )
    ENDIF
    ,
    IF ((totalchartsperorganization > 0 ) ) avgtattaskperorgdisplay = build (cnvtminstodayshoursmins
      ((totaltattaskperorganization / totalchartsperorganization ) ) )
    ELSE avgtattaskperorgdisplay = build (cnvtminstodayshoursmins (0 ) )
    ENDIF
    ...
    WHILE ((((_bcontfieldname031 = 1 ) ) OR ((bfirsttime = 1 ) )) )
     _bholdcontinue = _bcontfieldname031 ,_fdrawheight = fieldname031 (rpt_calcheight ,(_fenddetail
      - _yoffset ) ,_bholdcontinue ) ,
     IF ((((_bholdcontinue = 1 ) ) OR ((_fdrawheight > 0 ) )) )
      IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname032
       (rpt_calcheight ) )
      ENDIF
      ,
      IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname033
       (rpt_calcheight ) )
      ENDIF
      ,
      IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname034
       (rpt_calcheight ) )
      ENDIF
      ,
      IF ((_fenddetail >= (_yoffset + _fdrawheight ) ) ) _fdrawheight = (_fdrawheight + fieldname035
       (rpt_calcheight ) )
      ENDIF
     ENDIF
     ,
     ...
     AND (_bcontfieldname031 = 0 ) )
      BREAK
     ENDIF
     ,dummy_val = fieldname031 (rpt_render ,(_fenddetail - _yoffset ) ,_bcontfieldname031 ) ,
     bfirsttime = 0
    ENDWHILE
  ...
  SELECT
   ...
   HEAD REPORT
    ...
    _htmlfileinfo->file_buf = build2 ("<STYLE>" ,
     ...
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
     " font:  bold 10pt Times;" ," " ," color: #000000;" ," " ," text-align: right;" ,
     " vertical-align: bottom;}" ,".FieldName0140 { border-width: 0.014in; border-color: #000000;" ,
     ...
     " border-style: none none solid none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
     " font:  bold 10pt Times;" ," " ," color: #000000;" ," " ," text-align: right;" ,
     " vertical-align: bottom;}" ,".FieldName0142 { border-width: 0.014in; border-color: #000000;" ,
     " border-style: none none solid none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
     " font:  bold 10pt Times;" ," " ," color: #000000;" ," " ," text-align: right;" ,
     " vertical-align: bottom;}" ,".FieldName0144 { border-width: 0.014in; border-color: #000000;" ,
     ...
     " vertical-align: bottom;}" ,".FieldName0170 { border-width: 0.014in; border-color: #000000;" ,
     ...
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
     " font:   10pt Times;" ," " ," color: #000000;" ," " ," text-align: left;" ,
     " vertical-align: bottom;}" ,".FieldName0230 { border-width: 0.014in; border-color: #000000;" ,
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
     " font:   10pt Times;" ," " ," color: #000000;" ," " ," text-align: left;" ,
     " vertical-align: middle;}" ,".FieldName0231 { border-width: 0.014in; border-color: #000000;" ,
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
     " font:   10pt Times;" ," " ," color: #000000;" ," " ," text-align: right;" ,
     " vertical-align: middle;}" ,".FieldName0234 { border-width: 0.014in; border-color: #000000;" ,
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.100in;" ,
     " font:   10pt Times;" ," " ," color: #000000;" ," " ," text-align: right;" ,
     ...
     " vertical-align: middle;}" ,".FieldName0241 { border-width: 0.014in; border-color: #000000;" ,
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
     " font:   10pt Times;" ," " ," color: #000000;" ," background: #e8e8e8;" ," text-align: right;"
     ," vertical-align: middle;}" ,".FieldName0244 { border-width: 0.014in; border-color: #000000;" ,
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.100in;" ,
     " font:   10pt Times;" ," " ," color: #000000;" ," background: #e8e8e8;" ," text-align: right;"
     ...
     ," vertical-align: middle;}" ,".FieldName0272 { border-width: 0.014in; border-color: #000000;" ,
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
    ...
    _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo ) ,
    _htmlfileinfo->file_buf = build2 ("<colgroup span=9>" ,"<col width=150/>" ,"<col width=25/>" ,
     "<col width=75/>" ,"<col width=38/>" ,"<col width=112/>" ,"<col width=25/>" ,"<col width=163/>"
     ,"<col width=212/>" ,"<col width=184/>" ,"</colgroup>" ) ,
    _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo ) ,
    daterange = getdaterangedisplay (dates ,him_dash ) ,
    totalchartsperorganization = 0 ,
    totaltatperorganization = 0 ,
   ...
   HEAD user_name
    usernamehead = "" ,totalchartsperuser = 0 ,totaltatperuser = 0 ,avgtatperuser = 0 ,
    totaltattaskperuser = 0 ,avgtattaskperuser = 0 ,dummy_val = fieldname016html (0 )
   HEAD user_id
    dummy_val = fieldname017html (0 ) ,dummy_val = fieldname018html (0 ) ,dummy_val =
    fieldname019html (0 )
   HEAD task_queue_name
   ...
   HEAD task_queue_cd
    taskqueuehead = "" ,totalchartsperqueue = 0 ,totallengthofstayperqueue = 0 ,
    avglengthofstayperqueue = 0 ,totaltatperqueue = 0 ,avgtatperqueue = 0 ,totaltattaskperqueue = 0 ,
    avgtattaskperqueue = 0 ,rowcount = 0 ,dummy_val = fieldname021html (0 )
   DETAIL
    detailblankrow = "" ,
    totalchartsperorganization = (totalchartsperorganization + 1 ) ,
    totaltatperorganization = (totaltatperorganization + tat_discharge_to_final ) ,
   ...
   FOOT  task_queue_cd
    usernamerowone = user_name ,rowcount = (rowcount + 1 ) ,totalchartsrowone = build (
     totalchartsperqueue ) ,avglosdisplayrowone = trim (build ((totallengthofstayperqueue /
      totalchartsperqueue ) ) ,3 ) ,usernamerowtwo = user_name ,totalchartsrowtwo = build (
     totalchartsperqueue ) ,avglosdisplayrowtwo = trim (build ((totallengthofstayperqueue /
      totalchartsperqueue ) ) ,3 ) ,dummy_val = fieldname023html (0 ) ,dummy_val = fieldname024html (
     0 )
   FOOT  user_id
    totalchartsperuserdisplay = build (totalchartsperuser ) ,
    IF ((totalchartsperuser > 0 ) ) avgtatperuserdisplay = build (cnvtminstodayshoursmins ((
    ...
    ELSE avgtattaskperuserdisplay = build (cnvtminstodayshoursmins (0 ) )
    ENDIF
    ,dummy_val = fieldname025html (0 ) ,dummy_val = fieldname026html (0 ) ,dummy_val =
    fieldname027html (0 ) ,dummy_val = fieldname028html (0 ) ,dummy_val = fieldname029html (0 ) ,
    dummy_val = fieldname030html (0 )
   FOOT  organization_id
    totalchartsperorganizationdisplay = build (totalchartsperorganization ) ,
    IF ((totalchartsperorganization > 0 ) ) avgtatperorgdisplay = build (cnvtminstodayshoursmins ((
       totaltatperorganization / totalchartsperorganization ) ) )
    ...
    ELSE avgtattaskperorgdisplay = build (cnvtminstodayshoursmins (0 ) )
    ENDIF
    ,dummy_val = fieldname031html (0 ) ,dummy_val = fieldname032html (0 ) ,dummy_val =
    fieldname033html (0 ) ,dummy_val = fieldname034html (0 ) ,dummy_val = fieldname035html (0 )
   FOOT REPORT
    _htmlfileinfo->file_buf = "</tbody>" ,
    _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo ) ,
    _htmlfileinfo->file_buf = "<tfoot>" ,
    _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo ) ,
    dummy_val = fieldname036html (0 ) ,
    _htmlfileinfo->file_buf = "</tfoot>" ,
    _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo ) ,
 ...
 SUBROUTINE  maingrid (dummy )
  SELECT INTO "nl:"
   ...
   los_days = data->qual[d.seq ].los_days ,
   tat_discharge_to_final = data->qual[d.seq ].tat_discharge_to_final ,
   tat_task_create_to_final = data->qual[d.seq ].tat_create_to_final
   FROM (dummyt d WITH seq = value (size (data->qual ,5 ) ) )
   WHERE (d.seq > 0 )    
   ORDER BY organization_name ,
  ...
  HEAD task_queue_cd
   ...
   total_charts = 0
   total_los_days = 0
   total_tat_discharge_to_final = 0
   total_tat_create_to_final = 0
   
   call alterlist(finaldata->qual, cnt)
   
  DETAIL
   total_charts += 1
   total_los_days = total_los_days + data->qual[d.seq ].los_days
   total_tat_discharge_to_final = total_tat_discharge_to_final + data->qual[d.seq ].tat_discharge_to_final
   total_tat_create_to_final = total_tat_create_to_final + data->qual[d.seq ].tat_create_to_final
   
  FOOT task_queue_cd
   finaldata->qual[cnt].organization_name = organization_name
   finaldata->qual[cnt].user_name = user_name
   finaldata->qual[cnt].task_queue_name = task_queue_name
   finaldata->qual[cnt].total_charts = total_charts
   finaldata->qual[cnt].avg_los_days = total_los_days / total_charts
   finaldata->qual[cnt].avg_tat_discharge_to_final = total_tat_discharge_to_final / total_charts
   finaldata->qual[cnt].avg_tat_create_to_final = total_tat_create_to_final / total_charts
	 
   WITH nullreport ,nocounter ,memsort
   
   
  SELECT INTO $OUTDEV
   organization_name = finaldata->qual[d.seq].organization_name ,
   user_name = finaldata->qual[d.seq].user_name ,
   task_queue_name = finaldata->qual[d.seq].task_queue_name ,
   total_charts = finaldata->qual[d.seq].total_charts ,
   avg_los_days = finaldata->qual[d.seq].avg_los_days ,
   avg_tat_discharge_to_final = trim(cnvtminstodayshoursmins (finaldata->qual[d.seq].avg_tat_discharge_to_final ), 3) ,
   avg_tat_create_to_final = trim(cnvtminstodayshoursmins (finaldata->qual[d.seq].avg_tat_create_to_final ), 3)
   FROM (dummyt d WITH seq = value (size (finaldata->qual ,5 ) ) )
   
   WITH nullreport ,nocounter ,memsort, format, separator = " "
 ...
 SUBROUTINE  fieldname00html (dummy )
  IF (_bgeneratehtml )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName000' colspan='9'>" ,
 ...
 SUBROUTINE  fieldname01html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName010' colspan='9'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName0" ,
 ...
 SUBROUTINE  fieldname02html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName020' colspan='9'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName1" ,"Summary Report" ) ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname03html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName030' colspan='9'>" ,daterange ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname04html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='9'>" ,blank ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname05html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName050' colspan='1'>" ,
   i18ndateprinted ,"</td>" ,"<td class='FieldName051' colspan='8'>" ,vctodaydatetime ,"</td>" ,
   "</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname06html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName050' colspan='1'>" ,
   i18nuserprinted ,"</td>" ,"<td class='FieldName051' colspan='8'>" ,vcuser ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname07html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName050' colspan='1'>" ,
   i18npromptsfilters ,"</td>" ,"<td class='FieldName071' colspan='8'>" ,"" ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname08html (dummy )
  IF (i1multifacilitylogicind )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='1'>" ,"" ,
    ...
    "<td class='FieldName082' colspan='5'>" ,facilitylist ,"</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname09html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='1'>" ,"" ,"</td>"
   ,"<td class='FieldName050' colspan='3'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName5" ,"User Name(s):" ) ,"</td>" ,
   "<td class='FieldName082' colspan='5'>" ,userlist ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname010html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='1'>" ,"" ,"</td>"
   ,"<td class='FieldName050' colspan='3'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName7" ,"Task Queue(s):" ) ,"</td>" ,
   "<td class='FieldName082' colspan='5'>" ,taskqueuelist ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname011html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='1'>" ,"" ,"</td>"
   ...
   "<td class='FieldName071' colspan='5'>" ,getdaterangedisplay (dates ,him_prompt ) ,"</td>" ,
   "</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname012html (dummy )
  IF (negate (_bgeneratehtml ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0120' colspan='9'>" ,
 ...
 SUBROUTINE  fieldname013html (dummy )
  IF ((rowcount > 0 ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0130' colspan='2'>" ,"" ,
    "</td>" ,"<td class='FieldName0131' colspan='7'>" ,"" ,"</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 SUBROUTINE  fieldname014 (ncalc ,maxheight ,bcontinue )
  DECLARE a1 = f8 WITH noconstant (0.0 ) ,private
  SET a1 = fieldname014abs (ncalc ,_xoffset ,_yoffset ,maxheight ,bcontinue )
  RETURN (a1 )
 END ;Subroutine
 SUBROUTINE  fieldname014abs (ncalc ,offsetx ,offsety ,maxheight ,bcontinue )
  DECLARE sectionheight = f8 WITH noconstant (0.200000 ) ,private
  DECLARE growsum = i4 WITH noconstant (0 ) ,private
  ...
  DECLARE __cellname22 = vc WITH noconstant (build (uar_i18ngetmessage (_hi18nhandle ,
     "FieldName014_CellName22" ,build2 ("Avg TAT Task (Create to Final)" ,char (0 ) ) ) ,char (0 ) )
   ) ,protect
  DECLARE __cellname21 = vc WITH noconstant (build (uar_i18ngetmessage (_hi18nhandle ,
     "FieldName014_CellName21" ,build2 ("Avg TAT (Discharge to Final)" ,char (0 ) ) ) ,char (0 ) ) )
  ,protect
  ...
  DECLARE __cellname14 = vc WITH noconstant (build (uar_i18ngetmessage (_hi18nhandle ,
     "FieldName014_CellName14" ,build2 ("Total Charts Analyzed" ,char (0 ) ) ) ,char (0 ) ) ) ,
  protect
  IF (NOT ((rowcount > 0 ) ) )
   RETURN (0.0 )
  ENDIF
  ...
  IF ((_remcellname14 > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (_remcellname14 ,((
      size (__cellname14 ) - _remcellname14 ) + 1 ) ,__cellname14 ) ) )
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remcellname14 ,((size (__cellname14 )
    ...
    SET _remcellname14 = (_remcellname14 + rptsd->m_drawlength )
   ELSE
    SET _remcellname14 = 0
   ENDIF
   SET growsum = (growsum + _remcellname14 )
  ENDIF
  ...
  AND (_holdremcellname14 > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (_holdremcellname14 ,((
      size (__cellname14 ) - _holdremcellname14 ) + 1 ) ,__cellname14 ) ) )
  ELSE
 ...
 SUBROUTINE  fieldname014html (dummy )
  IF ((rowcount > 0 ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0140' colspan='2'>" ,
    uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName12" ,"User Name" ) ,
    "</td>" ,"<td class='FieldName0141' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName13" ,"Task Queue" ) ,"</td>" ,
    "<td class='FieldName0142' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName14" ,"Total Charts Analyzed" ) ,"</td>" ,
    "<td class='FieldName0142' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName17" ,"Avg LOS (Days)" ) ,"</td>" ,
    "<td class='FieldName0144' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName21" ,"Avg TAT (Discharge to Final)" ) ,"</td>" ,
    "<td class='FieldName0145' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName22" ,"Avg TAT Task (Create to Final)" ) ,"</td>" ,
    "</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname015html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0150' colspan='9'>" ,
   organization ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname016html (dummy )
  IF (0 )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName071' colspan='9'>" ,
    usernamehead ,"</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname017html (dummy )
  IF (0 )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0170' colspan='9'>" ,"" ,
    "</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname018html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0130' colspan='9'>" ,"" ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname019abs (ncalc ,offsetx ,offsety ,maxheight ,bcontinue )
  ...
  DECLARE __cellname60 = vc WITH noconstant (build (uar_i18ngetmessage (_hi18nhandle ,
     "FieldName019_CellName60" ,build2 ("Avg TAT Task (Create to Final)" ,char (0 ) ) ) ,char (0 ) )
   ) ,protect
  DECLARE __cellname59 = vc WITH noconstant (build (uar_i18ngetmessage (_hi18nhandle ,
     "FieldName019_CellName59" ,build2 ("Avg TAT (Discharge to Final)" ,char (0 ) ) ) ,char (0 ) ) )
  ,protect
 ...
 SUBROUTINE  fieldname019html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0140' colspan='2'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName47" ,"User Name" ) ,
   "</td>" ,"<td class='FieldName0141' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName52" ,"Task Queue" ) ,"</td>" ,
   "<td class='FieldName0141' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName53" ,"Total Charts Analyzed" ) ,"</td>" ,
   "<td class='FieldName0142' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName56" ,"Avg LOS (Days)" ) ,"</td>" ,
   "<td class='FieldName0144' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName59" ,"Avg TAT (Discharge to Final)" ) ,"</td>" ,
   "<td class='FieldName0144' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName60" ,"Avg TAT Task (Create to Final)" ) ,"</td>" ,"</tr>"
   )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname022html (dummy )
  IF (0 )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0220' colspan='9'>" ,
    detailblankrow ,"</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname023abs (ncalc ,offsetx ,offsety ,maxheight ,bcontinue )
  ...
  DECLARE __tatcreatetofinalrowone = vc WITH noconstant (build (cnvtminstodayshoursmins ((
     totaltattaskperqueue / totalchartsperqueue ) ) ,char (0 ) ) ) ,protect
  DECLARE __tatdischargetofinalrowone = vc WITH noconstant (build (cnvtminstodayshoursmins ((
     totaltatperqueue / totalchartsperqueue ) ) ,char (0 ) ) ) ,protect
  DECLARE __avglosdisplayrowone = vc WITH noconstant (build (avglosdisplayrowone ,char (0 ) ) ) ,
  protect
  ...
  IF ((_remavglosdisplayrowone > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _remavglosdisplayrowone ,((size (__avglosdisplayrowone ) - _remavglosdisplayrowone ) + 1 ) ,
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remavglosdisplayrowone ,((size (
    ...
    SET _remavglosdisplayrowone = (_remavglosdisplayrowone + rptsd->m_drawlength )
   ELSE
    SET _remavglosdisplayrowone = 0
   ENDIF
   SET growsum = (growsum + _remavglosdisplayrowone )
  ENDIF
  SET rptsd->m_flags = 325
  SET rptsd->m_y = (offsety + 0.000 )
  SET rptsd->m_x = (offsetx + 2.875 )
  ...
  IF ((_remtotalchartsrowone > 0 ) )
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remtotalchartsrowone ,((size (
    ...
    SET _remtotalchartsrowone = (_remtotalchartsrowone + rptsd->m_drawlength )
   ELSE
    SET _remtotalchartsrowone = 0
   ENDIF
   SET growsum = (growsum + _remtotalchartsrowone )
  ENDIF
  SET rptsd->m_flags = 325
  SET rptsd->m_y = (offsety + 0.000 )
  SET rptsd->m_x = (offsetx + 1.750 )
  ...
  IF ((_remtaskqueuerowone > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (_remtaskqueuerowone ,(
      (size (__taskqueuerowone ) - _remtaskqueuerowone ) + 1 ) ,__taskqueuerowone ) ) )
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remtaskqueuerowone ,((size (
    ...
    SET _remtaskqueuerowone = (_remtaskqueuerowone + rptsd->m_drawlength )
   ELSE
    SET _remtaskqueuerowone = 0
   ENDIF
   SET growsum = (growsum + _remtaskqueuerowone )
  ENDIF
  ...
  IF ((_remusernamerowone > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (_remusernamerowone ,((
      size (__usernamerowone ) - _remusernamerowone ) + 1 ) ,__usernamerowone ) ) )
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remusernamerowone ,((size (
       __usernamerowone ) - _remusernamerowone ) + 1 ) ,__usernamerowone ) ) ) ) )
    SET _remusernamerowone = (_remusernamerowone + rptsd->m_drawlength )
   ELSE
    SET _remusernamerowone = 0
   ENDIF
   SET growsum = (growsum + _remusernamerowone )
  ENDIF
  ...
  AND (_holdremavglosdisplayrowone > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _holdremavglosdisplayrowone ,((size (__avglosdisplayrowone ) - _holdremavglosdisplayrowone ) +
      1 ) ,__avglosdisplayrowone ) ) )
  ELSE
  ...
  AND (_holdremtotalchartsrowone > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _holdremtotalchartsrowone ,((size (__totalchartsrowone ) - _holdremtotalchartsrowone ) + 1 ) ,
      __totalchartsrowone ) ) )
  ELSE
  ...
  AND (_holdremtaskqueuerowone > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _holdremtaskqueuerowone ,((size (__taskqueuerowone ) - _holdremtaskqueuerowone ) + 1 ) ,
      __taskqueuerowone ) ) )
  ELSE
  ...
  AND (_holdremusernamerowone > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _holdremusernamerowone ,((size (__usernamerowone ) - _holdremusernamerowone ) + 1 ) ,
      __usernamerowone ) ) )
  ELSE
 ...
 SUBROUTINE  fieldname023html (dummy )
  IF ((mod (rowcount ,2 ) = 1 ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0230' colspan='2'>" ,
    usernamerowone ,"</td>" ,"<td class='FieldName0231' colspan='2'>" ,task_queue_name ,"</td>" ,
    "<td class='FieldName0231' colspan='2'>" ,totalchartsrowone ,"</td>" ,
    "<td class='FieldName0231' colspan='1'>" ,avglosdisplayrowone ,"</td>" ,
    "<td class='FieldName0234' colspan='1'>" ,cnvtminstodayshoursmins ((totaltatperqueue /
     totalchartsperqueue ) ) ,"</td>" ,"<td class='FieldName0234' colspan='1'>" ,
    cnvtminstodayshoursmins ((totaltattaskperqueue / totalchartsperqueue ) ) ,"</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname024abs (ncalc ,offsetx ,offsety ,maxheight ,bcontinue )
  ...
  DECLARE __tatdischargetofinalrowtwo = vc WITH noconstant (build (cnvtminstodayshoursmins ((
     totaltatperqueue / totalchartsperqueue ) ) ,char (0 ) ) ) ,protect
  DECLARE __avglosdisplayrowtwo = vc WITH noconstant (build (avglosdisplayrowtwo ,char (0 ) ) ) ,
  protect
  ...
  IF ((_remavglosdisplayrowtwo > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _remavglosdisplayrowtwo ,((size (__avglosdisplayrowtwo ) - _remavglosdisplayrowtwo ) + 1 ) ,
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remavglosdisplayrowtwo ,((size (
    ...
    SET _remavglosdisplayrowtwo = (_remavglosdisplayrowtwo + rptsd->m_drawlength )
   ELSE
    SET _remavglosdisplayrowtwo = 0
   ENDIF
   SET growsum = (growsum + _remavglosdisplayrowtwo )
  ENDIF
  SET oldbackcolor = uar_rptsetbackcolor (_hreport ,uar_rptencodecolor (232 ,232 ,232 ) )
  SET oldbackcolor = uar_rptresetbackcolor (_hreport )
  SET rptsd->m_flags = 325
  ...
  IF ((_remtotalchartsrowtwo > 0 ) )
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remtotalchartsrowtwo ,((size (
    ...
    SET _remtotalchartsrowtwo = (_remtotalchartsrowtwo + rptsd->m_drawlength )
   ELSE
    SET _remtotalchartsrowtwo = 0
   ENDIF
   SET growsum = (growsum + _remtotalchartsrowtwo )
  ENDIF
  SET oldbackcolor = uar_rptsetbackcolor (_hreport ,uar_rptencodecolor (232 ,232 ,232 ) )
  SET oldbackcolor = uar_rptresetbackcolor (_hreport )
  SET rptsd->m_flags = 325
  ...
  IF ((_remtaskqueuerowtwo > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (_remtaskqueuerowtwo ,(
      (size (__taskqueuerowtwo ) - _remtaskqueuerowtwo ) + 1 ) ,__taskqueuerowtwo ) ) )
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remtaskqueuerowtwo ,((size (
    ...
    SET _remtaskqueuerowtwo = (_remtaskqueuerowtwo + rptsd->m_drawlength )
   ELSE
    SET _remtaskqueuerowtwo = 0
   ENDIF
   SET growsum = (growsum + _remtaskqueuerowtwo )
  ENDIF
  SET oldbackcolor = uar_rptsetbackcolor (_hreport ,uar_rptencodecolor (232 ,232 ,232 ) )
  SET oldbackcolor = uar_rptresetbackcolor (_hreport )
  SET rptsd->m_flags = 293
  ...
  IF ((_remusernamerowtwo > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (_remusernamerowtwo ,((
      size (__usernamerowtwo ) - _remusernamerowtwo ) + 1 ) ,__usernamerowtwo ) ) )
   ...
   ELSEIF ((rptsd->m_drawlength < size (nullterm (substring (_remusernamerowtwo ,((size (
       __usernamerowtwo ) - _remusernamerowtwo ) + 1 ) ,__usernamerowtwo ) ) ) ) )
    SET _remusernamerowtwo = (_remusernamerowtwo + rptsd->m_drawlength )
   ELSE
    SET _remusernamerowtwo = 0
   ENDIF
   SET growsum = (growsum + _remusernamerowtwo )
  ENDIF
  SET oldbackcolor = uar_rptsetbackcolor (_hreport ,uar_rptencodecolor (232 ,232 ,232 ) )
  SET oldbackcolor = uar_rptresetbackcolor (_hreport )
  SET rptsd->m_flags = 324
  ...
  AND (_holdremavglosdisplayrowtwo > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _holdremavglosdisplayrowtwo ,((size (__avglosdisplayrowtwo ) - _holdremavglosdisplayrowtwo ) +
      1 ) ,__avglosdisplayrowtwo ) ) )
  ELSE
  ...
  AND (_holdremtotalchartsrowtwo > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _holdremtotalchartsrowtwo ,((size (__totalchartsrowtwo ) - _holdremtotalchartsrowtwo ) + 1 ) ,
      __totalchartsrowtwo ) ) )
  ELSE
  ...
  AND (_holdremtaskqueuerowtwo > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _holdremtaskqueuerowtwo ,((size (__taskqueuerowtwo ) - _holdremtaskqueuerowtwo ) + 1 ) ,
      __taskqueuerowtwo ) ) )
  ELSE
  ...
  AND (_holdremusernamerowtwo > 0 ) )
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,nullterm (substring (
      _holdremusernamerowtwo ,((size (__usernamerowtwo ) - _holdremusernamerowtwo ) + 1 ) ,
      __usernamerowtwo ) ) )
  ELSE
 ...
 SUBROUTINE  fieldname024html (dummy )
  IF ((mod (rowcount ,2 ) = 0 ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0240' colspan='2'>" ,
    usernamerowtwo ,"</td>" ,"<td class='FieldName0241' colspan='2'>" ,task_queue_name ,"</td>" ,
    "<td class='FieldName0241' colspan='2'>" ,totalchartsrowtwo ,"</td>" ,
    "<td class='FieldName0241' colspan='1'>" ,avglosdisplayrowtwo ,"</td>" ,
    "<td class='FieldName0244' colspan='1'>" ,cnvtminstodayshoursmins ((totaltatperqueue /
     totalchartsperqueue ) ) ,"</td>" ,"<td class='FieldName0244' colspan='1'>" ,
    cnvtminstodayshoursmins ((totaltattaskperqueue / totalchartsperqueue ) ) ,"</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname025html (dummy )
  IF (0 )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0250' colspan='9'>" ,"" ,
    "</td>" ,"</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname026html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0260' colspan='9'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName48" ,
 ...
 SUBROUTINE  fieldname027html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0270' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName72" ,
 ...
 SUBROUTINE  fieldname028abs (ncalc ,offsetx ,offsety )
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname028html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0270' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName49" ,
    "Avg TAT (Discharge to Final):" ) ,"</td>" ,"<td class='FieldName0271' colspan='2'>" ,
   avgtatperuserdisplay ,"</td>" ,"<td class='FieldName0272' colspan='4'>" ,"" ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname029abs (ncalc ,offsetx ,offsety )
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname029html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0270' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName9" ,
    "Avg TAT Task (Create to Final):" ) ,"</td>" ,"<td class='FieldName0271' colspan='2'>" ,
   avgtattaskperuserdisplay ,"</td>" ,"<td class='FieldName0272' colspan='4'>" ,"" ,"</td>" ,"</tr>"
   )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  fieldname030 (ncalc )
  DECLARE a1 = f8 WITH noconstant (0.0 ) ,private
  SET a1 = fieldname030abs (ncalc ,_xoffset ,_yoffset )
  RETURN (a1 )
 END ;Subroutine
 SUBROUTINE  fieldname030abs (ncalc ,offsetx ,offsety )
  DECLARE sectionheight = f8 WITH noconstant (0.110000 ) ,private
  IF ((ncalc = rpt_render ) )
   SET rptsd->m_flags = 288
   SET rptsd->m_borders = rpt_sdnoborders
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname030html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName051' colspan='9'>" ,"" ,"</td>"
   ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  fieldname031 (ncalc ,maxheight ,bcontinue )
  DECLARE a1 = f8 WITH noconstant (0.0 ) ,private
  SET a1 = fieldname031abs (ncalc ,_xoffset ,_yoffset ,maxheight ,bcontinue )
  RETURN (a1 )
 END ;Subroutine
 SUBROUTINE  fieldname031abs (ncalc ,offsetx ,offsety ,maxheight ,bcontinue )
  DECLARE sectionheight = f8 WITH noconstant (0.220000 ) ,private
  DECLARE growsum = i4 WITH noconstant (0 ) ,private
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname031html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0310' colspan='9'>" ,
   IF (i1multifacilitylogicind ) build2 (uar_i18ngetmessage (i18nhandlehim ,"TOTALSFORORG" ,
      "Totals for " ) ,trim (organization_name ,3 ) ,": " )
   ELSE build2 (uar_i18ngetmessage (i18nhandlehim ,"TOTALS" ,"Totals:" ) )
   ENDIF
  ...
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  fieldname032 (ncalc )
  DECLARE a1 = f8 WITH noconstant (0.0 ) ,private
  SET a1 = fieldname032abs (ncalc ,_xoffset ,_yoffset )
  RETURN (a1 )
 END ;Subroutine
 SUBROUTINE  fieldname032abs (ncalc ,offsetx ,offsety )
  DECLARE sectionheight = f8 WITH noconstant (0.200000 ) ,private
  IF ((ncalc = rpt_render ) )
   SET rptsd->m_flags = 288
   SET rptsd->m_borders = rpt_sdnoborders
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname032html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0320' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName33" ,
    "Total # of Charts Analyzed:" ) ,"</td>" ,"<td class='FieldName0271' colspan='2'>" ,
   totalchartsperorganizationdisplay ,"</td>" ,"<td class='FieldName0272' colspan='4'>" ,"" ,"</td>"
   ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  fieldname033 (ncalc )
  DECLARE a1 = f8 WITH noconstant (0.0 ) ,private
  SET a1 = fieldname033abs (ncalc ,_xoffset ,_yoffset )
  RETURN (a1 )
 END ;Subroutine
 SUBROUTINE  fieldname033abs (ncalc ,offsetx ,offsety )
  DECLARE sectionheight = f8 WITH noconstant (0.250000 ) ,private
  IF ((ncalc = rpt_render ) )
   SET rptsd->m_flags = 288
   SET rptsd->m_borders = rpt_sdnoborders
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname033html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0320' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName29" ,
    "Avg TAT (Discharge to Final):" ) ,"</td>" ,"<td class='FieldName0271' colspan='2'>" ,
   avgtatperorgdisplay ,"</td>" ,"<td class='FieldName0272' colspan='4'>" ,"" ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  fieldname034 (ncalc )
  DECLARE a1 = f8 WITH noconstant (0.0 ) ,private
  SET a1 = fieldname034abs (ncalc ,_xoffset ,_yoffset )
  RETURN (a1 )
 END ;Subroutine
 SUBROUTINE  fieldname034abs (ncalc ,offsetx ,offsety )
  DECLARE sectionheight = f8 WITH noconstant (0.220000 ) ,private
  IF ((ncalc = rpt_render ) )
   SET rptsd->m_flags = 288
   SET rptsd->m_borders = rpt_sdnoborders
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname034html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0320' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_CellName8" ,
    "Avg TAT Task (Create to Final):" ) ,"</td>" ,"<td class='FieldName0271' colspan='2'>" ,
   avgtattaskperorgdisplay ,"</td>" ,"<td class='FieldName0272' colspan='4'>" ,"" ,"</td>" ,"</tr>"
   )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  fieldname035 (ncalc )
  DECLARE a1 = f8 WITH noconstant (0.0 ) ,private
  SET a1 = fieldname035abs (ncalc ,_xoffset ,_yoffset )
  RETURN (a1 )
 END ;Subroutine
 SUBROUTINE  fieldname035abs (ncalc ,offsetx ,offsety )
  DECLARE sectionheight = f8 WITH noconstant (0.130000 ) ,private
  IF ((ncalc = rpt_render ) )
   SET rptsd->m_flags = 272
   SET rptsd->m_borders = rpt_sdnoborders
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname035html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0350' colspan='9'>" ,"" ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  fieldname036 (ncalc )
  DECLARE a1 = f8 WITH noconstant (0.0 ) ,private
  SET a1 = fieldname036abs (ncalc ,_xoffset ,_yoffset )
  RETURN (a1 )
 END ;Subroutine
 SUBROUTINE  fieldname036abs (ncalc ,offsetx ,offsety )
  ...
  RETURN (sectionheight )
 END ;Subroutine
 SUBROUTINE  fieldname036html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0350' colspan='9'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_GRP_EndOfReport" ,
    "**END OF REPORT**" ) ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  initializereport (dummy )
  IF ((_bsubreport = 0 ) )
   ...
   ELSE
    ...
    SET rptreport->m_reportname = "HIM_MAK_PROD_ANALYSIS_SUM_GRP"
