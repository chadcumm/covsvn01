...
******************************************************************************
	...
	Source file name:	cov_mak_prod_analysis_sum_ngrp.prg
	Object name:		cov_mak_prod_analysis_sum_ngrp
	Request #:			8333
 
	Program purpose:	Lists deficiency summary data ungrouped.
...
DROP PROGRAM cov_mak_prod_analysis_sum_ngrp GO
CREATE PROGRAM cov_mak_prod_analysis_sum_ngrp
 prompt 
...
with OUTDEV, ORGANIZATIONS, STARTDATERANGE, ENDDATERANGE, USERNAMES, TASKQUEUES, 
  ...
  SELECT
   ...
   HEAD REPORT
    ...
    _htmlfileinfo->file_buf = build2 ("<STYLE>" ,
     ...
     " vertical-align: middle;}" ,".FieldName0360 { border-width: 0.025in; border-color: #000000;" ,
     " border-style: none none none none;" ," padding: 0.000in 0.000in 0.000in 0.000in;" ,
 ...
 SUBROUTINE  fieldname01html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName010' colspan='9'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName0" ,
 ...
 SUBROUTINE  fieldname02html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName020' colspan='9'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName1" ,"Summary Report" ) ,
   "</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname09html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='1'>" ,"" ,"</td>"
   ,"<td class='FieldName050' colspan='3'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName5" ,"User Name(s):" ) ,"</td>" ,
 ...
 SUBROUTINE  fieldname010html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName040' colspan='1'>" ,"" ,"</td>"
   ,"<td class='FieldName050' colspan='3'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName7" ,"Task Queue(s):" ) ,"</td>" ,
 ...
 SUBROUTINE  fieldname014html (dummy )
  IF ((rowcount > 0 ) )
   SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0140' colspan='2'>" ,
    uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName12" ,"User Name" ) ,
    "</td>" ,"<td class='FieldName0141' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName13" ,"Task Queue" ) ,"</td>" ,
    "<td class='FieldName0142' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName14" ,"Total Charts Analyzed" ) ,"</td>" ,
    "<td class='FieldName0142' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName17" ,"Avg LOS (Days)" ) ,"</td>" ,
    "<td class='FieldName0144' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName21" ,"Avg TAT (Discharge to Final)" ) ,"</td>" ,
    "<td class='FieldName0145' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
     "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName22" ,"Avg TAT Task (Create to Final)" ) ,"</td>" ,
    "</tr>" )
   SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
  ENDIF
 END ;Subroutine
 ...
 SUBROUTINE  fieldname019html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0140' colspan='2'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName47" ,"User Name" ) ,
   "</td>" ,"<td class='FieldName0141' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName52" ,"Task Queue" ) ,"</td>" ,
   "<td class='FieldName0141' colspan='2'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName53" ,"Total Charts Analyzed" ) ,"</td>" ,
   "<td class='FieldName0142' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName56" ,"Avg LOS (Days)" ) ,"</td>" ,
   "<td class='FieldName0144' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName59" ,"Avg TAT (Discharge to Final)" ) ,"</td>" ,
   "<td class='FieldName0144' colspan='1'>" ,uar_i18ngetmessage (_hi18nhandle ,
    "HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName60" ,"Avg TAT Task (Create to Final)" ) ,"</td>" ,
   "</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 ...
 SUBROUTINE  fieldname026html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0260' colspan='9'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName48" ,
 ...
 SUBROUTINE  fieldname027html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0270' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName72" ,
 ...
 SUBROUTINE  fieldname028html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0270' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName49" ,
 ...
 SUBROUTINE  fieldname029html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0270' colspan='3'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_CellName9" ,
 ...
 SUBROUTINE  fieldname036html (dummy )
  SET _htmlfileinfo->file_buf = build2 ("<tr>" ,"<td class='FieldName0360' colspan='9'>" ,
   uar_i18ngetmessage (_hi18nhandle ,"HIM_MAK_PROD_ANALYSIS_SUM_NGRP_EndOfReport" ,
    "**END OF REPORT**" ) ,"</td>" ,"</tr>" )
  SET _htmlfilestat = cclio ("WRITE" ,_htmlfileinfo )
 END ;Subroutine
 SUBROUTINE  initializereport (dummy )
  IF ((_bsubreport = 0 ) )
   ...
   ELSE
    ...
    SET rptreport->m_reportname = "HIM_MAK_PROD_ANALYSIS_SUM_NGRP"
