...
0004    12/21/2021  Dawn Greer, DBA         CR 11789 - Put in documentation
                                            of what the encntr_type_cd values are                                          
*************************************************************************/
...
FROM task_activity ta
	, (LEFT JOIN encounter enc ON (ta.encntr_id = enc.encntr_id
		AND enc.encntr_type_cd IN ( 2554389963.00 /*Phone Message*/,   22282402.00 /*Clinic*/)))	;0004
