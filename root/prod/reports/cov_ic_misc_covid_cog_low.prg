...
drop program cov_ic_misc_covid_cog_low:dba go
create program cov_ic_misc_covid_cog_low:dba
...
head report
	log_message = "No Cogulation CRIT/LOW lvl found"
	retval = 0
detail
	log_message = concat("Cogulation CRIT/LOW lvl found on ",format(ce.event_end_dt_tm,";;q"))
	retval = 100
