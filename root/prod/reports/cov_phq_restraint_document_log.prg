...
******************************************************************************
	...
	Source file name:  	cov_phq_restraint_document_log.prg
	Object name:		cov_phq_restraint_document_log
	Request#:			1045
...
drop program cov_phq_restraint_document_log:DBA go
create program cov_phq_restraint_document_log:DBA
...
,( ( select distinct ce.person_id, ce.encntr_id,ce.event_cd, ce.result_val, ce.performed_dt_tm, ce.performed_prsnl_id
...
;Populate Demographic and clinical events
Head report
cnt = 0
