...
execute 2_cov_him_mak_defic_by_phys value(concat(t_rec->files.file_path,t_rec->report_name_1)),value(0),value(0)
call addAttachment(t_rec->files.file_path,t_rec->report_name_1)
call writeLog(build2("* END   Execute First Deficiency Report ********************"))

call writeLog(build2("* START Execute Last Deficiency Report *********************"))
execute 2_cov_him_mak_defic_by_phys value(concat(t_rec->files.file_path,t_rec->report_name_2)),value(0),value(0)
call addAttachment(t_rec->files.file_path,t_rec->report_name_2)
