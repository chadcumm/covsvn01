...
******************************************************************************
	...
	Request#:			10435
	Program purpose:	      Nozin med on cvl patients
	Executing from:		Rule
 	Special Notes:
...
drop program cov_cvl_nozin_med_rule:dba go
create program cov_cvl_nozin_med_rule:dba
...
set retval = 0
set log_message = 'Existing Nozin/Bacto Order Found'
...
if(active_nozin_var != 'Yes' and active_bacto_var != 'Yes')
	 set retval = 100
	 set log_message = 'No existing Nozin/Bacto Order Found'
endif
