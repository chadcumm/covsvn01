...
with OUTDEV, facility, unit, testtype, testsubtype, test, containertype, prov,
	consultprov, enctype, bdate, edate, sumdet
...
DECLARE enctypenameprmpt = vc
 ...
 CALL ECHO(BUILD("Test Type Prompt ", $testtype))
 CALL ECHO(BUILD("Test SubType Prompt ", $testsubtype))
/**************************************************************
; Prompts
**************************************************************/
/**************************************************************
