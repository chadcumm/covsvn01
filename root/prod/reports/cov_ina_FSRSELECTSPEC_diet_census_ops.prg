...
drop program cov_ina_FSRSELECTSPEC_cs_ops:dba go
create program cov_ina_FSRSELECTSPEC_cs_ops:dba
...
declare filename_var = vc WITH noconstant(CONCAT('cer_temp:', 'fsr_selectspec_diet_census.pdf')), PROTECT
declare ccl_filepath_var = vc WITH noconstant(CONCAT('$cer_temp/', 'fsr_selectspec_diet_census.pdf')), PROTECT
...
if(iOpsInd = 1)
	execute cov_ina_dietcensus_lb VALUE(filename_var), VALUE(2553765627.00)
