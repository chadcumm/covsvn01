...
******************************************************************************
	...
	Solution:			Quality
	Source file name:  	cov_autoset_acute_and_sbu.prg
	Object name:		cov_autoset_acute_and_sbu
	CR#:				Supporting CCL for facility prompt
	Program purpose:		Combining Acute and SBU locations
	Executing from:		CCL
...
create program cov_autoset_acute_and_sbu:dba
...
into 'nl:'
	...
	,description = uar_get_code_description(l.location_cd)
	, l.location_cd
