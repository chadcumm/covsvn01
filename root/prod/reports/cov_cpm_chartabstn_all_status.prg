...
******************************************************************************
	...
	Source file name:	      cov_cpm_chartabstn_all_status.prg
	Object name:		cov_cpm_chartabstn_all_status
 
	Request#:			1396
	Program purpose:	      To get patients have been added to a schedule that need to have chart abstraction completed.
				      Patients with all status
...
drop program cov_cpm_chartabstn_all_status:dba go
create program cov_cpm_chartabstn_all_status:dba
