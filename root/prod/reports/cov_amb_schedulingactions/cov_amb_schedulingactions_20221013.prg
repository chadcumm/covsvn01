...
009		06/08/21	David Baumgardner		Increasing the time so the queries can run.
010		10/06/21	David Baumgardner		CR10725 Add in the next the patient's next office visit appt with the ordering provider group
...
; 011 pull the latest prior auth field to prevent earlier expire dates from pulling.
