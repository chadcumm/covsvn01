...
drop program cov_gs_test3:dba go
create program cov_gs_test3:dba
...
;======================================================================================================
 ...
 select into $outdev
	...
	, ekg_order_dt = format(pat->plist[d1.seq].ekg_orderdt, 'mm/dd/yy hh:mm;;q')
...
;Facility | Date| Ordering Provider | EKG Order | EKG Priority
;| EKG Indication/ Reason for Procedure | Order for Resuscitation Status/ Medical Intervention
