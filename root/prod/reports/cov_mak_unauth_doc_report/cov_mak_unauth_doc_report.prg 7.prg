...
set him_request->date_flag = 0
set him_request->debug_ind = 1
set him_request->sort_flag = 1
set him_request->start_dt_tm = cnvtdatetime(curdate-5,0)
...
execute him_mak_unauth_doc_report with replace(request,him_request), replace(him_temp,temp)
