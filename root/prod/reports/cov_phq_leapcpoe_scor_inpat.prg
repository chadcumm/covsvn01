...
******************************************************************************
	...
	Solution:			Quality
	Request#:			12795
	Source file name:	      cov_phq_leapcpoe_scor_inpat.prg
	Object name:		cov_phq_leapcpoe_scor_inpat
	Program purpose:	      CPOE Leapfrog Scorecard for all facility
	Executing from:		DA2
 	Special Notes:		include all units and IP
...
5/2/22      Geetha    CR# 12795    Initial release
 
******************************************************************************/
 
drop program cov_phq_leapcpoe_scor_inpat:DBA go
create program cov_phq_leapcpoe_scor_inpat:DBA
...
,(
(select distinct
	e.loc_facility_cd, e.encntr_id, e.person_id, o.order_id, o.orig_order_dt_tm;, elh.loc_nurse_unit_cd
	, numerator = evaluate2(
...
from encounter e, orders o, order_action oa;, encntr_loc_hist elh
	...
	with sqltype('f8','f8','f8','f8','dq8','i2','i2') )i
)
