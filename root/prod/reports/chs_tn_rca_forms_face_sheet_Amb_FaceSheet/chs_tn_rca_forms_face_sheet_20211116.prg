 ...
 ***********************************************************************
  ...
  009      11/08/2021   Dawn Greer, DBA Cov   CR 11521 - Problem with provider
                                              ...
                                              and the resource appt.  Add the copay/
                                              financial responsibility back
  010      11/16/2021   Dawn Greer, DBA Cov   CR 11617 - Rendering Provider not pulling
                                              for an appt.                                              
 ***************************************************************************
...
, (INNER JOIN encounter enc ON (sa.encntr_id = enc.encntr_id))	;009
, (LEFT JOIN encntr_prsnl_reltn ep ON (sa.encntr_id = ep.encntr_id
	...
	AND ep.priority_seq IN (0,1) 		;010
	AND ep.active_ind = 1
...
HEAD sa.ENCNTR_ID
    ...
    addl_rec->fin_resp_amt = BUILD("$",TRIM(CNVTSTRING(enc.est_financial_resp_amt),3))	    ;005   ;009
