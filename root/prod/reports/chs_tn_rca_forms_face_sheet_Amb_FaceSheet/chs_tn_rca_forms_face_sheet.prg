 ...
 ***********************************************************************
  ...
  ------   ----------   -------------         ------------------------------ 
  0001     04/20/2018   RS043142              Initial Version                
  0002     07/18/2018   Dawn Greer, DBA Cov   Add Resource/rend provider     
                                              from encounter                 
  0003     03/19/2019   Dawn Greer, DBA Cov   Add Gender, Reason for Visit   
                                              Appt Comments, Location, and   
                                              Health Plan                    
  0004     10/15/2019   Dawn Greer, DBA Cov   CR 6221 (old CR 4700) Adding   
                                              time to the Appt Date          
  0005     10/15/2019   Dawn Greer, DBA Cov   CR 6221 (old CR 4700) Adding   
                                              Financial Responsibility  
  0006     03/02/2021   Dawn Greer, DBA Cov   CR 9702 Truncate Comment to 
                                              100 characters          
 ***************************************************************************
