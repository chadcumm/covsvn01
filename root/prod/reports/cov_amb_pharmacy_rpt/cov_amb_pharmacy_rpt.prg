...
******************************************************************************
	...
	Solution:			Ambulatory
	Source file name:	cov_amb_pharmacy_rpt.prg
	Object name:		cov_amb_pharmacy_rpt
	Request #:
...
drop program cov_amb_pharmacy_rpt go
create program cov_amb_pharmacy_rpt
...
with OUTDEV, OUTPUT_FILE, startdate, enddate
...
IF ($output_file = 1)
	SET startdate = CNVTDATETIME(CURDATE-15,0)
	SET enddate = CNVTDATETIME(CURDATE-8,235959)
ELSE 
	SET startdate = CNVTDATETIME($startdate)
	SET enddate = CNVTDATETIME($enddate)
ENDIF
...
;
;	HEAD REPORT
;		output_rec = build("Facility", cov_tab,
;					"Facility_Tax_ID", cov_tab,
;					"FIN", cov_tab,
;					"PatientName", cov_tab,
;					"Patient_DOB", cov_tab,
;					"Encntr_Id", cov_tab,
;					"Enc_Type", cov_tab,
;					"Enc_Date_DOS", cov_tab,
;					"Enc_Diag_Code1", cov_tab,
;					"Enc_Diag_Desc1", cov_tab,
;					"Enc_Diag_Code2", cov_tab,
;					"Enc_Diag_Desc2", cov_tab,
;					"Enc_Diag_Code3", cov_tab,
;					"Enc_Diag_Desc3", cov_tab,
;					"Enc_Diag_Code4", cov_tab,
;					"Enc_Diag_Desc4", cov_tab,
;					"Enc_Diag_Code5", cov_tab,
;					"Enc_Diag_Desc5", cov_tab,
;					"Enc_Diag_Code6", cov_tab,
;					"Enc_Diag_Desc6", cov_tab,
;					"Enc_Diag_Code7", cov_tab,
;					"Enc_Diag_Desc7", cov_tab,
;					"Enc_Diag_Code8", cov_tab,
;					"Enc_Diag_Desc8", cov_tab,
;					"Enc_Diag_Code9", cov_tab,
;					"Enc_Diag_Desc9", cov_tab,
;					"Enc_Diag_Code10", cov_tab,
;					"Enc_Diag_Desc10", cov_tab,
;					"Order_Provider", cov_tab,
;					"Order_Provider_NPI", cov_tab,
;					"Supervising_Provider", cov_tab,
;					"Supervising_Provider_NPI", cov_tab,
;					"Order_id", cov_tab,
;					"Order_Date", cov_tab,
;					"Order_Communication_Type", cov_tab,
;					"Medication", cov_tab,
;					"Order_Status", cov_tab,
;					"Special_Instructions", cov_tab,
;					"Frequency", cov_tab,
;					"Volume_Dose", cov_tab,
;					"Volume_Dose_Unit", cov_tab,
;					"Drug_Form", cov_tab,
;					"Duration", cov_tab,
;					"Duration_Unit", cov_tab,
;					"Rate", cov_tab,
;					"Rate_Unit", cov_tab,
;					"RX_Route", cov_tab,
;					"Strength_Dose", cov_tab,
;					"Strength_Dose_Unit", cov_tab,
;					"Disp_Qty", cov_tab,
;					"Disp_Unit", cov_tab,
;					"Nbr_Refill", cov_tab,
;					"Total_Refill", cov_tab,
;					"Start_Date", cov_tab,
;					"Stop_Date", cov_tab,
;					"Prn_Instruction", cov_tab,
;					"Indication", cov_tab,
;					"Pharmacy_Route", cov_tab,
;					"Pharmacy_Name", cov_tab,
;					"eRX_Note", cov_tab,
;					"Diagnosis_Code1", cov_tab,
;					"Diagnosis_Desc1", cov_tab,
;					"Diagnosis_Code2 ", cov_tab,
;					"Diagnosis_Desc2 ", cov_tab,
;					"Diagnosis_Code3", cov_tab,
;					"Diagnosis_Desc3", cov_tab,
;					"Diagnosis_Code4", cov_tab,
;					"Diagnosis_Desc4", cov_tab,
;					"Diagnosis_Code5", cov_tab,
;					"Diagnosis_Desc5", cov_tab,
;					"Drug_Identifier", cov_tab,
;					"Parent_Category_Id", cov_tab,
;					"Parent_Category", cov_tab,
;					"Sub_Category_ID", cov_tab,
;					"Sub_Category", cov_tab,
;					"Sub_Sub_Category_ID", cov_tab,
;					"Sub_Sub_Category")
;		col 0 output_rec
;		row + 1
;
...
CALL ECHO (BUILD("OUTDEV", CHAR(9), VALUE($outdev)))
CALL ECHO (BUILD("OUTPUT FILE", CHAR(9), VALUE($output_file)))
;
;IF ($outdev = "MINE" AND $output_file = 1)
;	CALL ECHO (BUILD("Sending to a file"))
...
;IF ($outdev = "MINE" AND $output_file = 0)
;	CALL ECHO (BUILD("Sending to the screen"))
	SELECT INTO VALUE($outdev)
		Facility = exp_data->list[dt.seq].Facility
		,Facility_Tax_Id = exp_data->list[dt.seq].Facility_Tax_ID
		,FIN = exp_data->list[dt.seq].FIN
		,Patient_Name = exp_data->list[dt.seq].PatientName
		,Patient_DOB = exp_data->list[dt.seq].Patient_DOB
		,Encntr_id = exp_data->list[dt.seq].Encntr_id
		,Enc_Type = exp_data->list[dt.seq].Enc_Type
		,Enc_Date_DOS = exp_data->list[dt.seq].Enc_Date_DOS
		,Enc_Diag_Code1 = exp_data->list[dt.seq].Enc_Diag_Code1
		,Enc_Diag_Desc1 = exp_data->list[dt.seq].Enc_Diag_Desc1
		,Enc_Diag_Code2 = exp_data->list[dt.seq].Enc_Diag_Code2
		,Enc_Diag_Desc2 = exp_data->list[dt.seq].Enc_Diag_Desc2
		,Enc_Diag_Code3 = exp_data->list[dt.seq].Enc_Diag_Code3
		,Enc_Diag_Desc3 = exp_data->list[dt.seq].Enc_Diag_Desc3
		,Enc_Diag_Code4 = exp_data->list[dt.seq].Enc_Diag_Code4
		,Enc_Diag_Desc4 = exp_data->list[dt.seq].Enc_Diag_Desc4
		,Enc_Diag_Code5 = exp_data->list[dt.seq].Enc_Diag_Code5
		,Enc_Diag_Desc5 = exp_data->list[dt.seq].Enc_Diag_Desc5
		,Enc_Diag_Code6 = exp_data->list[dt.seq].Enc_Diag_Code6
		,Enc_Diag_Desc6 = exp_data->list[dt.seq].Enc_Diag_Desc6
		,Enc_Diag_Code7 = exp_data->list[dt.seq].Enc_Diag_Code7
		,Enc_Diag_Desc7 = exp_data->list[dt.seq].Enc_Diag_Desc7
		,Enc_Diag_Code8 = exp_data->list[dt.seq].Enc_Diag_Code8
		,Enc_Diag_Desc8 = exp_data->list[dt.seq].Enc_Diag_Desc8
		,Enc_Diag_Code9 = exp_data->list[dt.seq].Enc_Diag_Code9
		,Enc_Diag_Desc9 = exp_data->list[dt.seq].Enc_Diag_Desc9
		,Enc_Diag_Code10 = exp_data->list[dt.seq].Enc_Diag_Code10
		,Enc_Diag_Desc10 = exp_data->list[dt.seq].Enc_Diag_Desc10
		,Order_Provider = exp_data->list[dt.seq].ordlist[dt2.seq].Order_Provider
		,Order_Provider_NPI = exp_data->list[dt.seq].ordlist[dt2.seq].Order_Provider_NPI
		,Supervising_Provider = exp_data->list[dt.seq].ordlist[dt2.seq].Supervising_Provider
		,Supervising_Provider_NPI = exp_data->list[dt.seq].ordlist[dt2.seq].Supervising_Provider_NPI
		,Order_id = exp_data->list[dt.seq].ordlist[dt2.seq].Order_id
		,Order_Date = exp_data->list[dt.seq].ordlist[dt2.seq].Order_Date
		,Order_Communication_Type = exp_data->list[dt.seq].ordlist[dt2.seq].Order_Communication_Type
		,Medication = exp_data->list[dt.seq].ordlist[dt2.seq].Medication
		,Order_Status = exp_data->list[dt.seq].ordlist[dt2.seq].Order_Status
		,Special_Instructions = exp_data->list[dt.seq].ordlist[dt2.seq].Special_Instructions
		,Frequency = exp_data->list[dt.seq].ordlist[dt2.seq].Frequency
		,Volume_Dose = exp_data->list[dt.seq].ordlist[dt2.seq].Volume_Dose
		,Volume_Dose_Unit = exp_data->list[dt.seq].ordlist[dt2.seq].Volume_Dose_Unit
		,Drug_Form = exp_data->list[dt.seq].ordlist[dt2.seq].Drug_Form
		,Duration = exp_data->list[dt.seq].ordlist[dt2.seq].Duration
		,Duration_Unit = exp_data->list[dt.seq].ordlist[dt2.seq].Duration_Unit
		,Rate = exp_data->list[dt.seq].ordlist[dt2.seq].Rate
		,Rate_Unit = exp_data->list[dt.seq].ordlist[dt2.seq].Rate_Unit
		,RX_Route = exp_data->list[dt.seq].ordlist[dt2.seq].RX_Route
		,Strength_Dose = exp_data->list[dt.seq].ordlist[dt2.seq].Strength_Dose
		,Strength_Dose_Unit = exp_data->list[dt.seq].ordlist[dt2.seq].Strength_Dose_Unit
		,Disp_Qty = exp_data->list[dt.seq].ordlist[dt2.seq].Disp_Qty
		,Disp_Unit = exp_data->list[dt.seq].ordlist[dt2.seq].Disp_Unit
		,Nbr_Refill = exp_data->list[dt.seq].ordlist[dt2.seq].Nbr_Refill
		,Total_Refill = exp_data->list[dt.seq].ordlist[dt2.seq].Total_Refill
		,Start_Date = exp_data->list[dt.seq].ordlist[dt2.seq].Start_Date
		,Stop_Date = exp_data->list[dt.seq].ordlist[dt2.seq].Stop_Date
		,Prn_Instruction = exp_data->list[dt.seq].ordlist[dt2.seq].Prn_Instruction
		,Indication = exp_data->list[dt.seq].ordlist[dt2.seq].Indication
		,Pharmacy_Route = exp_data->list[dt.seq].ordlist[dt2.seq].Pharmacy_Route
		,Pharmacy_Name = exp_data->list[dt.seq].ordlist[dt2.seq].Pharmacy_Name
		,eRX_note = exp_data->list[dt.seq].ordlist[dt2.seq].eRX_Note
		,Diagnosis_Code1 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Code1
		,Diagnosis_Desc1 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Desc1
		,Diagnosis_Code2 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Code2
		,Diagnosis_Desc2 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Desc2
		,Diagnosis_Code3 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Code3
		,Diagnosis_Desc3 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Desc3
		,Diagnosis_Code4 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Code4
		,Diagnosis_Desc4 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Desc4
		,Diagnosis_Code5 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Code5
		,Diagnosis_Desc5 = exp_data->list[dt.seq].ordlist[dt2.seq].Diagnosis_Desc5
		,Drug_Identifier = exp_data->list[dt.seq].ordlist[dt2.seq].Drug_Identifier
		,Parent_Category_id = exp_data->list[dt.seq].ordlist[dt2.seq].Parent_Category_Id
		,Parent_Category = exp_data->list[dt.seq].ordlist[dt2.seq].Parent_Category
		,Sub_Category_id = exp_data->list[dt.seq].ordlist[dt2.seq].Sub_Category_ID
		,Sub_Category = exp_data->list[dt.seq].ordlist[dt2.seq].Sub_Category
		,Sub_Sub_Category_id = exp_data->list[dt.seq].ordlist[dt2.seq].Sub_Sub_Category_ID
		,Sub_Sub_Category = exp_data->list[dt.seq].ordlist[dt2.seq].Sub_Sub_Category
	FROM (DUMMYT DT WITH SEQ = exp_data->output_cnt) ;VALUE(SIZE(exp_data->list, 5)))
		,(DUMMYT DT2 WITH SEQ = 1)
 	PLAN DT WHERE MAXREC(DT2, exp_data->list[DT.SEQ].ordcnt)
 	JOIN DT2
