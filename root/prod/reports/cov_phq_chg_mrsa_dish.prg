...
******************************************************************************
	...
	Solution:			Quality
	Source file name:	      cov_phq_chg_mrsa_dish.prg
	Object name:		cov_phq_chg_mrsa_dish
	Request#:			9964
	Program purpose:	      MRSA/CHG Project
	Executing from:		One time proccess to adjust the feed
 	Special Notes:          Discharged patients data - addition to the daily feed
...
drop program cov_phq_chg_mrsa_dish:dba go
create program cov_phq_chg_mrsa_dish:dba
...
;test ----------
declare filename_var  = vc with constant('cer_temp:cov_mrsa_dish_pat.txt'), protect
declare ccl_filepath_var = vc WITH constant('$cer_temp/cov_mrsa_dish_pat.txt'), PROTECT
;---------------*/
