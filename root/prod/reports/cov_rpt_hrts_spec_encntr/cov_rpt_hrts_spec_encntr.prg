...
******************************************************************************
	...
	Source file name:	cov_rpt_hrts_spec_encntr.prg
	Object name:		cov_rpt_hrts_spec_encntr
	Request #:
...
013     10/06/2021  Chad Cummings			Added specific encounters
******************************************************************************/
 
drop program cov_rpt_hrts_spec_encntr:dba go
create program cov_rpt_hrts_spec_encntr:dba
...
set t_rec->curprog2 = "cov_rpt_op_readiness2" ;override for dev script
...
plan cv1
	where cv1.code_set 				= t_rec->custom_code_set
	and   cv1.definition 			= trim(cnvtlower(t_rec->curprog2))
	and   cv1.active_ind 			= 1
	and   cv1.begin_effective_dt_tm <= cnvtdatetime(curdate,curtime3)
	and   cv1.end_effective_dt_tm 	>= cnvtdatetime(curdate,curtime3)
...
from
	...
	,person p
plan e
	where e.encntr_id in(125934579,
					125009690,
					125702915,
					126236616,
					123895541,
