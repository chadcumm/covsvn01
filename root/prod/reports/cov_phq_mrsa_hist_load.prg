...
drop program cov_phq_mrsa_hist_load:dba go
create program cov_phq_mrsa_hist_load:dba
...
;test ----------
declare filename_var  = vc with constant('cer_temp:cov_mrsa_jul21_aug05.txt'), protect
declare ccl_filepath_var = vc WITH constant('$cer_temp/cov_mrsa_jul21_aug05.txt'), PROTECT
;---------------*/
