...
SELECT into $OUTDEV
	...
	, ENCNTR_QUAL_REG_DT_TM = T_REC->encntr_qual[D1.SEQ].reg_dt_tm
	...
	, ENCNTR_QUAL_ORIG_ORDER_DT_TM = T_REC->encntr_qual[D1.SEQ].orig_order_dt_tm
	, ENCNTR_QUAL_BIRTH_DT_TM = T_REC->encntr_qual[D1.SEQ].birth_dt_tm
	...
	, ENCNTR_QUAL_ORDER_ACTION_DT_TM = T_REC->encntr_qual[D1.SEQ].order_action_dt_tm
	...
	, ENCNTR_QUAL_COSIGN_DT_TM = T_REC->encntr_qual[D1.SEQ].cosign_dt_tm
