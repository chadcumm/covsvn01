...
select into $OUTDEV
	...
	,primary_hp = trim(t_rec->encntr_qual[d1.seq].primary_hp )
	,secondary_hp = trim(t_rec->encntr_qual[d1.seq].secondary_hp )
	,patient_name = trim(t_rec->encntr_qual[d1.seq].patient_name )
	...
	,order_status = trim(t_rec->encntr_qual[d1.seq].order_status )
	,order_action_prsnl =trim(t_rec->encntr_qual[d1.seq].order_action_prsnl  )
	,order_action_position = trim(t_rec->encntr_qual[d1.seq].order_action_position )
	,order_action_dt_tm = trim(format(t_rec->encntr_qual[d1.seq].order_action_dt_tm , ";;q"))
	,order_communication_type = trim(t_rec->encntr_qual[d1.seq].order_communication_type )
	...
	,cosigned_position = trim(t_rec->encntr_qual[d1.seq].cosigned_position )
	,cosign_dt_tm = trim(format( t_rec->encntr_qual[d1.seq].cosign_dt_tm ,";;q"))
	,cosign_status = trim(t_rec->encntr_qual[d1.seq].cosign_status )
