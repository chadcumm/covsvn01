...
******************************************************************************
	...
	Source file name:	cov_cpdi_act_audit_wqm.prg
	Object name:		cov_cpdi_act_audit_wqm
	Request #:			6874

	Program purpose:	CDI transaction log of batches named 'WQM*'.
...
drop program cov_cpdi_act_audit_wqm:dba go
create program cov_cpdi_act_audit_wqm:dba
...
where
 	t_rec->qual[d1.seq].batch_name = patstring("WQM*")
order by
