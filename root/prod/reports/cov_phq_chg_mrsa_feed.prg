...
drop program cov_phq_chg_mrsa_feed:dba go
create program cov_phq_chg_mrsa_feed:dba
...
plan e where e.loc_facility_cd = $acute_facility_list
	and e.reg_dt_tm between cnvtdatetime('01-JAN-2021 00:00:00') and cnvtdatetime($end_datetime)
	and e.encntr_type_cd in(309308.00, 309312.00,19962820.00);Inpatient,Observation,Outpatient in a Bed
	and e.active_ind = 1
	and e.disch_dt_tm = null
