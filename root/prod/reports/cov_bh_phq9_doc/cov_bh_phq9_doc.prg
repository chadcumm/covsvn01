...
******************************************************************************
	...
	Solution:			BH
	Source file name:		cov_bh_phq9_doc.prg
	Object name:		cov_bh_phq9_doc
 	Request#:			8782
	Program purpose:
	Executing from:		DA2
 	Special Notes:
...
drop program cov_bh_phq9_doc:dba go
create program cov_bh_phq9_doc:dba
...
Head levent_priority
	;Initial Score
	call echo(build2(lpersonid,'levent_priority = ', levent_priority,
		'--levent_id = ',levent_id,'--lmin1_eventid = ',lmin1_eventid,'--lmin2_eventid = ',lmin1_eventid  ))
...
;Final result
select into $outdev
	repo_type =  'PHQ-9' ;if($repo_type = 1) 'GAD-7' else 'PHQ-9' endif
