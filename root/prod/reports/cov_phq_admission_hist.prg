...
******************************************************************************
	...
	Date Written:		Nov'2019
	Solution:			Quality
	Source file name:	      cov_phq_admission_hist.prg
	Object name:		cov_phq_admission_hist
	Request#:			6682
	Program purpose:	      Admission History Compliance
	Executing from:		DA2
...
drop program cov_phq_admission_hist:dba go
create program cov_phq_admission_hist:dba
...
, e.loc_facility_cd, ea.alias, p.name_full_formatted, elh.loc_bed_cd, elh.loc_room_cd, e.updt_dt_tm
...
order by facility, admit_dt, patient_name
