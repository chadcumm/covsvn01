...
head page
    ...
    "{CPI/9}{POS/0/64}{B}" call CENTER(trim(orders->org_name),1,186), row+1 
  	"{CPI/9}{POS/0/80}{B}" call CENTER(trim(orders->org_street_add),1,186), row+1 
  	"{CPI/9}{POS/0/96}{B}" call CENTER(trim(orders->org_city_state_zip),1,186), row+1 
