...
order by
 ...
 detail
    ...
    orders->isolation[orders->isolation_cnt].isolation_status =  
        concat(trim(ocs.mnemonic),":","  ",trim(o.clinical_display_line))
with nocounter
...
order by
 ...
 detail
    ...
    orders->code_status[orders->code_status_cnt].code_status_disp =  
        concat(trim(ocs.mnemonic),":","  ",trim(o.clinical_display_line))
with nocounter
...
head page
    ...
    "{CPI/15}{POS/85/285}",
	    call print(orders->code_status[1].code_status_disp), row+1
    ...
    ;else
    	"{CPI/15}{POS/85/295}{B}",
	    call print(orders->isolation[1].isolation_status), "{ENDB}", row+1
    ;endif
...
detail
  ...
  if (orders->qual[vv]->display_ind = 1)
	...
	"{CPI/15}{POS/300/385}", "Ambulation Assistance: ",
    ...
    "{CPI/15}", call print(calcpos(287,695)), "Communication Type: ",
        ...
        call print(orders->qual[vv].communication_type), qq row+1
