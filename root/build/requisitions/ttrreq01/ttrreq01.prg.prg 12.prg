...
head page
    ...
    "{CPI/15}{POS/255/285}{B}", call print(orders->code_status[1].code_status_disp), "{ENDB}", row+1
    ...
    ;else
    	...
    	"{CPI/15}{POS/155/295}{B}", call print(concat(orders->isolation[1].isolation_status)), "{ENDB}", row+1
    ;endif
