...
3.0     3/11/2019	ccummin4			Updated to new prg for PAT. Do not require pirmary surgeon
**************************************************************/
...
drop program cov1_sn_pat_sched go
create program cov1_sn_pat_sched
...
*/
JOIN sed16 WHERE se.sch_event_id =outerjoin( sed16.sch_event_id)
	AND sed16.oe_field_meaning = outerjoin("SURGEON1")
	AND sed16.version_dt_tm = outerjoin(cnvtdatetime ("31-DEC-2100 00:00:00.00" ))
	AND sed16.active_ind = ( 1)
