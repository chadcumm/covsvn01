...
******************************************************************************
  ...
  Solution:           
  Source file name:   cov_wh_psg_demographics.prg
  Object name:        cov_wh_psg_demographics
  Request #:
...
001	  02/25/2020  Chad Cummings			Removed address and phone
******************************************************************************/

DROP PROGRAM cov_wh_psg_demographics :dba GO
CREATE PROGRAM cov_wh_psg_demographics :dba
 ...
 SELECT
  ...
  head hp.health_plan_id ;002
   ...
   ELSE 
   002 */
   pt_info->hp_qual[hpcnt ].hp_address = snot_documented
   ;002 ENDIF
   ,
   /* 002 IF ((size (trim (ph.phone_num ) ) > 0 ) ) tempphone = fillstring (22 ," " ) ,tempphone =
   ...
   ELSE 
   002 */
   pt_info->hp_qual[hpcnt ].hp_phone = snot_documented
   ;002 ENDIF
  FOOT REPORT
