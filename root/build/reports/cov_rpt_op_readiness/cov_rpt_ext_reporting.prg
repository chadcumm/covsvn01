...
******************************************************************************
	...
	Source file name:	cov_rpt_ext_reporting.prg
	Object name:		cov_rpt_ext_reporting
	Request #:
...
drop program cov_rpt_ext_reporting:dba go
create program cov_rpt_ext_reporting:dba
...
call writeLog(build2("* START Finding Admitted Patient Lab Results ****************************"))
