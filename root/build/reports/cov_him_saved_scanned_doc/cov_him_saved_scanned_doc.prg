drop program cov_him_saved_scanned_doc go
create program cov_him_saved_scanned_doc
...
plan d
	...
	and   t_rec->qual[d.seq].scanning_prsnl > " "
	;and   t_rec->qual[d.seq].scanned_image > "0"
