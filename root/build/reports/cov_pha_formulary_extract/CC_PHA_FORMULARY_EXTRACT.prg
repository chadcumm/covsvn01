DROP PROGRAM CC_PHA_FORMULARY_EXTRACT GO
CREATE PROGRAM CC_PHA_FORMULARY_EXTRACT
 prompt 
...
with OUTDEV, FACILITY, ALLNDC
 ...
 ELSE
  SELECT distinct INTO $OUTDEV
	...
	;,mfoi3.med_def_flex_id
	;,mfoi3.med_flex_object_id
	;,mfoi3.sequence
	;,mfoi3.flex_object_type_cd
	, ndc = mi2.value
	, inner_ndc = mi4.value
	, default_route = uar_get_code_display (mod.route_cd )
	, form = uar_get_code_display (md.form_cd )
...
ORDER BY
	...
	, mfoi3.sequence
	, md.item_id
	,mi3.med_identifier_id
	,mi4.med_identifier_id
	,mi5.med_identifier_id
	,mi6.med_identifier_id
	,mi7.med_identifier_id
	,mi8.med_identifier_id
	,mi9.med_identifier_id
