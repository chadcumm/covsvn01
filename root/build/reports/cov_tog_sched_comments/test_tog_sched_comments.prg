...
drop program test_tog_sched_comments:DBA go
create program test_tog_sched_comments:DBA
...
from
    ...
    , (inner join code_value cv on sev.appt_type_cd = cv.code_value
       and cv.display in("ONC Extended Follow Up Visit","ONC Follow Up MD","ONC Follow Up Nurse Practioner",
						"ONC New Patient Appt*","ONC New Patient Appt - Hematology ",
						"ONC Backload Follow Up MD","ONC Backload Follow Up NP"))
