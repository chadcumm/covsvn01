...
detail
	...
	t_rec->qual[t_rec->cnt].freetext_allergy		= a.substance_ftdesc
...
set audit_header = build(
							...
							,char(34),^Allergy ID^			,char(34),char(44)
						)
...
for (i=1 to t_rec->cnt)
	...
	set audit_line = build(	
							...
							,char(34),	trim(cnvtstring(t_rec->qual[i].allergy_id))						,char(34),char(44)
							)
