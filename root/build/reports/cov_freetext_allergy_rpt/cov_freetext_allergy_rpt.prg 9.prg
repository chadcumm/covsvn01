...
detail
	...
	t_rec->qual[t_rec->cnt].freetext_allergy		= replace(t_rec->qual[t_rec->cnt].freetext_allerg,char(13)," ")
	t_rec->qual[t_rec->cnt].freetext_allergy		= replace(t_rec->qual[t_rec->cnt].freetext_allerg,char(44)," ")
