...
;7.0 set NoFallRiskData		= uar_i18ngetmessage(i18nHandle, "NoFallRiskData"," No")
 set NoFallRiskData	= "None"
/**************************************************************
; DVDev Start Coding
**************************************************************/
...
head pr.problem_id
	   ...
	   reply->custom_field[iCustomFieldIndex].custom_field_display             =
	   BUILD2(" ","Yes1"," ","(", PR.BEG_EFFECTIVE_DT_TM,")")
...
head	d.diagnosis_id
	   ...
	   reply->custom_field[iCustomFieldIndex].custom_field_display             =
	   BUILD2(" ","Yes2"," ","(", d.BEG_EFFECTIVE_DT_TM,")")
	   reply->custom_field[iCustomFieldIndex].custom_field_index               = 4
with nocounter 
