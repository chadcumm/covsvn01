...
set debug_ind = 1 go 
set request->batch_selection = "cov_trkfn_tracking_cleanup" go
...
set request->program_name = "cov_trkfn_tracking_cleanup" go
...
set debug_ind = 1 go 
execute cov_trkfn_tracking_cleanup "MINE"  go
