...
Source File		:	sch_inqa_stjude_persononly.prg
Object Name		:	sch_inqa_stjude_persononly
...
Special Notes	:
Usage			:	sch_inqa_stjude_persononly go
...
************************************************************/
DROP PROGRAM sch_inqa_stjude_persononly :dba GO
CREATE PROGRAM sch_inqa_stjude_persononly :dba
 ...
 ENDIF
 SELECT INTO "nl:"
  ad_exists = nullind (ad.sch_action_id ) ,
  l_exists = nullind (l.sch_lock_id ) ,
  a.queue_id
  FROM (sch_entry a ),
   (sch_event_action ea ),
   (sch_event e ),
  ...
  HEAD a.sch_action_id
   IF ((((l_exists = 1 ) ) OR ((l.status_flag = 3 )
...
ENDFOR
 ...
 IF ((pref_value_disppidrl = 1.0 ) )
  ...
  ;end select
 ENDIF
CALL ECHO(pref_value_disppidrl) 
