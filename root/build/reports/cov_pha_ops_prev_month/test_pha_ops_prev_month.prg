...
drop program test_pha_ops_prev_month:dba go
create program test_pha_ops_prev_month:dba
...
set t_rec->cons.dates.prev_year_start_dt_tm 
	= datetimefind(cnvtlookbehind(t_rec->cons.lookback.month,cnvtdatetime(curdate,curtime3)), 'M', 'B', 'B')
set t_rec->cons.dates.prev_year_end_dt_tm
	= datetimefind(cnvtlookbehind(t_rec->cons.lookback.month,cnvtdatetime(curdate,curtime3)), 'M', 'E', 'E')
...
set t_rec->cons.dates.prev_week_start_dt_tm 
	= datetimefind(cnvtlookbehind(t_rec->cons.lookback.week,cnvtdatetime(curdate,curtime3)), 'M', 'B', 'B')
set t_rec->cons.dates.prev_week_end_dt_tm
	= datetimefind(cnvtlookbehind(t_rec->cons.lookback.week,cnvtdatetime(curdate,curtime3)), 'M', 'E', 'E')

set t_rec->cons.dates.prev_day_start_dt_tm 
	= datetimefind(cnvtlookbehind(t_rec->cons.lookback.day,cnvtdatetime(curdate,curtime3)), 'M', 'B', 'B')
set t_rec->cons.dates.prev_day_end_dt_tm
	= datetimefind(cnvtlookbehind(t_rec->cons.lookback.day,cnvtdatetime(curdate,curtime3)), 'M', 'E', 'E')
