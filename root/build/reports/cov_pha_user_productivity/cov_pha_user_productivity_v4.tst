...
set request->batch_selection = ^cov_pha_user_productivity_v4 "mine", 1.0,"bdate", "edate"^ go
set request->output_dist = "chad.cummings@covhlth.com;" go
;set request->output_dist = "chad.cummings@covhlth.com;TPaterso@CovHlth.com;rcak@CovHlth.com" go
...
set request->program_name = "cov_pha_user_productivity_v4" go
...
set debug_ind = 1 go
execute 
cov_pha_user_productivity_v4
"MINE", 1.0, "24-JUN-2020 00:00:00", "25-JUN-2020 23:59:00" ,0
go
