...
002		02/26/2020	Dan Herren				Fixed wrapping on Order Detail field.
 
************************************************************/
 
drop program cov_pha_user_productivity_ops go
create program cov_pha_user_productivity_ops
...
DECLARE filename2		=	vc WITH
CONSTANT(BUILD('cer_temp:','V3_CovHlth_Detail_Rx_Stats_',FORMAT(curdate,'yyyymmdd;;q'),'.txt')), PROTECT
...
if (validate(request->batch_selection)  > 0)
	...
	SET bdate = cnvtdatetime("01-MAY-2020 00:00:00")
