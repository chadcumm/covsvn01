drop program cov_anes_saved_notes go
create program cov_anes_saved_notes
...
plan d
	...
	and   t_rec->qual[d.seq].status in( "Expected Sign", "Sign")
	and   t_rec->qual[d.seq].physician_position = "Perioperative - CRNA"
