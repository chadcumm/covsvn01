...
select into $OUTDEV
	...
	,DOB = format(cnvtdatetimeutc(datetimezone(p.birth_dt_tm,p.birth_tz),1),'DD-MMM-YYYY;;q')
	,visit_date = format(e.reg_dt_tm,"DD-MMM-YYYY;;q")
	,discharge_date = format(e.disch_dt_tm,"DD-MMM-YYYY;;q")
