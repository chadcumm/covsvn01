...
head e.encntr_id
	...
	if (idx > 0)
		...
		t_rec->prsnl_qual[d1.seq].encntr_qual[idx].patient_name = p.name_full_formatted
		t_rec->prsnl_qual[d1.seq].encntr_qual[idx].loc_facility_cd = e.loc_facility_cd
		t_rec->prsnl_qual[d1.seq].encntr_qual[idx].loc_nurse_unit_cd = e.loc_nurse_unit_cd
		t_rec->prsnl_qual[d1.seq].encntr_qual[idx].facilitiy = uar_get_code_display(e.loc_facility_cd)
		t_rec->prsnl_qual[d1.seq].encntr_qual[idx].unit = uar_get_code_display(e.loc_nurse_unit_cd)
...
plan d1
join d2
	where maxrec(d2,t_rec->prsnl_qual[d1.seq].encntr_cnt)
join ea
