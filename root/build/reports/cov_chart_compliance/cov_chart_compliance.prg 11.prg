...
set t_rec->encntr_prsnl_reltn_cnt = (t_rec->encntr_prsnl_reltn_cnt + 1)
set stat = alterlist(t_rec->encntr_prsnl_reltn_qual,t_rec->encntr_prsnl_reltn_cnt)
set t_rec->encntr_prsnl_reltn_qual[t_rec->encntr_prsnl_reltn_cnt].encntr_prsnl_r_cd = code_values->cv.cs_333.attenddoc_cd
set t_rec->encntr_prsnl_reltn_qual[t_rec->encntr_prsnl_reltn_cnt].encntr_prsnl_r_cd = code_values->cv.cs_333.admitdoc_cd
set t_rec->encntr_prsnl_reltn_qual[t_rec->encntr_prsnl_reltn_cnt].encntr_prsnl_r_cd = code_values->cv.cs_333.admitdoc_cd
