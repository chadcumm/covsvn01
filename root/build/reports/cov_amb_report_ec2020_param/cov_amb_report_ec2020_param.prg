...
******************************************************************************
	...
	Source file name:	cov_amb_report_ec2020_param.prg
	Object name:		cov_amb_report_ec2020_param
	Request #:
...
drop program cov_amb_report_ec2020_param:dba go
create program cov_amb_report_ec2020_param:dba
...
set t_rec->report_program 			= ^lh_ec2020_ops_report^
...
set t_rec->13_qrdamode				= ^CMS^
set t_rec->14_reportby				= ^INDV^

set t_rec->merged.filename 		= concat("cov_nqf2020_ops_" ,format(cnvtdatetime(curdate,curtime3),"MMDDYYYY_HHMMSS;;q"),".csv")
