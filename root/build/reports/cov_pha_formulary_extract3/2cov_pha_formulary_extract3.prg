...
*   003          AUG 2021	 Chad Cummings		   corrected Primary NDC
*
*******************************************************************************/
 
drop program cov_pha_formulary_extract3:dba GO
create program cov_pha_formulary_extract3:dba
...
if ($ALLNDC = "Yes")
    ...
    ,(inner join MED_FLEX_OBJECT_IDX mfoi3 on mfoi3.parent_entity_id = mi2.med_product_id
    	and mfoi3.active_ind = 1 ;003
   		and mfoi3.sequence = 1)
 	,(inner join MED_DEF_FLEX mdf3 on mdf3.med_def_flex_id= mfoi3.med_def_flex_id ;003
 		and mdf3.active_ind = 1) ;003
    ...
    ;003 ,(inner join MED_DEF_FLEX mdf2 on mdf2.item_id = md.item_id
    ,(left join MED_DEF_FLEX mdf2 on mdf2.item_id = md.item_id
    ...
    ,(left join MED_IDENTIFIER mi4 on mi4.item_id = mi2.item_id
    	...
    	and mi4.primary_ind = 1 ;003
    	and mi4.value > ""	;003
    	and mi4.active_ind = 1)
    	
    ,(left join MED_FLEX_OBJECT_IDX mfoi4 on mfoi4.parent_entity_id = mi4.med_product_id ;004
    	and mfoi4.active_ind = 1 ;004
   		and mfoi4.sequence = 1) ;004
   		
   ,(left join MED_DEF_FLEX mdf4 on mdf4.med_def_flex_id = mfoi4.med_def_flex_id ;004
 		and mdf3.active_ind = 1) ;004
    ...
    */		  
    ...
    ,(inner join MED_FLEX_OBJECT_IDX mfoi3 on mfoi3.parent_entity_id = mi2.med_product_id ;003)
    	and mfoi3.active_ind = 1) ;003
