...
*	002			 SEP 2020    Chad Cummings		   updated alt_Sel_Cat selection from left to inner
*
*******************************************************************************/
...
from MEDICATION_DEFINITION 	md
	...
	,(inner  join ALT_SEL_LIST al on al.synonym_id = ocir.synonym_id)
 
	,(inner  join ALT_SEL_CAT ac on ac.alt_sel_category_id = al.alt_sel_category_id
		and ac.ahfs_ind = 1)
