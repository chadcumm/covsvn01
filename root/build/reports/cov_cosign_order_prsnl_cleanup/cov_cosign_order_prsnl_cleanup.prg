...
drop program cov_cosign_order_prsnl_cleanup go
create program cov_cosign_order_prsnl_cleanup
...
set t_rec->filename = "ccluserdir:orderprsnltemp.csv"
...
for (i= 1 to t_rec->cnt)
	execute oar_cosign_order_notif_cleanup t_rec->qual[i].person_id
endfor
#exit_script
