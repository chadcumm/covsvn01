...
drop program 2cov_ic_au_report_data:dba go
create program 2cov_ic_au_report_data:dba
...
from
	...
	,encntr_alias ea
plan l
	where l.facility_cd = $FACILITY
	and   l.verification_dt_tm between cnvtdatetime($START_DT_TM) and cnvtdatetime($END_DT_TM)
join o
