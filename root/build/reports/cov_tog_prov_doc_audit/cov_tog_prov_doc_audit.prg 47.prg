...
prompt 
	...
	, "Start Date" = "SYSDATE"
	, "End Date" = "SYSDATE"
	, "All Documents or Latest" = 0          ;* Return each instance of qualified documents for the date range or just the most re 

with OUTDEV, loc_phys, start_datetime, end_datetime, all_docs_ind
...
join ce
	...
	and   ce.event_end_dt_tm between cnvtdatetime(t_rec->start_dt_tm) and cnvtdatetime(t_rec->end_dt_tm)
order by
	 d1.seq
	,ce.event_cd
	;,ce.result_status_cd
