...
Program Title	:	Cancel By Person
Source File		:	sch_inqa_req_cancel_patonly.prg
Object Name		:	sch_inqa_req_cancel_patonly
...
Special Notes	:
Usage			:	sch_inqa_req_cancel_patonly go
...
************************************************************/
DROP PROGRAM sch_inqa_req_cancel_patonly :dba GO
CREATE PROGRAM sch_inqa_req_cancel_patonly :dba
 ...
 SET reply->attr_qual[t_index ].attr_label = uar_i18ngetmessage (i18nhandle ,"Latest Dt/Tm" ,
  "Latest Dt/Tm" )
 SET reply->attr_qual[t_index ].attr_type = "dq8"
 SET t_index = (t_index + 1 )
 ...
 SELECT INTO "nl:"
  ...
  HEAD a.sch_action_id
   ...
   ENDIF
   ,reply->query_qual[reply->query_qual_cnt ].req_made_dt_tm = cnvtdatetime (ea.action_dt_tm ) ,
