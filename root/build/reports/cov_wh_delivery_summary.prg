...
select into "NL:"
	...
	, facility_name        = uar_get_code_description(e.loc_facility_cd)
 	...
 	, age                  = cnvtage(max(pe.birth_dt_tm))
 	, mrn                  = max(ea1.alias)
...
from
	...
	,(
		( select distinct ce.encntr_id, ce.event_cd, ce.result_val, ce.updt_dt_tm, ce.result_status_cd
			...
			and ce.event_cd in
 			(edc_var, onset_labor_var, complete_dilation_var, plcnta_deli_time_var, deli_doctor_var, anesthesiologist_var,
 			anesthetist_var, deli_anesthesia_var, labor_anes_var, anes_medication_var, dt_anes_admins_var,
...
join i5 where i5.person_id = outerjoin(e.person_id)
	and i5.result_status_cd in(25,34,35)
	and i5.ordext3 = 1
...
select distinct into "NL:"
	...
	, infant_comp   	      = max(evaluate(i.event_cd, infant_comp_var,        i.result_val, 0, ""))
...
(
	...
	where ea.alias = $fin
		...
		vacum_activity_var, shoulder_dystocia_var,  ga_at_deli_var, neonate_outcome_var, neonate_condition_var, gender_var,
		birth_weight_var, presentation_var, length_var, rom_dt_var, length_repture_var, plcnta_deli_mthod_var,  plcnta_status_var,
		plcnta_disposn_var, nuchal_cord_var, nucl_cord_tension_var, cord_ph_var, cord_ph_obtained_var, cord_bld_taken_var,
		bank_donate_var, cord_sgmnt_colecd_var, cord_sgmnt_dispo_var, suction_var, suction_amount_var, color_suctioned_var,
		void_output_var, stool_output_var, apgar_1min_var, apgar_5min_var, apgar_10min_var, apgar_15min_var, apgar_20min_var,
		infant_comp_var, resprn_type_var, neonatlogy_called_var, infant_care_by_var, neonate_death_var, neonate_trans_to_var,
		skn_to_skin_var, skn_to_skn_time_var, vitamin_K_dt_var, antibio_eye_var, id_band_var, id_band_read_by_var,
		sensor_aplied_var, sensor_nbr_var, cord_vessels_var, vbac_var, plcnta_deli_time_var)
	...
	with sqltype("vc", "f8", "vc", "f8", "f8", "vc", "dq8", "i4"))i
)
