...
001 8/2/2018   Dawn Greer, DBA         Filter out ZZZTEST, ZZZRegression,
                                       TTTTLAB from the report.  Commenting
                                       out filter from Build domain because
                                       it only has test patients.
******************************************************************************/
...
where
	...
	and o.active_ind = 1
;	and p.name_last_key NOT IN ("ZZZTEST","ZZZREGRESSION","TTTTLAB")      ;001 - Filtering out test patients
