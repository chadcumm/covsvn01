...
*/
set debug_ind = 1 go
execute cov_amb_substance_rpt "MINE", VALUE("CAET Athens","CAET Crossville","CAET Decatur","CAET Lenoir","CAET Oneida"
,"CAET Parkwest","Crossville","TOG Blount","TOG Downtown","TOG Lenoir City","TOG Morristown","TOG Oak Ridge"
,"TOG Sevier","TOG West") go
