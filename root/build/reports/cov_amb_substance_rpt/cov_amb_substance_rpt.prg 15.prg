...
call writeLog(build2("* END   Custom Section  ************************************"),1)
call writeLog(build2("************************************************************"))

call writeLog(build2("* START Finding Location ***********************************"),1)
...
call writeLog(build2("* END   Finding Location ***********************************"),1)

call writeLog(build2("* START Order Selection ************************************"),1)
...
head e.encntr_id
	call writeLog(build2("---->e.encntr_id=",trim(cnvtstring(e.encntr_id))))
head o.order_id
