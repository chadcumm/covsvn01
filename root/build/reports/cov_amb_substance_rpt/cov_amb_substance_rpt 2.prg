...
with OUTDEV, FACILITY, start_dt_tm, end_dt_tm, CSA_IND, NEW_PROVIDER
...
select distinct into $OUTDEV
	...
	,order_synonym=substring(1,50,o.order_mnemonic)
...
order by
	...
	,order_provider
	,fin
with nocounter,format,separator=" ",outerjoin = d3, outerjoin = d5, outerjoin = d6, outerjoin = d7
