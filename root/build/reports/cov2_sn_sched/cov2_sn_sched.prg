...
/*****************************************************************************
        ...
        Source file name:       cov2_sn_sched.prg
        Object name:			cov2_sn_sched
...
drop program cov2_sn_sched:dba go
create program cov2_sn_sched:dba
...
set t_rec->facility_prompt		= $Facility
...
head scp.surg_case_id
	...
	t_rec->qual[t_rec->cnt].procedure					= uar_get_code_description(scp.sched_surg_proc_cd)
