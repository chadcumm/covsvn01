...
-------	 	-------    	-----------         ------------------------
1.0			6/20/2019	Chad Cummings		Initial Release
**************************************************************/ 

/***********************PROGRAM NOTES*************************
Description - This MPage is used to pass values to custom webpage. ;chs_tn.custpatpop
...
subroutine GetPatientData( dummy )
	...
	join oa ;v3.0 - Include the join to return the facility specific MRN.
		...
		and oa.alias_entity_alias_type_cd in (4_CMRN) ;v3.0
		and oa.active_ind = 1
