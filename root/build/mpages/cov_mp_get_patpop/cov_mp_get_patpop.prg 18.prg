...
;http://covhppmodules.covhlth.net/ColdFusionApplications/Cerner_PopulationGroupAlert/
;PopulationGroupNoticeComponent.cfm?strStaffUserName=mmaples&strStaffCernerPosition=441&strPatientCMRN=21222345

set record_data->launch_url = concat("http://covhppmodules.covhlth.net/ColdFusionApplications/Cerner_PopulationGroupAlert/"
				,"PopulationGroupNoticeComponent.cfm")
...
subroutine GetPatientData( dummy )
	...
	head report
		...
		record_data->user_position = trim(cnvtstring(p.position_cd));v4.0
...
;		^<!-- ************************************************** -->^,CHAR(10),CHAR(13),
		...
		^<IFRAME^,CHAR(10),CHAR(13),
		  ...
		  ^NAME="iFrameCovCovPatPopLaunch" ^,CHAR(10),CHAR(13),

		  ^ID="iFrameCovCovPatPopLaunch" ^,CHAR(10),CHAR(13),
		 
		  ^WIDTH="100%" ^,CHAR(10),CHAR(13),
		 ; ^STYLE="position:fixed;background-color:white;top:0px;left:0px;width:50%;height:50%;" ^,CHAR(10),CHAR(13),
		...
		^>testing chad</IFRAME>^,CHAR(10),CHAR(13),
		...
		^<FORM^,CHAR(10),CHAR(13),
		  ...
		  ^NAME="frmCovPatPop"^,CHAR(10),CHAR(13),

		  ^ID="frmCovPatPop"^,CHAR(10),CHAR(13),

		  ^ACTION="^,record_data->launch_url,^"^,CHAR(10),CHAR(13),

		  ^METHOD="POST"^,CHAR(10),CHAR(13),

		  ^TARGET="iFrameCovCovPatPopLaunch"^,CHAR(10),CHAR(13),
		...
		^>^,CHAR(10),CHAR(13),
		  ...
		  ^<INPUT TYPE="submit" value="Submit">^,CHAR(10),CHAR(13), ;v4.0
		...
		^<SCRIPT TYPE="text/javascript">^,CHAR(10),CHAR(13),
		 ...
		 ; ^/* SUBMIT FORM */^,CHAR(10),CHAR(13),
		  ...
		  ^var objCtrlCovPatPop = document.getElementById("frmCovPatPop");^,CHAR(10),CHAR(13),

		  ^objCtrlCovPatPop.submit();^,CHAR(10),CHAR(13),
		  
		  ^alert("test");^,char(10),char(13),
