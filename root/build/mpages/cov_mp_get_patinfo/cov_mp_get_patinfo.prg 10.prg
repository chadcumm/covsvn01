...
for (i = 1 to size(patinfo->qual,5))
	if (patinfo->qual[i].encntr_id > 0.0)
		set replyString = build("<tr><td><b>Arrive DT/TM</b></td><td>&nbsp</td><td>",
											format(patinfo->qual[i].arrive_dt_tm,";;q"),
						"</td></tr>")
		set replyString = build("<tr><td><b>Reg DT/TM</b></td><td>&nbsp</td><td>",
											format(patinfo->qual[i].reg_dt_tm,";;q"),
						"</td></tr>")
		set replyString = build("<tr><td><b>Inpatient Admit DT/TM</b></td><td>&nbsp</td><td>",
