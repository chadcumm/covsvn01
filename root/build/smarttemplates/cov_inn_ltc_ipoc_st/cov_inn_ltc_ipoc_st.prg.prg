...
******************************************************************************
	...
	Date Written:		05/23/2019
	Solution:			Behavior Health and INA
	Source file name:	cov_inn_ltc_ipoc_st.prg
	Object name:		cov_inn_ltc_ipoc_st
	Request #:			
 
	Program purpose:	
 
	Executing from:		CCL, PowerChart
 
 	Special Notes:		Smart Template used in PowerForms
...
******************************************************************************
 ...
 --- ----------	--------------------	--------------------------------------
 001 05/21/2018	Chad Cummings			Updated for Covenant results
...
CREATE PROGRAM cov_inn_ltc_ipoc_st :dba
 ...
 ;001 SET titlecaption = uar_i18ngetmessage (i18nhandle ,"Title" ,"Current IPOCs" )
 SET titlecaption = uar_i18ngetmessage (i18nhandle ,"Title" ,"Current IPOCs / Short Term Goals" )
