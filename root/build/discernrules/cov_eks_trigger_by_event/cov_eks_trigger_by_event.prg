...
******************************************************************************
	...
	Solution:			   
	Source file name:	   cov_eks_trigger_by_event.prg
	Object name:		   cov_eks_trigger_by_event
	Request #:
...
drop program cov_eks_trigger_by_event:dba go
create program cov_eks_trigger_by_event:dba
...
if (t_rec->cnt = 0)
	if (program_log->run_from_ops = 1)
		...
		set reply->status_data.subeventstatus[1].operationname		= "EVENTS"
		set reply->status_data.subeventstatus[1].operationstatus	= "Z"
		set reply->status_data.subeventstatus[1].targetobjectname	= "CLINICAL_EVENT"
		set reply->status_data.subeventstatus[1].targetobjectvalue	= "No Events qualified"
	endif
	go to exit_script
endif
call writeLog(build2("************************************************************"))
