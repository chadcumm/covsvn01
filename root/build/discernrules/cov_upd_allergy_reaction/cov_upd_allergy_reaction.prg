...
******************************************************************************
  ...
  Solution:           
  Source file name:   cov_upd_allergy_reaction.prg
  Object name:        cov_upd_allergy_reaction
  Request #:
...
******************************************************************************/
drop program cov_upd_allergy_reaction:dba go
create program cov_upd_allergy_reaction:dba
...
%i cust_script:cov_upd_allergy_reaction.inc
...
for (i=1 to 963006reply->allergy_qual)
	...
	;check allergy reaction class to match ALLERGY and is active
	if ((963006reply->allergy[i].reaction_class_cd = t_rec->reaction_class_cd) and (963006reply->allergy[i].active_ind = 1) and 
		...
		if (t_rec->cur_allergy_qual = 1)
			...
			set 101706request->allergy[1].active_ind 									= 1 ;002
