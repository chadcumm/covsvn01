1)translate inn_eks_diagnosis_check go
;*** Generated by TRANSLATE, verify before re-including (Debug:N,Optimize:N,DiffEnd:N,Rdb:N) ***
DROP PROGRAM inn_eks_diagnosis_check :dba GO
CREATE PROGRAM inn_eks_diagnosis_check :dba
...
200727:232325 CCUMMIN4_DVD18              Cost 0.00 Cpu 0.00 Ela 0.00 Dio   0 O0M0R0 P1R0
