1)translate eks_med_micro_refhelp go
;*** Generated by TRANSLATE, verify before re-including (Debug:N,Optimize:N,DiffEnd:N,Rdb:N) ***
DROP PROGRAM eks_med_micro_refhelp :dba GO
CREATE PROGRAM eks_med_micro_refhelp :dba
 ...
 SELECT DISTINCT INTO "NL:"
  ...
  _hidden_par =
  IF ((cv.cki > " " ) ) cv.cki
  ELSE cnvtstring (cv.code_value ,25 ,1 )
  ENDIF
...
191218:075525 CCUMMIN4_DVD2              Cost 0.00 Cpu 0.00 Ela 0.00 Dio   0 O0M0R0 P1R0
