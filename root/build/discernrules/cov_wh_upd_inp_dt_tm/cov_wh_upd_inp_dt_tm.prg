...
******************************************************************************
  ...
  Solution:           
  Source file name:   cov_wh_upd_inp_dt_tm.prg
  Object name:        cov_wh_upd_inp_dt_tm
  Request #:
...
******************************************************************************/
drop program cov_wh_upd_inp_dt_tm:dba go
create program cov_wh_upd_inp_dt_tm:dba
...
set
	  e.inpatient_admit_dt_tm = e.reg_dt_tm
	, e.updt_applctx = 99999
	, e.updt_cnt = updt_cnt + 1
