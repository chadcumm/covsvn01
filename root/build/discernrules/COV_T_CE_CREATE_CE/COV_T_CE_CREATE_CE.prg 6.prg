...
CREATE PROGRAM COV_T_CE_CREATE_CE :dba
 ...
 IF (NOT ((tname IN ("EKS_CE_CREATE_DATE_CE_A" ,
 ;002 "EKS_CE_UPDATE_DATE_CE_A" ) ) ) )
 "EKS_CE_UPDATE_DATE_CE_A","COV_CE_UPDATE_SVSREC_A" ) ) ) ) ;002
  IF ((validate (value1 ,"Z" ) = "Z" )
  AND (validate (value1 ,"Y" ) = "Y" ) )
   SET msg = concat("VALUE1 parameter does not exist. ",curprog)
   SET retval = - (1 )
   GO TO endprogram
 ...
 "EKS_CE_UPDATE_CODED_CE_A" ,"COV_CE_UPDATE_SVSREC_A") ) ) ) ;002
 ...
 ENDIF
 call echojson(cerequest, concat("eks_cov_t_ce_create_",trim(format(sysdate,"dd-MMM hhmmss;;q")),".dat") , 0)  ;002
 FREE SET cerequest
 CALL echo (msg )
 CALL echo (concat (format (curdate ,"dd-mmm-yyyy;;d" ) ," " ,format (curtime3 ,"hh:mm:ss.cc;3;m" ) ,
