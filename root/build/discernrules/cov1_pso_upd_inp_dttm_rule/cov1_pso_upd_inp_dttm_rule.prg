...
2.0	   11/28/2018   Chad Cummings		Included stop date and time as an option for dt discovery
**************************************************************/
...
Discern Rule - COV_PSO_UPD_INP_DT_TM
 
**************************************************************/
drop program cov1_pso_upd_inp_dttm_rule:dba go
create program cov1_pso_upd_inp_dttm_rule:dba
