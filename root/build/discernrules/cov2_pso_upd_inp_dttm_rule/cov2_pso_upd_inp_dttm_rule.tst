...
select into "nl:"
from orders o where o.order_id =  400867363 ;400867355
head report
	stat = alterlist(request->OrderList,1)
	request->OrderList[1].actionTypeCd = 2534
	stat = alterlist(request->OrderList->detailList,1)
	request->OrderList[1].detailList[1].oeFieldMeaning = "INPTADMDTETME"
detail
...
execute cov2_pso_upd_inp_dttm_rule:dba go
