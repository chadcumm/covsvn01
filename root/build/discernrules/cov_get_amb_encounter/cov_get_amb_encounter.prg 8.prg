...
from 
	...
	,encounter e
plan o
	where o.order_id = 408694515                ;trigger_orderid
join e
...
if (t_rec->orig_encntr_type = value(uar_get_code_by("DISPLAY",71,"Clinic")))
	call echo("Current Encounter is Clinic Encounter")
	set t_rec->encntr_id = t_rec->orig_encntr_id
else
	call echo("Current Encounter is NOT Clinic Encounter, finding most recent")
	select into "nl:"
	from encounter e
	plan e
