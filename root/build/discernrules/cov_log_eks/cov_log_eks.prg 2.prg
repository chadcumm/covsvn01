...
set t_rec->filename_a = concat("cclscratch:eks_dietso_eksdata_",trim(format(sysdate,"yyyy_mm_dd_hh_mm_ss;;d")),".dat")
set t_rec->filename_b = concat("cclscratch:eks_dietso_request_",trim(format(sysdate,"yyyy_mm_dd_hh_mm_ss;;d")),".dat")
