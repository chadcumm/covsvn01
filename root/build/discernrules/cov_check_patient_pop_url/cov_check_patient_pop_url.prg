...
******************************************************************************
	...
	Solution:				Discern
	Source file name:		cov_check_patient_pop_url.prg
	Object name:			cov_check_patient_pop_url
	Request #:
...
;/WebService.cfc?method=fnPopulationGroupShowAlert&strStaffUserName=CCUMMIN4&strStaffCernerPosition=441&strPatientCMRN=1
