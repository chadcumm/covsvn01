...
set 640101_request->patient_id = t_rec->patient.person_id go
set 640101_request->confirmation_dt_tm = cnvtdatetime(curdate,curtime3) go
set 640101_request->confirmation_method_cd = 15783919 go

set stat = alterlist(request->problem_data, 1) go

set 640101_request->problem_data[1].problem_id = 0 go
set 640101_request->problem_data[1].confirmation_status_cd = 15840709 go
set 640101_request->problem_data[1].onset_dt_tm = curdate go
set 640101_request->problem_data[1].life_cycle_status_cd = 3301 go

; nomenclature (this should stay constant)
set 640101_request->nomen_source_id = "429859012" go
set 640101_request->nomen_vocab_mean = "SNMCT" go
