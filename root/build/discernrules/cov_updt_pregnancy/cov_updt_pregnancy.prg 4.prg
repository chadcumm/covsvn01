...
set request->patient_id = 18816571 go
set request->confirmation_dt_tm = curdate go
set request->confirmation_method_cd = 15783919 go

set stat = alterlist(request->problem_data, 1) go

set request->problem_data[1].problem_id = 0 go
set request->problem_data[1].confirmation_status_cd = 15840709 go
set request->problem_data[1].onset_dt_tm = curdate go
set request->problem_data[1].life_cycle_status_cd = 3301 go

; nomenclature (this should stay constant)
set request->nomen_source_id = "429859012" go
set request->nomen_vocab_mean = "SNMCT" go
