...
detail
	...
	r_rec->result_qual[r_rec->result_cnt].trigger_name = "COV_POC_UPDT_SRV_R"
with nocounter
...
set r_rec->log_message = concat(
										...
										trim(cnvtstring(r_rec->patient.person_id)),"|",
										trim(cnvtstring(r_rec->patient.encntr_id)),"|",
										trim(cnvtstring(r_rec->patient.order_id)),"|"
									)
