...
******************************************************************************
  ...
  Solution:           
  Source file name:   cov_eks_t_a08_evoke.prg
  Object name:        cov_eks_t_a08_evoke
  Request #:
...
******************************************************************************/
drop program cov_eks_t_a08_evoke:dba go
create program cov_eks_t_a08_evoke:dba
...
if	(validate(request->transaction) = 1)
	if (request->transaction = "A08")
		set t_rec->return_value = "TRUE"	
	endif
		if (request->transaction = "UMPI")
		set t_rec->return_value = "TRUE"	
	endif
endif
