...
drop program spec_cov_cardiology_results_e:dba go
create program spec_cov_cardiology_results_e:dba
...
for (i=1 to t_rec->order_cnt)
	if (
			...
			where event_id = value(t_rec->order_qual[i].event_id)
