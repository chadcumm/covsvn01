...
call set_dminfo_date(t_rec->dminfo.info_domain,t_rec->dminfo.info_name,cnvtdatetime("03-NOV-2021 00:00:00"))
/*************************/
...
if (t_rec->dates.start_dt_tm = 0.0)
	...
	set t_rec->dates.start_dt_tm = cnvtdatetime("02-NOV-2021 12:00:00")
endif
...
from
	...
	,person p
plan ce
	where ce.clinsig_updt_dt_tm between cnvtdatetime("02-NOV-2021 00:00:00") and cnvtdatetime("03-NOV-2021 00:00:00")
...
call writeLog(build2("* START Creating Audit *************************************"))
	call writeAudit(build2(
							...
							char(34),	cnvtdatetime(t_rec->cons.run_dt_tm,"DD-MMM-YYYY HH:MM:SS;;q")	,char(34),char(44),
							char(34),	"start_dt_tm:"													,char(34),char(44), 
							char(34),	cnvtdatetime(t_rec->dates.start_dt_tm,"DD-MMM-YYYY HH:MM:SS;;q"),char(34),char(44), 
							char(34),	"end_dt_tm:"		,char(34),char(44),   
							char(34),	cnvtdatetime(t_rec->dates.end_dt_tm,"DD-MMM-YYYY HH:MM:SS;;q")	,char(34),char(44),   
