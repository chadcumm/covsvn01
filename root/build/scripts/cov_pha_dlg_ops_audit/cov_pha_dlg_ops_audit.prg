...
******************************************************************************
	...
	Source file name:	cov_pha_dlg_ops_audit.prg
	Object name:		cov_pha_dlg_ops_audit
	Request #:
...
drop program cov_pha_dlg_ops_audit:dba go
create program cov_pha_dlg_ops_audit:dba
...
set t_rec->start_date 	= format(
	datetimefind(cnvtlookbehind("1,M",cnvtdatetime(curdate,curtime3)), 'M', 'B', 'B')
	,"mmddyy;;d")
	
set t_rec->end_date 	= format(
	datetimefind(cnvtlookbehind("1,M",cnvtdatetime(curdate,curtime3)), 'M', 'E', 'E')
	,"mmddyy;;d")
