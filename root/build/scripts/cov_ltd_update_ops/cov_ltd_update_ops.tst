...
set request->batch_selection = "cov_ltd_update_ops NOFORMS" go
set request->output_dist = "chad.cummings@covhlth.com;athomas3@CovHlth.com" go
...
/*
set debug_ind = 1 go 
execute cov_ltd_update_ops "MINE","N"  go
*/
