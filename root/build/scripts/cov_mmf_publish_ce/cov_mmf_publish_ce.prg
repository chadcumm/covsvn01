DROP PROGRAM cov_mmf_publish_ce :dba GO
CREATE PROGRAM cov_mmf_publish_ce :dba
 ...
 SUBROUTINE  postclinicalevent (personid ,encntrid )
  ...
  ;SET srvstat = uar_srvsetshort (hreq ,"ensure_type" ,258 )
...
;  else
 ; 	 SET formatcd =         116.00	;CP	CP	Cerner Postscript
