...
set request->batch_selection = "cov_him_purge_queue" go
...
set request->program_name = "cov_him_purge_queue" go
;set request->output_device = "chad.cummings@covhlth.com" go
...
set debug_ind = 1 go
set debug_on = 1 go
execute cov_him_purge_queue "MINE"   go
