...
DROP PROGRAM mp_unified_driver_ws_diag :dba GO
CREATE PROGRAM mp_unified_driver_ws_diag :dba
 PROMPT
 ...
 SUBROUTINE  generatecontentrequirements (null )
  ...
  IF ((textlen (trim (criterion->workflow_base_url ) ) > 0 ) )
   ...
   SET cssreqs = build2 (^<link rel="stylesheet" type="text/css" href='^ ,
    criterion->static_content ,"/WS_DIAGNOSTIC/workflow/workflow.css'></link>" ,cssreqs )
  ENDIF
