...
CREATE PROGRAM cov_sch_inqa_queueonly :dba
 ...
 IF ((cs23010_disppidrl_cd > 0.0 ) )
  ...
  ;end select
 ENDIF
 ;012 SET reply->attr_qual_cnt = 32 ; limit columns ;010
 SET reply->attr_qual_cnt = 34 ; limit columns ;012
 ...
 SET reply->attr_qual[t_index ].attr_label = uar_i18ngetmessage (i18nhandle ,"Notes" ,
  "Notes" )
 SET reply->attr_qual[t_index ].attr_type = "vc"
 SET t_index = (t_index + 1 )
...
ENDFOR
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   reply->query_qual[d.seq ].ord_phys_group = trim (ps.practice_site_display ,3 ) ;006
 ...
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   ,t_record->event_qual[d.seq ].order_qual[t_record->event_qual[d.seq ].order_qual_cnt ].order_id = a.order_id ,
	;003
    IF ((o.current_start_dt_tm > cnvtdatetime ("01-JAN-1800 00:00:00.00" ) ) )
 ...
 IF ((pref_value_disppidrl = 1.0 ) )
  SELECT INTO "nl:"
   ...
   val_notes = substring (1 ,255 ,reply->query_qual[d.seq ].sch_inst) , ;010
   val_comments = substring (1 ,255 ,reply->query_qual[d.seq ].special_inst) , ;010
   ...
   DETAIL
    ...
    reply->query_qual[sch2_idx ].sch_inst = val_sch_inst , ;010
    reply->query_qual[sch2_idx ].special_inst = val_special_inst , ;010
