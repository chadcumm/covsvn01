...
******************************************************************************************
	...
	Solution:			AMB
	Source file name:  	cov_amb_discharge_appt_check.prg
	Object name:		cov_amb_discharge_appt_check
	CR#:				8083
...
*  	-----------  ----------  --------------------  ---------------------------------------
*   001          0-08-2021	 Chad Cummings			Updated for ops
*
******************************************************************************************/
 
drop program cov_amb_discharge_appt_check:dba go
create program cov_amb_discharge_appt_check:dba
