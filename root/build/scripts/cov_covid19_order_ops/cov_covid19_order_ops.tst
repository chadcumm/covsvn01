...
set request->batch_selection = "cov_covid19_order_ops" go
set request->output_dist = "chad.cummings@covhlth.com;kgraves@CovHlth.com" go
...
set debug_ind = 1 go 
execute cov_covid19_order_ops "MINE"  go
