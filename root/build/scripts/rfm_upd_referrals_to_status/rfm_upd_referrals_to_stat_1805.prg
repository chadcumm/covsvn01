...
************************************************************************************/
drop program rfm_upd_referral_to_stat_1805:dba go
create program rfm_upd_referral_to_stat_1805:dba
		...
		if(iErrCode > 0 or bFound != 1)	
			...
			if (iErrCode > 0)
				...
				(
					...
					rh.HEALTHCARE_GUARANTEE_DT_TM, rh.ADMINISTRATIVE_PROBLEM_CD, rh.WAIT_TIME_DAYS, rh.REFERRAL_SUBSTATUS_CD
				)
				( 
					SELECT
						...
						r.AUTHORIZATION_CODE_TXT, r.REFER_FROM_LOC_CD, r.HEALTHCARE_GUARANTEE_DT_TM, r.ADMINISTRATIVE_PROBLEM_CD, r.WAIT_TIME_DAYS, 
