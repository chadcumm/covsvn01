...
set mmf_store_request->contenttype = "REQUISITION" go
...
call echorecord(mmf_store_request) go
...
set mmf_publish_ce_request->mediaObjects[1]->display = 'Attachment 123456' go
...
set mmf_publish_ce_request->title = nullterm('Publish test A') go
set mmf_publish_ce_request->notetext = nullterm(' Note text from request structure. ') go
set mmf_publish_ce_request->noteformat = 'AS' go ; code set 23 cdf_meaning
set mmf_publish_ce_request->personnel[1]->id =    2.00 go
...
set mmf_publish_ce_request->publishAsNote=1 go;
