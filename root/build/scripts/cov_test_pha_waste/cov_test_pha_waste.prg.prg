...
free record 390055request
record 390055request (
  1 order_id = f8   
  1 facility_cd = f8   
)

free record 390058request
...
set stat = tdbexecute(380000,380900,380017,"REC",380017request,"REC",380017reply)
call echorecord(380017reply)

set 390058request->dispense_hx_id = 34427794

call echorecord(390058request)
set stat = tdbexecute(380000,380000,390058,"REC",390058request,"REC",390058reply)
