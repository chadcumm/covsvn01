DROP PROGRAM sch_inqa_appt_index_past :dba GO
CREATE PROGRAM sch_inqa_appt_index_past :dba
 ...
 SELECT
  ...
  PLAN (ep
   ...
   cnvtdatetime (datetimeadd (cnvtdatetime (curdate ,0 ) ,(max_appt_time / 24.0 ) ) ) )
