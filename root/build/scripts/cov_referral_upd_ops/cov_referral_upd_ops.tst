...
set request->batch_selection = "cov_referral_upd_ops MINE,180" go
set request->output_dist = "chad.cummings@covhlth.com;bseagrov@CovHlth.com" go
...
/*
set debug_ind = 1 go 
execute cov_referral_upd_ops "nl:", 365  go
*/
