...
CREATE PROGRAM cov_celr_mobj_oru_out :dba
 ...
 call echo(build( "Starting-" ,current_program ,char (0 ) ))
 ...
 IF ((((messg_type != "ORU" ) ) OR ((((messg_trigger != "R01" ) ) OR ((version_id != "2.5.1" ) )) )))
  call echo(build("Non-ORU R01 transaction being ignored:" ,messg_type ,"-" , messg_trigger ,"-" ,version_id,char(0)))
...
%i cust_script:cov_celr_mobj_oru_out_sub.inc
 ...
 call echo(build ("** START Finding ESO Routine Arguments" ,char (0 ) ))
 SELECT INTO "nl:"
  ...
  DETAIL
   ...
   ENDWHILE
  WITH nocounter
 call echo(build ("** END  Finding ESO Routine Arguments" ,char (0 ) ))



 call echo(build ("**START Finding obx_4_routine_arg" ,char (0 ) ))
 FOR (loop1 = 1 TO size (data->qual ,5 ) )
  ...
  ENDIF
 ENDFOR
 call echo(build ("**END   Finding obx_4_routine_arg" ,char (0 ) ))
 ...
 if (validate(oen_reply->control_group[1 ].msh[1 ].conform_statment[1 ].name_id))
...
call echo(build ("**START Finding Org si_oid" ,char (0 ) ))
 SELECT INTO "nl"
  ...
  WITH nocounter
 call echo(build ("**END   Finding Org si_oid" ,char (0 ) ))
 
 
 call echo(build ("**START Setting si_oid" ,char (0 ) ))
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].pid.patient_id_int ,5 ) )
  ...
  ENDIF
 ENDFOR
 call echo(build ("**END  Setting si_oid" ,char (0 ) ))
 
 call echo(build ("**START Getting Phone Information" ,char (0 ) ))
 SELECT INTO "nl:"
  FROM (phone p )
  PLAN (p
  ...
  DETAIL
   ...
   ENDIF
  WITH nocounter
 call echo(build ("**END   Getting Phone Information" ,char (0 ) ))
 
 
 call echo(build ("**START Getting Encounter Information" ,char (0 ) ))
 SELECT INTO "nl:"
  FROM (encounter e )
  PLAN (e
  ...
  WITH nocounter
 call echo(build ("**END  Getting Encounter Information" ,char (0 ) ))
 
 call echo(build ("**Resetting NTE" ,char (0 ) ))
 ...
 call echo(build("starging add_data_field_by_cdf"))
 ...
 call echo(build ("Alias fields in PID Segment" ,char (0 ) ))
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].pid.patient_address ,5 ) )
  call echo(build ("Alias PID-11.9 field" ,char (0 ) ))
 ...
 ENDFOR
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].pid.ph_nbr_home ,5 ) )
  call echo(build ("Alias PID-13.2 field" ,char (0 ) ))
  CALL populate_id ("PID-13.2" ,oen_reply->person_group[1 ].pat_group[1 ].pid.ph_nbr_home[loop1 ].
   telecom_use_cd )
 ENDFOR
 call echo(build ("Alias fields in NK1 Segment" ,char (0 ) ))
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].nk1 ,5 ) )
  call echo(build ("Alias NK1-2.7 field" ,char (0 ) ))
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].nk1[loop1 ].nk_name ,5 ) )
   CALL populate_id ("NK1-2.7" ,oen_reply->person_group[1 ].pat_group[1 ].nk1[loop1 ].nk_name[loop2 ]
    .name_type_cd )
  ENDFOR
  call echo(build ("Alias NK1-3 field" ,char (0 ) ))
  ...
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].nk1[loop1 ].nk_contact_phone ,5
   ...
   call echo(build ("Alias NK1-31.2 field" ,char (0 ) ))
 ...
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].res_oru_group ,5 ) )
  ...
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group ,5 ) )
   ...
   FOR (loop3 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group[loop2 ].obx.
    ...
    call echo(build ("Alias OBX-24.4 field" ,char (0 ) ))
    ...
    call echo(build ("Alias OBX-24.6 field" ,char (0 ) ))
    ...
    call echo(build ("Alias OBX-24.7 field" ,char (0 ) ))
    ...
    call echo(build ("Alias OBX-24.9 field" ,char (0 ) ))
  ...
  ENDFOR
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].specimen_group ,5 ) )
   call echo(build ("Alias SPM-12.2 field" ,char (0 ) ))
  ...
  ENDFOR
 ENDFOR
 call echo(build ("Format Fields Section..." ,char (0 ) ))
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].nk1 ,5 ) )
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].nk1[loop1 ].nk_address ,5 ) )
   call echo(build ("Format NK1-4.5" ,char (0 ) ))
 ...
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].res_oru_group ,5 ) )
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].orc ,5 ) )
   FOR (loop3 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].orc[loop2 ].
    ord_fac_address ,5 ) )
    call echo(build ("Format ORC-22.5" ,char (0 ) ))
   ...
   FOR (loop3 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].orc[loop2 ].
    provider_address ,5 ) )
    call echo(build ("Format ORC-24.5" ,char (0 ) ))
  ...
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group ,5 ) )
   FOR (loop3 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group[loop2 ].obx.
    performing_org_addr ,5 ) )
    call echo(build ("Format OBX-24.5" ,char (0 ) ))
 ...
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].pat_group[1 ].nte ,5 ) )
  ...
  AND (oen_reply->person_group[1 ].pat_group[1 ].nte[loop1 ].comment_type.coding_system = "" ) )
   call echo(build ("Set PID-NTE-4" ,char (0 ) ))
 ...
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].res_oru_group ,5 ) )
  ...
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obr.ord_provider ,5 ) )
   IF ((textlen (trim (oen_reply->person_group[1 ].res_oru_group[loop1 ].obr.ord_provider[loop2 ].
    ...
    call echo(build ("Set OBR-16.14.1" ,char (0 ) ))
    SET oen_reply->person_group[1 ].res_oru_group[loop1 ].obr.ord_provider[loop2 ].assign_fac_id.
    name_id = org_name_id
    call echo(build ("Set OBR-16.14.2" ,char (0 ) ))
    SET oen_reply->person_group[1 ].res_oru_group[loop1 ].obr.ord_provider[loop2 ].assign_fac_id.
    univ_id = org_univ_id
    call echo(build ("Set OBR-16.14.3" ,char (0 ) ))
    SET oen_reply->person_group[1 ].res_oru_group[loop1 ].obr.ord_provider[loop2 ].assign_fac_id.
    univ_id_type = org_univ_id_type
   ENDIF
  ENDFOR
  ...
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].nte ,5 ) )
   ...
   "" ) )
    call echo(build ("Set OBR-NTE-4" ,char (0 ) ))
    SET oen_reply->person_group[1 ].res_oru_group[loop1 ].nte[loop2 ].comment_type.coding_system =
    "HL70364"
   ENDIF
  ENDFOR
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group ,5 ) )
   FOR (loop3 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group[loop2 ].obx.
    ...
    AND (textlen (trim (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group[loop2 ].obx.
     ...
     call echo(build ("Set OBX-23.6.2" ,char (0 ) ))
    ...
    AND (textlen (trim (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group[loop2 ].obx.
     ...
     call echo(build ("Set OBX-23.6.3" ,char (0 ) ))
     SET oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group[loop2 ].obx.performing_org_name[
   ...
   FOR (loop3 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group[loop2 ].nte ,
    ...
    .coding_system = "" ) )
     call echo(build ("Set OBX-NTE-4" ,char (0 ) ))
  ...
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].specimen_group ,5 ) )
   ...
   IF ((((textlen (trim (oen_reply->person_group[1 ].res_oru_group[loop1 ].specimen_group[loop2 ].spm
    ...
    call echo(build ("Set SPM-7.3" ,char (0 ) ))
    ...
    FOR (loop3 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].orc[loop2 ].
     ...
     SET stat = alterlist (oen_reply->person_group[1 ].res_oru_group[loop1 ].orc[loop2 ].
      placer_ord_nbr ,size (oen_reply->person_group[1 ].res_oru_group[loop1 ].orc[loop2 ].
       filler_ord_nbr ,5 ) )
     call echo(build ("Copy ORC-3.1 to ORC-2.1" ,char (0 ) ))
     ...
     .entity_id
     call echo(build ("Copy ORC-3.2 to ORC-2.2" ,char (0 ) ))
     ...
     call echo(build ("Copy ORC-3.3 to ORC-2.3" ,char (0 ) ))
     ...
     call echo(build ("Copy ORC-3.4 to ORC-2.4" ,char (0 ) ))
     SET oen_reply->person_group[1 ].res_oru_group[loop1 ].orc[loop2 ].placer_ord_nbr[loop3 ].
     ...
     call echo(build ("Copy OBR-3.1 to OBR-2.1" ,char (0 ) ))
     ...
     call echo(build ("Copy OBR-3.2 to OBR-2.2" ,char (0 ) ))
     ...
     call echo(build ("Copy OBR-3.3 to OBR-2.3" ,char (0 ) ))
     ...
     call echo(build ("Copy OBR-3.4 to OBR-2.4" ,char (0 ) ))
 ...
 ENDFOR
 call echo(build ("Correct PID-35.3" ,char (0 ) ))
 ...
 FOR (loop1 = 1 TO size (oen_reply->person_group[1 ].res_oru_group ,5 ) )
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group ,5 ) )
   FOR (loop3 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].obx_group[loop2 ].obx.
    observation_value ,5 ) )
    call echo(build ("Correct OBX-5.6" ,char (0 ) ))
  ...
  ENDFOR
  FOR (loop2 = 1 TO size (oen_reply->person_group[1 ].res_oru_group[loop1 ].specimen_group ,5 ) )
   call echo(build ("Correct SPM-4.6" ,char (0 ) ))
   IF ((textlen (trim (oen_reply->person_group[1 ].res_oru_group[loop1 ].specimen_group[loop2 ].spm.
  ...
  ENDFOR
 ENDFOR
 call echo(build ("Remove fields that are not supported by the Federal specification" ,
  char (0 ) ))
...
call echojson(data_field,filename,1)
 ...
 FREE RECORD data
 FREE RECORD data_field
 call echo(build ("Exiting-" ,current_program ,char (0 ) ))
END GO
