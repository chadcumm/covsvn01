...
CREATE PROGRAM cov_update_ce :dba
 ...
 DECLARE postclinicalevent ((p1 = f8 ) ) = i4
 ...
 CALL logmsg (debugflag ,build ("request->event_id:" ,request->event_id ) )

 CALL postclinicalevent (request->event_id )

 CALL logmsg (debugflag ,concat ("end:" ,format (curdate ,"MM/DD/YYYY;;D" ) ," " ,format (curtime3 , "@TIMEWITHSECONDS" ) ) )


SUBROUTINE  postclinicalevent (eventid )
