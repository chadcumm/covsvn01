...
;     017 04/08/05 SF3151   Handle traversing prsnl_org org list correctly  *
;     018 04/11/05 SF3151   Handle getting prsnl_org org list correctly     *
...
;     045 05/15/18 RS049105 Adjusted to print one perscription per page     *
;                           Mirror RXREQGEN03 logic.                        *
;     046 06/28/18 CR 2445/ Covenant-DG-Adding ICD 10 codes to              *
;                           prescriptions per TN State Requirement on       *
;                           7/1/2018.                                       *
;                  CR 2463  Also changed the Frequency code to the Frequency*
;                           text.                                           *
;     047 07/06/18 CR 2526  Covenant-DG-Add Supervisor Provider to the      *
;                           prescription via the order entry fields.        *
;     048 07/10/18 CR 2526  Covenant-DG-Pull Supervisor Provider from       *
;                           name_value_prefs and app_prefs and prsnl tables *
;                           where providers are associated with a           *
;                           supervising provider using the                  *
;                           DEFAULT_SUP_PHY_ORM preference setting.         *
;     049 07/17/18 CR 2526  Covenant-DG-Remove the word Ambulatory from the *
...
;     050 07/20/18 CR 2526  Covenant-DG-Remove code for the OEF and         *
;                           DEFAULT_SUP_PHY_ORM Preference setting.  They   *
;                           are going to use a setting to enable the        *
;                           original Supervising Provider field and that    *
...
;     051 12/18/18 CR 2822  Covenant-DG-Add Finnbr, Future Fill Date and    *
;                           update documentation throughout the program     *
;                           Also adjusted the location of the preferred     *
;                           Pharmacy to be just below the patient address   *
;     052 01/21/19 CR 4241  Covenant-DG-Added the seq = 1 code to pulling   *
;                           the providers Phone Numbers                     *
;     053 02/12/19 CR 4309  Covenant-DG-A CCL package install (CCLREV 9.40  *
;                           CCLVER 81401, CCLREVMAJOR 8, CCLREVMINOR 14, and*
;                           CCLREVMINOR2 1) broke the order of operations   *
;                           for division in the subroutine                  *
;                           get_number_spellout.  Had to add parenthesis    *
;                           around division operation.  Changed the         *
;                           the Subroutine parameter from REF to VALUE      *
;~DE~************************************************************************
