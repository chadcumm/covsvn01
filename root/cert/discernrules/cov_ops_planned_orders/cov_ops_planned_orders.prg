...
if (program_log->run_from_ops = 1)
...
else;if ((program_log->run_from_eks = 1)
	set log_message = build("program_log->run_from_eks =",program_log->run_from_eks)
	...
	set log_message = build("---->checking $UNIT_NAME=",$UNIT_NAME)
endif
