...
******************************************************************************
	...
	Solution:			Quality
	Source file name:	      cov_phq_verbal_acc_disclosure.prg
	Object name:		cov_phq_verbal_acc_disclosure
	Request#:			6709
	Program purpose:	      Accounting for Disclosure - Health Department Report
	Executing from:		DA2
 	Special Notes:
...
drop program cov_phq_verbal_acc_disclosure:dba go
create program cov_phq_verbal_acc_disclosure:dba
...
join re where re.event_dt_tm between cnvtdatetime($start_datetime) and cnvtdatetime($end_datetime)
	and re.active_ind = 1
