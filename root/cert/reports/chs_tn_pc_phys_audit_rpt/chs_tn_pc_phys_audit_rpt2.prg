 ...
 *****************************************************************************/
drop program chs_tn_pc_phys_audit_rpt2:dba go
create program chs_tn_pc_phys_audit_rpt2:dba
...
plan ce
    ...
    and ce.action_type_cd in (21_verify_cd, 21_sign_cd,21_review_cd)
...
detail
    ...
    elseif(ce.action_type_cd in(21_sign_cd,21_review_cd) and ce.action_status_cd = 103_requested_cd)
    ...
    elseif(ce.action_type_cd in(21_sign_cd,21_review_cd) and ce.action_status_cd = 103_completed_cd)
