...
;005 end */
	...
	head apc2.pathway_id
		...
		call writeLog(build2("------>p2.pw_group_desc=",trim(p2.pw_group_desc)))
		call writeLog(build2("------>p2.description=",trim(p2.description)))
		call writeLog(build2("------>pc.description=",trim(pc.description)))
								...
								*/
								...
								update into clinical_Event 							
									set ;event_end_dt_tm		= cnvtdatetime(curdate, curtime3),
									  ...
									  updt_cnt              = 0,
										  updt_applctx          = reqinfo->updt_applctx,
										  reference_nbr			= t_rec->grouplist[i].reference_nbr ;012
									where parent_event_id = t_rec->grouplist[i].orderlist[j].event_id
