...
028   11/29/2020  Chad Cummings			allow reoccuring order children to qualify for printing
******************************************************************************/
...
select into "nl:"
	...
	,sel_order_id = evaluate(o.protocol_order_id,0.0,o.order_id,o.protocol_order_id) ;028
from
...
head sel_order_id ;028
	...
	call writeLog(build2("---->inside the sel_order_id=",trim(cnvtstring(sel_order_id)))) ;028
	...
	t_rec->grouplist[gcnt].orderlist[cnt].order_id 				= o.order_id ;028
	t_rec->grouplist[gcnt].orderlist[cnt].encntr_id 			= o.originating_encntr_id
	t_rec->grouplist[gcnt].orderlist[cnt].group_id 				= gcnt
	;028 t_rec->grouplist[gcnt].orderlist[cnt].printer_name = concat(t_rec->print_dir,"req_pdf_",trim(cnvtstring(o.order_id)),".pdf")
	t_rec->grouplist[gcnt].orderlist[cnt].printer_name = concat(t_rec->print_dir,"req_pdf_",trim(cnvtstring(sel_order_id)),".pdf") ;028
...
/*start 028
detail
	if ((o.order_status_cd in(value(uar_get_code_by("MEANING",6004,"FUTURE")))) and (o.protocol_order_id > 0.0))
		t_rec->grouplist[gcnt].orderlist[cnt].order_id 				= o.order_id
	endif
/*end 028*/
;028 foot o.order_id	
foot sel_order_id ;028
	stat = 0
;021 foot oc.requisition_format_cd
	;028 t_rec->grouplist[gcnt].printer_name			= concat(t_rec->print_dir,"req_pdf_",trim(cnvtstring(o.order_id))
	t_rec->grouplist[gcnt].printer_name			= concat(t_rec->print_dir,"req_pdf_",trim(cnvtstring(sel_order_id)) ;028
