...
dateFormat.masks={"default":"ddd dd-mmm-yyyy HH:MM:ss",shortDate:"dd-mmm-yyyy",shortDate2:"dd-mmm-yyyy",shortDate3:"dd-mmm-yyyy",shortDate4:"mmm-yyyy",shortDate5:"yyyy",mediumDate:"dd-mmm-yyyy",longDate:"dd-mmm-yyyy",fullDate:"dddd, dd-mmm-yyyy",shortTime:"h:MM TT",mediumTime:"h:MM:ss TT",longTime:"h:MM:ss TT Z",militaryTime:"HH:MM",isoDate:"yyyy-mm-dd",isoTime:"HH:MM:ss",isoDateTime:"yyyy-mm-dd'T'HH:MM:ss",isoUtcDateTime:"UTC:yyyy-mm-dd'T'HH:MM:ss'Z'",longDateTime:"dd-mmm-yyyy h:MM:ss TT Z",longDateTime2:"dd-mmm-yyyy HH:MM",longDateTime3:"dd-mmm-yyyy HH:MM",longDateTime4:"dd-mmm-yyyy hh:MM TT",shortDateTime:"mmm-dd h:MM TT"};
