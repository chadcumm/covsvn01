...
var amb_i18n = {
	...
	ERROR: "Error",
	FAILED_TO: "Failed to",
	FIRST_LOGIN_SENT1: "To view requsitions, select a location from the location drop down located in the top right quadrant. The system will save your last selected location and will default the next time the requisition manager is accessed.", //new
	FIRST_LOGIN_SENT2: "After selecting the location, select the refresh button to load requisitions into view defaulting the last weeks tasks. The date range of the requisitions viewed can be changed, however the system will limit retrieval for up to a 1 month time period.",//new
	FROM: "from",
	GENDER: "Gender",
	HELP_PAGE: "Help Page",
	...
	NO_RELATED_LOC: "No Locations Found", 
	...
	ORDER_TASKS: "Requisition Manager",
	ORDERED: "Ordered",
	...
	PATIENT_NAME: "Patient Name",   
 	PATIENT_SNAPSHOT: "Patient Information",
	PCP: "PCP",
	PENDING_RESULTS: "Pending Results",  
	PHONE_NUM: "Phone Numbers",
	PRINT_LABELS: "(remove) Print Label(s)",
	...
	TASK: "Requisition",
	TASK_COMM: "Requisition Comment",
	TASK_COMM_DETECT: "Requisition Comment Detected",
	TASK_COMMS: "Requisition Comments",
	TASK_COMM_REFRESH: "Requisition Comment Added/Modified (Please Refresh)",  
	TASK_DATE: "Requisition Date",
	TASK_DETAILS: "Requisition Details",
	TASK_DISCONTINUED: "Task Discontinued",  
	TASK_DONE: "Task Done",  
	TASK_IN_PROCESS: "Task In Process",  
	TASK_NOT_DONE: "Task Not Done",  
	TASK_LIST: "Requsition Manager",
	TASK_LIST_INFO: "Requsition Manager Information",
