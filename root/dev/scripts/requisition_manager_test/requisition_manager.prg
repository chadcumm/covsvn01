...
prompt 
	...
	, "F or I Drive or Web Services" = "I" 
...
set t_rec->prompts.org.w_drive = 
	"http://chstneanp/mpage-content/c0665.chs_tn.cernerasp.com/custom_mpage_content/requisition_manager/"
set t_rec->prompts.org.g_drive = 
	"http://104.170.114.248/mpage-content/c0665.chs_tn.cernerasp.com/custom_mpage_content/requisition_manager/"
set t_rec->prompts.chart.w_drive = 
	"http://chstneanp/mpage-content/c0665.chs_tn.cernerasp.com/custom_mpage_content/requisition_manager_chart/"
set t_rec->prompts.chart.g_drive = 
	"http://104.170.114.248/mpage-content/c0665.chs_tn.cernerasp.com/custom_mpage_content/requisition_manager_chart/"
...
if (t_rec->prompts.level = 1)
	...
	elseif (t_rec->prompts.drive = "W")
		set t_rec->static_content = t_rec->prompts.chart.w_drive
	elseif (t_rec->prompts.drive = "G")
		set t_rec->static_content = t_rec->prompts.chart.g_drive
	else
	...
	elseif (t_rec->prompts.drive = "W")
		set t_rec->static_content = t_rec->prompts.org.w_drive
	elseif (t_rec->prompts.drive = "G")
		set t_rec->static_content = t_rec->prompts.org.g_drive
	else
