...
pwx_get_selected = function (class_name) {
    ...
    $(class_name).each(function (index) {
        ...
        selectedElems[6][index] = $(this).children('dt.pwx_label_print_type').text()
        selectedElems[7][index] = $(this).children('dt.pwx_label_print_auto_off').text()
        selectedElems[8][index] = $(this).children('dt.pwx_task_order_id_hidden').text() + ".0";
    });
...
function pwx_toggle_person_task_type_pref_save() {
    if ($('#pwx_update_task_type_pref_dt').length > 0) {
        ...
        $('#pwx_new_task_types_pref_dt').on('click', function (event) {
            ...
            PWX_CCL_Request_User_Pref('amb_cust_mp_maintain_user_pref', js_criterion.CRITERION.PRSNL_ID, "PWX_MPAGE_PERSON_TASK_LIST_TYPES", typeArr.join('|'), true)
        ...
        $('#pwx_clear_task_type_pref').on('click', function (event) {
            var js_criterion = JSON.parse(m_criterionJSON);
            PWX_CCL_Request_User_Pref('amb_cust_mp_maintain_user_pref', js_criterion.CRITERION.PRSNL_ID, "PWX_MPAGE_PERSON_TASK_LIST_TYPES", "", true)
            $('#pwx_task_type_update_menu').css('display', 'none');
            pwx_toggle_person_task_type_pref_save()
        });
    }
...
function pwx_open_person_details(details) {
    ...
    var detailText = [];
    detailText.push('<dl class="pwx_task_detail_line"><dt>',amb_i18n.NAME,':</dt><dd>', details.PERSON_NAME, '</dd></dl>')
    detailText.push('<dl class="pwx_task_detail_line"><dt>',amb_i18n.AGE,':</dt><dd>', details.PT_AGE, '</dd></dl>')
    detailText.push('<dl class="pwx_task_detail_line"><dt>',amb_i18n.GENDER,':</dt><dd>', details.GENDER_CD, '</dd></dl>')
    detailText.push('<dl class="pwx_task_detail_line"><dt>',amb_i18n.DOB,':</dt><dd>', details.DOB, '</dd></dl>')
    detailText.push('<dl class="pwx_task_detail_line"><dt>',amb_i18n.MRN,':</dt><dd>', details.MRN, '</dd></dl>')
	//Shaun UTC Change
    //detailText.push('<dl class="pwx_task_detail_line"><dt>Visit Date:</dt><dd>', details.VISIT_DATE, '</dd></dl>')
...
var pwx_task_submenu_clicked_label_print_type = "";
var pwx_task_submenu_clicked_label_printoff_ind = "";
...
function RenderPWxFrame() {
    ...
    var js_criterion = JSON.parse(m_criterionJSON);
    PWX_CCL_Request_User_Pref('amb_cust_mp_maintain_user_pref', js_criterion.CRITERION.PRSNL_ID, "PWX_MPAGE_PERSON_TASK_TAB_PREF", "ORDERTASKS", true)
    var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^" + pwx_task_global_from_date + "^", "^" + pwx_task_global_to_date + "^", "^0^", "^" + pwx_task_get_type + "^", pwx_current_set_location + ".0"];
    PWX_CCL_Request("AMB_CUST_MP_TASK_BY_PERSON", sendArr, true, function () {
        start_page_load_timer = new Date();
        ...
        RenderTaskList(this, pwx_task_global_from_date, pwx_task_global_to_date);
    });
    ...
    pwxheadHTML.push('<div id="pwx_list_total_count"><span class="pwx_grey">0 ',amb_i18n.TOTAL_ITEMS,'</span></div></dt>');
    ...
    pwxheadHTML.push('<dt class="pwx_toolbar_task_icon"><a class="pwx_no_text_decor pwx_pointer_cursor" id="pwx_task_list_pt_details" title="',amb_i18n.VIEW_PT_DETAILS,'" ><span class="pwx-patient_data-icon">&nbsp;</span></a></dt>');
    pwxheadHTML.push('<dt id="pwx_location_list"></dt></div>');
    headelement.innerHTML = pwxheadHTML.join("");
    //person detail
    $('#pwx_task_list_pt_details').on('click', function (e) {
        PWX_CCL_Request_Person_Details("amb_cust_person_details_diag", js_criterion.CRITERION.PERSON_ID, js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID, false)
    });
    $('#pwx_frame_content').html('<div id="pwx_loading_div"><span class="pwx_loading-spinner"></span><br/><span id="pwx_loading_div_time">0 ' + amb_i18n.SEC + '</span></div>');
    start_pwx_timer()  
}
//display the list
function RenderTaskList(pwxdata, from, to) {
    ...
    from_date = '';
    to_date = '';
    if ($("#task_location").length == 0) {
        if (pwxdata.LOC_LIST.length > 0) {
            pwxloclistHTML = '<span class="pwx_location_list_lbl">' + amb_i18n.LOCATION + ': </span>';
			pwxloclistHTML += '<select id="task_location" name="task_location" style="width:300px;" data-placeholder="Choose a Location..." class="chzn-select"><option value=""></option>';
			
            if (pwx_current_set_location == 0) {
                pwxloclistHTML += '<option selected="selected" value="0">' + amb_i18n.ALL + '</option>'
            }
            else {
                pwxloclistHTML += '<option value="0">' + amb_i18n.ALL + '</option>'
            }
            var loc_height = 30;
            for (var i = 0; i < pwxdata.LOC_LIST.length; i++) {
                loc_height += 26;
                if (pwx_current_set_location == pwxdata.LOC_LIST[i].ORG_ID) {
                    pwxloclistHTML += '<option value="' + pwxdata.LOC_LIST[i].ORG_ID + '" selected="selected">' + pwxdata.LOC_LIST[i].ORG_NAME + '</option>';
                }
                else {
                    pwxloclistHTML += '<option value="' + pwxdata.LOC_LIST[i].ORG_ID + '">' + pwxdata.LOC_LIST[i].ORG_NAME + '</option>';
                }
            }
            if (loc_height > 300) { loc_height = 300; }
            pwxloclistHTML += '</select>';
            $('#pwx_location_list').html(pwxloclistHTML);
			...
			$("#task_location").on("change", function (event) {
                ...
                start_pwx_timer()
                var start_ccl_timer = new Date();
                var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^" + from + "^", "^" + to + "^", "^0^", "^" + pwx_task_get_type + "^", pwx_current_set_location];
                PWX_CCL_Request("AMB_CUST_MP_TASK_BY_PERSON", sendArr, true, function () {
                    var end_ccl_timer = new Date();
                    ccl_timer = (end_ccl_timer - start_ccl_timer) / 1000
                    start_page_load_timer = new Date();
                    this.TLIST.sort(pwx_sort_by_task_date)
                    RenderTaskList(this, from, to);
                });
			});
        }
    }
    ...
    pwxfilterbarHTML.push('<dt id="pwx_task_get_filter"><span style="vertical-align:30%;">',amb_i18n.DISPLAY,': </span><select id="task_get" name="task_get" multiple="multiple">');
    if (pwx_task_get_type_str == "All") {
    ...
    if (pwx_task_get_type_str == "By Date") {
        pwxfilterbarHTML.push('<option selected="selected" value="By Date">',amb_i18n.BY_DATE,'</option>');
    }
    else {
        pwxfilterbarHTML.push('<option value="By Date">',amb_i18n.BY_DATE,'</option>');
    }
    if (pwx_task_get_type_str == "This Visit") {
        pwxfilterbarHTML.push('<option selected="selected" value="This Visit">',amb_i18n.THIS_VISIT,'</option></select></dt>');
    }
    else {
        pwxfilterbarHTML.push('<option value="This Visit">',amb_i18n.THIS_VISIT,'</option></select></dt>');
    }
    ...
    if (pwx_global_statusArr.length > 0) {
        if (pwxdata.STATUS_LIST.length > 0) {
            pwxfilterbarHTML.push('<dt id="pwx_task_status_filter"><span style="vertical-align:30%;">',amb_i18n.STATUS,': </span><select id="task_status" name="task_status" multiple="multiple">');
            for (var i = 0; i < pwxdata.STATUS_LIST.length; i++) {
                ...
                if (status_match == 1) {
                    pwxfilterbarHTML.push('<option selected="selected" value="', pwxdata.STATUS_LIST[i].STATUS, '">', pwxdata.STATUS_LIST[i].STATUS, '</option>');
                }
                else {
                    pwxfilterbarHTML.push('<option value="', pwxdata.STATUS_LIST[i].STATUS + '">', pwxdata.STATUS_LIST[i].STATUS, '</option>');
                }
            }
    ...
    if (pwx_global_expanded == 1) { var filterStyle = "display:inline-block;"; var tglStyle = "pwx-collapse-tgl" } else { var filterStyle = "display:none"; var tglStyle = "pwx-expand-tgl" }
    pwxfilterbarHTML.push('<dt class="pwx_task_filterbar_left_icon" id="pwx_task_adv_filter_tgl" title="',amb_i18n.SHOW_ADV_FILTERS,'"><span class="' + tglStyle +'"></span></dt>');
    pwxfilterbarHTML.push('<dt class="pwx_task_filterbar_icon" id="pwx_task_info_icon"></dt>');
    pwxfilterbarHTML.push('<dt class="pwx_task_filterbar_icon" id="pwx_task_list_refresh_icon"><span class="pwx-refresh-icon" title="',amb_i18n.REFRESH_LIST,'"></span></dt>');
    //advanced filter bar
    pwxfilterbarHTML.push('<div id="pwx_frame_advanced_filters_container" style="' + filterStyle + '">')
    var fullOrderProv = $.map(pwxdata.TLIST, function (n, i) {
        return pwxdata.TLIST[i].ORDERING_PROVIDER;
    });
    var uniqueOrderProv = $.distinct(fullOrderProv);
    if (pwx_global_orderprovArr.length > 0 && pwx_global_orderprovFiltered == 1) {
        if (uniqueOrderProv.length > 0) {
            pwxfilterbarHTML.push('<dt id="pwx_task_orderprov_filter"><span style="vertical-align:30%;">',amb_i18n.ORDERING_PROV,': </span><select id="task_orderprov" name="task_orderprov" multiple="multiple">');
            for (var i = 0; i < uniqueOrderProv.length; i++) {
                ...
                if (type_match == 1) {
                    pwxfilterbarHTML.push('<option selected="selected" value="', uniqueOrderProv[i], '">', uniqueOrderProv[i], '</option>');
                }
                else {
                    pwxfilterbarHTML.push('<option value="', uniqueOrderProv[i], '">', uniqueOrderProv[i], '</option>');
                }
            }
            pwxfilterbarHTML.push('</select></dt>');
        }
    ...
    if (pwx_global_typeArr.length > 0) {
        if (pwxdata.TYPE_LIST.length > 0) {
            pwxfilterbarHTML.push('<dt id="pwx_task_type_filter"><span style="vertical-align:30%;">',amb_i18n.TYPE,': </span><select id="task_type" name="task_type" multiple="multiple">');
            for (var i = 0; i < pwxdata.TYPE_LIST.length; i++) {
                ...
                if (type_match == 1) {
                    pwxfilterbarHTML.push('<option selected="selected" value="', pwxdata.TYPE_LIST[i].TYPE, '">', pwxdata.TYPE_LIST[i].TYPE, '</option>');
                }
                else {
                    pwxfilterbarHTML.push('<option value="', pwxdata.TYPE_LIST[i].TYPE, '">', pwxdata.TYPE_LIST[i].TYPE, '</option>');
                }
            }
            pwxfilterbarHTML.push('</select></dt>');
        }
    ...
    if (pwxdata.TYPE_PREF_FOUND == 1) {
        pwxfilterbarHTML.push('<dt class="pwx_task_adv_filterbar_left_icon pwx_pointer_cursor" id="pwx_update_task_type_pref_dt"><span class="pwx-discsave_checkmark-icon">&nbsp;</span>',
        '<span class="pwx-icon_submenu_arrow-icon">&nbsp;</span></dt><div id="pwx_task_type_update_menu" style="display:none;"><a class="pwx_result_link" id="pwx_update_task_type_pref">',amb_i18n.UPDATE,'</a></br><a class="pwx_result_link" id="pwx_clear_task_type_pref">',amb_i18n.CLEAR,'</a></div>');
    }
    else {
        pwxfilterbarHTML.push('<dt class="pwx_task_adv_filterbar_left_icon pwx_pointer_cursor" id="pwx_new_task_types_pref_dt"><span id="pwx_new_task_types_pref" title="',amb_i18n.SAVE_TASK_TYPE_TOOLTIP,'" class="pwx-discsave-icon">&nbsp;</span></dt>');
    }
    pwxfilterbarHTML.push('</div>')
    pwxfilterbarHTML.push('</dl></div><div id="pwx_frame_paging_bar_container"><dt id="pwx_task_filterbar_page_prev" class="pwx_task_pagingbar_page_icons"></dt><dt id="pwx_task_filterbar_page_next" class="pwx_task_pagingbar_page_icons"></dt><dt id="pwx_task_pagingbar_cur_page" class="pwx_grey"></dt><dt id="pwx_task_pagingbar_load_text"></dt><dt id="pwx_task_pagingbar_load_count" class="pwx_grey"></dt></div><dl><dt id="pwx_frame_filter_bar_bottom_pad"></dt><dl></div>');
    //create the reschedule modal
    pwxfilterbarHTML.push('<div id="pwx-resched-dialog-confirm"><p class="pwx_small_text"><label for="pwx_resched_dt_tm"><span style="vertical-align:30%;">',amb_i18n.RESCHEDULED_TO,': </span><input type="text" id="pwx_resched_dt_tm" name="pwx_resched_dt_tm" style="width: 125px; height:14px;" /></label></p></div>'); 
    //add the event dialogs/menus
    ...
    $('#pwx_task_list_refresh_icon').on('click', function () {
        ...
        start_pwx_timer()
        var start_ccl_timer = new Date();
        var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^" + pwx_task_global_from_date + "^", "^" + pwx_task_global_to_date + "^", "^" + pwx_all_show_clicked + "^", "^" + pwx_task_get_type + "^", pwx_current_set_location];
        PWX_CCL_Request("AMB_CUST_MP_TASK_BY_PERSON", sendArr, true, function () {
            var end_ccl_timer = new Date();
            ccl_timer = (end_ccl_timer - start_ccl_timer) / 1000
            start_page_load_timer = new Date();
            this.TLIST.sort(pwx_sort_by_task_date)
            RenderTaskList(this, from_date, to_date);
        });
    });
    //function to handle a date range entry
    function RenderDateRangeTaskList(selectedDate, dateId) {
        if (dateId == 'to') {
            to_date = selectedDate;
            pwx_task_global_to_date = selectedDate;
            $("#from").datepicker("option", "maxDate", selectedDate);
            //mindate = Date.parse(selectedDate).addDays(-7).toString("MM/dd/yyyy");
            // $("#from").datepicker("option", "minDate", mindate);
            if ($("#from").val() != "" && from_date == '') {
                $("#from").val("")
            }
        }
        else {
            ...
            // maxdate = Date.parse(selectedDate).addDays(7).toString("MM/dd/yyyy");
        ...
        if (from_date != '' && to_date != '') {
            ...
            pwx_task_global_from_date = from_date;
            pwx_task_global_to_date = to_date;
            pwx_global_orderprovArr = [];
            var array_of_checked_values = $("#task_type").multiselect("getChecked").map(function () {
                return this.value;
            }).get();
            ...
            start_pwx_timer()
            var start_ccl_timer = new Date();
            var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^" + from_date + "^", "^" + to_date + "^", "^" + pwx_all_show_clicked + "^", "^0^", pwx_current_set_location];
            PWX_CCL_Request("AMB_CUST_MP_TASK_BY_PERSON", sendArr, true, function () {
                var end_ccl_timer = new Date();
                ccl_timer = (end_ccl_timer - start_ccl_timer) / 1000
                start_page_load_timer = new Date();
    ...
    if (pwx_task_get_type_str != "By Date") {
        $('#pwx_date_picker').css('display', 'none')
    }
    ...
    $("#task_get").multiselect({
        height: "80",
        header: false,
        multiple: false,
        minWidth: "100",
        classes: "pwx_select_box",
        noneSelectedText: amb_i18n.SELECT,
        selectedList: 1
    });
    ...
    var array_of_checked_values = $("#task_get").multiselect("getChecked").map(function () {
        return this.value;
    }).get();
    var taskgetAr = jQuery.makeArray(array_of_checked_values);
    $("#task_get").on("multiselectclick", function (event, ui) {
        if (taskgetAr[0] != ui.value) {
            switch (ui.value) {
                case 'All':
                    pwx_task_get_type = "0"
                    pwx_task_get_type_str = "All"
                    pwx_task_global_from_date = "0";
                    pwx_task_global_to_date = "0";
                    pwx_global_orderprovArr = [];
                    var array_of_checked_values = $("#task_type").multiselect("getChecked").map(function () {
                        return this.value;
                    }).get();
                    ...
                    start_pwx_timer()
                    var start_ccl_timer = new Date();
                    var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^0^", "^0^", "^0^", "^0^", pwx_current_set_location];
                    PWX_CCL_Request("AMB_CUST_MP_TASK_BY_PERSON", sendArr, true, function () {
                        var end_ccl_timer = new Date();
                        ccl_timer = (end_ccl_timer - start_ccl_timer) / 1000
                        start_page_load_timer = new Date();
                ...
                case 'This Visit':
                    pwx_task_get_type = "1"
                    pwx_task_get_type_str = "This Visit"
                    pwx_task_global_from_date = "0";
                    pwx_task_global_to_date = "0";
                    pwx_global_orderprovArr = [];
                    var array_of_checked_values = $("#task_type").multiselect("getChecked").map(function () {
                    ...
                    start_pwx_timer()
                    var start_ccl_timer = new Date();
                    var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^0^", "^0^", "^0^", "^1^", pwx_current_set_location];
                    PWX_CCL_Request("AMB_CUST_MP_TASK_BY_PERSON", sendArr, true, function () {
                        var end_ccl_timer = new Date();
                        ccl_timer = (end_ccl_timer - start_ccl_timer) / 1000
                        start_page_load_timer = new Date();
                ...
                case 'By Date':
                    pwx_task_get_type = "0"
                    pwx_task_get_type_str = "By Date"
                    $('#pwx_date_picker').css('display', 'inline-block')
                    taskgetAr = 'By Date';
                    break;
            }
        }
    ...
    switch (pwx_task_header_id) {
        case 'pwx_fcr_header_task_dt':
            pwxdata.TLIST.sort(pwx_sort_by_task)
            break;
        case 'pwx_fcr_header_type_dt':
            pwxdata.TLIST.sort(pwx_sort_by_task_type)
            break;
        case 'pwx_fcr_header_orderby_dt':
    ...
    var ccllinkparams = '^MINE^,^' + js_criterion.CRITERION.PWX_PATIENT_SUMM_PRG + '^,' + js_criterion.CRITERION.PERSON_ID + '.0,' + js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + '.0';
    $.contextMenu('destroy');
    $.contextMenu({
        selector: 'dl.pwx_content_row.pwx_tasklist_row',
        zIndex: '9999',
        className: 'ui-widget',
        build: function ($trigger, e) {
            ...
            var uniqueLabelArr = []
            uniqueLabelArr = $.grep(taskInfo[6], function (v, k) {
                return $.inArray(v, taskInfo[6]) === k;
            });
            var options = {
                items: {
                    "Done": { "name": amb_i18n.DONE, callback: function (key, opt) {
                        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, taskIdlist, chart_done_str);
                        if (taskSuccess == true) {
                        ...
                        if (lab_tasks_found == 1) {
                            ...
                            for (var cc = 0; cc < taskInfo[1].length; cc++) {
                                if (taskInfo[1][cc] == 3) {
                                    ...
                                    lab_orderAr.push(taskInfo[8][cc])
                                }
                            }
                            if (printLabel == 1) {
                                if (uniqueLabelArr[0] == "BACKEND" || js_criterion.CRITERION.PWX_ADV_PRINT == 0) {
                                    var taskSuccess = pwx_task_label_print_launch(js_criterion.CRITERION.PERSON_ID, lab_taskAr.join(','));
                                }
                                else if (uniqueLabelArr[0] == "ZEBRA") {
                                    orderIdlist = lab_orderAr.join(',')
                                    var ccllinkparams = '^MINE^,^' + orderIdlist + '^'
                                    window.location = "javascript:CCLLINK('AMB_CUST_MP_REFLAB_ZEBRA_LABEL','" + ccllinkparams + "',0)";
                                }
                                else if (uniqueLabelArr[0] == "ZEBRASMALL") {
                                    orderIdlist = lab_orderAr.join(',')
                                    var ccllinkparams = '^MINE^,^' + orderIdlist + '^'
                    ...
                    "Done (with Date/Time)": { "name": "Done (with Date/Time)", callback: function (key, opt) {
                        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, taskIdlist, 'CHART_DONE_DT_TM');
                        if (taskSuccess == true) {
                            $('dl.pwx_row_selected').each(function (index) {
                                var dlHeight = $(this).height()
                                $(this).children('dt.pwx_fcr_content_type_icon_dt').children('div.pwx_fcr_content_action_bar').css('backgroundColor', '#87C854').css('height', dlHeight).attr("title", amb_i18n.CHARTED_DONE_REFRESH)
                    ...
                    "Not Done": { "name": amb_i18n.NOT_DONE, callback: function (key, opt) {
                        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, taskIdlist, 'CHART_NOT_DONE');
                        if (taskSuccess == true) {
                            $('dl.pwx_row_selected').each(function (index) {
                                var dlHeight = $(this).height()
                    ...
                    "Task Comment": { "name": amb_i18n.TASK_COMM, callback: function (key, opt) {
                        ...
                        //$("#pwx-create-task-comment-dialog-confirm").dialog('open')
                    }
                    },
                    "sep2": "---------",
                    "Print Label(s)": { "name": amb_i18n.PRINT_LABELS, callback: function (key, opt) {
                        if (uniqueLabelArr[0] == "BACKEND" || js_criterion.CRITERION.PWX_ADV_PRINT == 0) {
                            var taskSuccess = pwx_task_label_print_launch(js_criterion.CRITERION.PERSON_ID, taskIdlist);
                        }
                        else if (uniqueLabelArr[0] == "ZEBRA") {
                            var orderInfo = pwx_get_selected_order_id('dl.pwx_row_selected');
                            orderIdlist = orderInfo.join(',');
                    ...
                    "fold2": { "name": amb_i18n.PRINT_REQ,
                        //"name": "Print Requisitions&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='pwx-submenu_arrow-icon'></span>",
                        "items": {
            ...
            if (pwxdata.FORMSLIST.length > 0) {
                for (var cc in pwxdata.FORMSLIST) {
                    options.items["fold1"].items[cc] = { "name": pwxdata.FORMSLIST[cc].FORM_NAME, callback: function (key, opt) { pwx_form_launch(pwxdata.PATIENT_ID, pwxdata.ENCOUNTER_ID, pwxdata.FORMSLIST[key].FORM_ID, 0.0, 0); } }
                }
                options.items["fold1"].items["Forms Menu"] = { "name": amb_i18n.ALL_FORMS, "className": "pwx_link_blue", callback: function (key, opt) { pwx_form_launch(pwxdata.PATIENT_ID, pwxdata.ENCOUNTER_ID, 0.0, 0.0, 0); } }
            }
            else {
    ...
    framecontentElem.on('click', 'span.pwx_fcr_content_type_detail_icon_dt', function (e) {
        ...
        if (pwxdata.TLIST[json_index].TASK_STATUS == 'Complete') {
			...
			if(pwxdata.TLIST[json_index].CHARTED_DT_UTC != "" && pwxdata.TLIST[json_index].CHARTED_DT_UTC != "TZ") {
				...
				task_detailText.push('<span style="color:black;padding-left:5px;">', pwxdata.TLIST[json_index].CHARTED_BY, ' ',amb_i18n.ON,' ', chartedUTCDate.format("shortDate3"), '</span></dt></dl>',
				reasonCD,'<dl class="pwx_task_detail_line"><div class="pwx_sub_sub-sec-hd">&nbsp;</div></dl>');
			}
			else {
				task_detailText.push('<span style="color:black;padding-left:5px;">', pwxdata.TLIST[json_index].CHARTED_BY, ' ',amb_i18n.ON,' --</span></dt></dl>',
				reasonCD,'<dl class="pwx_task_detail_line"><div class="pwx_sub_sub-sec-hd">&nbsp;</div></dl>');
			}
        }
        if (pwxdata.TLIST[json_index].TASK_TYPE_IND == 3) {
            ...
            //task_detailText.push('<dl class="pwx_task_detail_line"><dt>Task Date:</dt><dd>', pwxdata.TLIST[json_index].TASK_DATE, ' ', pwxdata.TLIST[json_index].TASK_TIME, '</dd></dl>');
			//Shaun UTC
            ...
            for (var y = 0; y < pwxdata.TLIST[json_index].OLIST.length; y++) {
				task_detailText.push('<dl class="pwx_task_detail_line" style="padding-top:5px;"><dt class="pwx_no_wrap"><span class="pwx_order_info_title pwx_semi_bold">',amb_i18n.ORDER,' ', (y + 1), ':&nbsp;</span><span style="color:#000000;">', pwxdata.TLIST[json_index].OLIST[y].ORDER_NAME,'</span></dt><div class="pwx_sub_sub-sec-hd">&nbsp;</div></dl>');
			...
			if (pwxdata.TLIST[json_index].DFAC_ACTIVITY_ID > 0) {
				formLink = '&nbsp;&nbsp;<a class="pwx_blue_link" onClick="pwx_form_launch(' +  pwxdata.PATIENT_ID + ',' + pwxdata.ENCOUNTER_ID + ',0.0,' + pwxdata.TLIST[json_index].DFAC_ACTIVITY_ID + ',1)">' + amb_i18n.OPEN_CHARTED_FORM + '</a>';
			}
            ...
            if (pwxdata.TLIST[json_index].DLIST.length > 0) {
                task_detailText.push('</dl>');
                task_detailText.push('<dl class="pwx_task_detail_line"><dd class="pwx_normal_line_height pwx_extra_small_text pwx_hvr_order_info_diag_pad">');
    ...
    framecontentElem.on('click', 'span.pwx-icon_submenu_arrow-icon.pwx_task_need_chart_menu', function (event) {
        ...
        pwx_task_submenu_clicked_order_id = $(pwx_task_submenu_clicked_row_elem).children('dt.pwx_task_order_id_hidden').html() + ".0";
        pwx_task_submenu_clicked_label_print_type = $(pwx_task_submenu_clicked_row_elem).children('dt.pwx_label_print_type').html();
        pwx_task_submenu_clicked_label_printoff_ind = $(pwx_task_submenu_clicked_row_elem).children('dt.pwx_label_print_auto_off').html();
    ...
    framecontentElem.on('click', 'span.pwx-med_task-icon.pwx_pointer_cursor, span.pwx-form_task-icon.pwx_pointer_cursor', function (e) {
        ...
        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, cur_task_id, 'CHART');
        $(this).parents('dl.pwx_content_row').removeClass('pwx_row_selected')
        if (taskSuccess == true) {
    ...
    framecontentElem.on('click', 'span.pwx-lab_task-icon.pwx_pointer_cursor', function (e) {
        ...
        var labelType = $(this).parents('dl.pwx_content_row').children('dt.pwx_label_print_type').html();
        var labelPrintOff = $(this).parents('dl.pwx_content_row').children('dt.pwx_label_print_auto_off').html();
        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, cur_task_id, 'CHART');
        $(this).parents('dl.pwx_content_row').removeClass('pwx_row_selected')
        if (taskSuccess == true) {
            var dlHeight = $(this).parents('dl.pwx_content_row').height()
            $(this).siblings('div.pwx_fcr_content_action_bar').css('backgroundColor', '#87C854').css('height', dlHeight).attr("title", amb_i18n.CHARTED_DONE_REFRESH)
            if (labelPrintOff != "1") {
                if (labelType == "BACKEND" || js_criterion.CRITERION.PWX_ADV_PRINT == 0) {
                    var taskSuccess = pwx_task_label_print_launch(js_criterion.CRITERION.PERSON_ID, cur_task_id);
                }
                else if (labelType == "ZEBRA") {
                    var orderIdlist = $(this).parents('dl.pwx_content_row').children('dt.pwx_task_order_id_hidden').html();
                    var ccllinkparams = '^MINE^,^' + orderIdlist + '^'
                    window.location = "javascript:CCLLINK('AMB_CUST_MP_REFLAB_ZEBRA_LABEL','" + ccllinkparams + "',0)";
                }
                else if (labelType == "ZEBRASMALL") {
                    var orderIdlist = $(this).parents('dl.pwx_content_row').children('dt.pwx_task_order_id_hidden').html();
                    var ccllinkparams = '^MINE^,^' + orderIdlist + '^'
                    window.location = "javascript:CCLLINK('AMB_CUST_MP_REFLAB_ZEBRASMALL','" + ccllinkparams + "',0)";
                }
    ...
    framecontentElem.on('click', 'span.pwx-clip_task-icon.pwx_pointer_cursor', function (e) {
        cur_task_id = $(this).parent('dt.pwx_fcr_content_type_icon_dt').siblings('span.pwx_task_id_hidden').html() + ".0";
        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, cur_task_id, 'CHART_DONE');
        $(this).parents('dl.pwx_content_row').removeClass('pwx_row_selected')
        if (taskSuccess == true) {
            var dlHeight = $(this).parents('dl.pwx_content_row').height()
            $(this).siblings('div.pwx_fcr_content_action_bar').css('backgroundColor', '#87C854').css('height', dlHeight).attr("title", amb_i18n.CHARTED_DONE_REFRESH)
    ...
    //alert('Delegate Event Timer: ' + delegate_event_timer)
}
...
function RenderTaskListContent(pwxdata) {
	...
	if (pwxdata.TLIST.length > 0) {
        ...
        for (var i = json_task_end_number; i < pwxdata.TLIST.length; i++) {
            ...
            for (var cc = 0; cc < pwx_global_orderprovArr.length; cc++) {
                //if (pwx_global_orderprovArr[cc] == pwxdata.TLIST[i].ORDERING_PROVIDER) {
            ...
            if (status_match == 1 && type_match == 1 && orderprov_match == 1) {
                ...
                */
                ...
                pwxcontentHTML.push('<dl class="pwx_content_row pwx_tasklist_row', grey_text, task_row_zebra_type, '">');
                ...
                pwxcontentHTML.push('<dt class="pwx_label_print_type">', pwxdata.TLIST[i].LABEL_PRINT_TYPE, '</dt>');
                pwxcontentHTML.push('<dt class="pwx_label_print_auto_off">', pwxdata.TLIST[i].LABEL_PRINT_AUTO_OFF, '</dt>');
                ...
                if (pwxdata.TLIST[i].TASK_TYPE_IND == 3) {
                    pwxcontentHTML.push('<dt class="pwx_fcr_content_task_dt ' + italicClass + '" '+ italicTitle + ' ><span class="pwx_fcr_content_type_ordname_dt">', pwxdata.TLIST[i].TASK_DISPLAY);
                    if (pwxdata.TLIST[i].POWERPLAN_IND > 0) {
                        pwxcontentHTML.push('&nbsp;&nbsp;&nbsp;<span class="pwx-powerplan-icon"></span>');
                    }
                    ...
                    for (var cc = 0; cc < pwxdata.TLIST[i].CONTAIN_LIST.length; cc++) {
                        pwxcontentHTML.push('<div class="pwx_task_lab_container_hidden">');
                        pwxcontentHTML.push('<span class="pwx_task_lab_line_text_hidden">', pwxdata.TLIST[i].CONTAIN_LIST[cc].CONTAIN_SENT, '</span>');
                        pwxcontentHTML.push('<span class="pwx_task_lab_taskid_hidden">', pwxdata.TLIST[i].CONTAIN_LIST[cc].TASK_ID, '</span>');
                        pwxcontentHTML.push('</div>');
                        pwxcontentHTML.push('<div class="pwx_leftpad_20 pwx_grey  pwx_lab_container_line_div" >', pwxdata.TLIST[i].CONTAIN_LIST[cc].CONTAIN_SENT, '</div>');
                        task_row_lines += '<br />&nbsp;';
                        if (cc == 0) {
                    ...
                    pwxcontentHTML.push('<dt class="pwx_fcr_content_task_dt ' + italicClass + '"  '+ italicTitle + ' ><span class="pwx_fcr_content_type_name_dt">', pwxdata.TLIST[i].TASK_DISPLAY);
                    if (pwxdata.TLIST[i].ORD_COMMENT != "--") {
                        pwxcontentHTML.push('<span class="pwx-small-comment-icon" title="',amb_i18n.ORDER_COMM_DETECT,'">&nbsp;</span>');
                    }
                    else if (pwxdata.TLIST[i].TASK_NOTE != "--") {
                        pwxcontentHTML.push('<span class="pwx-small-comment-icon" title="',amb_i18n.TASK_COMM_DETECT,'">&nbsp;</span>');
                    }
                    if (pwxdata.TLIST[i].POWERPLAN_IND > 0) {
                        pwxcontentHTML.push('&nbsp;&nbsp;&nbsp;<span class="pwx-powerplan-icon">&nbsp;</span>');
                    }
                    if (pwxdata.TLIST[i].ORDER_CDL != "--") {
                        pwxcontentHTML.push('&nbsp;<span class="pwx_grey pwx_extra_small_text">', pwxdata.TLIST[i].ORDER_CDL, '</span>');
                    }
                    pwxcontentHTML.push('</span><span class="pwx_fcr_content_type_detail_icon_dt" title="View Task Detail"><span class="pwx_task_json_index_hidden">', i, '</span><span class="ui-icon ui-icon-carat-1-e"></span></span>',
                    '</dt><span class="pwx_task_id_hidden">', pwxdata.TLIST[i].TASK_ID, '</span>');
                    var task_row_lines = '';
                }
                if (pwxdata.TLIST[i].TASK_PRN_IND == 1) {
                    pwxcontentHTML.push('<dt class="pwx_fcr_content_schdate_dt" style="padding-bottom:2px;">',amb_i18n.PRN, task_row_lines, '</dt>');
                }
                else {
					//Shaun UTc
                ...
                //pwxcontentHTML += '<dt class="pwx_fcr_content_orderdate_dt">' + pwxdata.TLIST[i].ORIG_ORDER_DT + task_row_lines + '</dt>';
                ...
                if (pwxdata.TLIST[i].ABN_LIST.length > 0) {
                    ...
                    abnmodStyle = 'style="max-width:11.5%;"'
                }
        ...
        if (row_cnt == 0) {
            $('#pwx_frame_rows_header_dl').after('<dl class="pwx_content_noresfilter_row"><span class="pwx_noresult_text">' + amb_i18n.SELECTED_FILTERS_NO_TASKS + '</span></dl>');
        }
    }
    else {
    ...
    //pwxcontentHTML += '<dl><dt class="pwx_show_all"></dt></dl>';
    pwxcontentHTML.push('</div>');
    //display content
    ...
    if (json_task_start_number > 0 || pagin_active == 1) {
    ...
    $('#pwx_task_chart_link').on('click', function (e) {
        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, pwx_task_submenu_clicked_task_id, 'CHART');
        if (taskSuccess == true) {
            ...
            if (pwx_task_submenu_clicked_task_type_ind == 3) {
                if(pwx_task_submenu_clicked_label_printoff_ind != "1") {
                        if (pwx_task_submenu_clicked_label_print_type == "BACKEND" || js_criterion.CRITERION.PWX_ADV_PRINT == 0) {
                            var taskSuccess = pwx_task_label_print_launch(js_criterion.CRITERION.PERSON_ID, pwx_task_submenu_clicked_task_id);
                        }
                        else if (pwx_task_submenu_clicked_label_print_type == "ZEBRA") {
                            var orderIdlist = pwx_task_submenu_clicked_order_id
                            var ccllinkparams = '^MINE^,^' + orderIdlist + '^'
                            window.location = "javascript:CCLLINK('AMB_CUST_MP_REFLAB_ZEBRA_LABEL','" + ccllinkparams + "',0)";
                        }
                        else if (pwx_task_submenu_clicked_label_print_type == "ZEBRASMALL") {
                            var orderIdlist = pwx_task_submenu_clicked_order_id
                            var ccllinkparams = '^MINE^,^' + orderIdlist + '^'
                            window.location = "javascript:CCLLINK('AMB_CUST_MP_REFLAB_ZEBRASMALL','" + ccllinkparams + "',0)";
                        }
    ...
    $('#pwx_task_chart_done_link').on('click', function (e) {
        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, pwx_task_submenu_clicked_task_id, 'CHART_DONE');
        if (taskSuccess == true) {
            $(pwx_task_submenu_clicked_row_elem).each(function (index) {
                var dlHeight = $(this).height()
                $(this).children('dt.pwx_fcr_content_type_icon_dt').children('div.pwx_fcr_content_action_bar').css('backgroundColor', '#87C854').css('height', dlHeight).attr("title", amb_i18n.CHARTED_DONE_REFRESH)
    ...
    $('#pwx_task_chart_done_dt_tm_link').on('click', function (e) {
        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, pwx_task_submenu_clicked_task_id, 'CHART_DONE_DT_TM');
        if (taskSuccess == true) {
            $(pwx_task_submenu_clicked_row_elem).each(function (index) {
                var dlHeight = $(this).height()
                $(this).children('dt.pwx_fcr_content_type_icon_dt').children('div.pwx_fcr_content_action_bar').css('backgroundColor', '#87C854').css('height', dlHeight).attr("title", amb_i18n.CHARTED_DONE_REFRESH)
    ...
    $('#pwx_task_chart_not_done_link, #pwx_task_chart_not_done_link2').on('click', function (e) { 
        var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, pwx_task_submenu_clicked_task_id, 'CHART_NOT_DONE');
        if (taskSuccess == true) {
            $(pwx_task_submenu_clicked_row_elem).each(function (index) {
                var dlHeight = $(this).height()
                $(this).children('dt.pwx_fcr_content_type_icon_dt').children('div.pwx_fcr_content_action_bar').css('backgroundColor', '#DF5E3E').css('height', dlHeight).attr("title", amb_i18n.CHARTED_NOT_DONE_REFRESH)
...
function refLabSubTab(pwxObj, from, to, clicked_id) {
    switch (clicked_id) {
        case 'pwx_inoffice_lab_tab':
            if (pwx_reflab_type_view != 1) {
                ...
                RenderRefLabList(pwxObj, from, to)
            }
            break;
...
pwx_get_reflab_selected = function (class_name) {
    var selectedElems = new Array(10);
    selectedElems[0] = new Array()
    selectedElems[1] = new Array()
    selectedElems[2] = new Array()
    selectedElems[3] = new Array()
    ...
    $(class_name).each(function (index) {
        ...
        selectedElems[7].length = index + 1
        selectedElems[8].length = index + 1
        selectedElems[9].length = index + 1
        selectedElems[0][index] = $(this).children('span.pwx_task_id_hidden').text() + ".0";
        ...
        selectedElems[8][index] = $(this).children('dt.pwx_label_print_type').text()
        selectedElems[9][index] = $(this).children('dt.pwx_label_print_auto_off').text()
    });
    return selectedElems;
}
...
var pwx_reflab_global_from_date = "0";
var pwx_reflab_global_to_date = "0";
...
var pwx_reflab_submenu_clicked_label_type = "";
var pwx_reflab_submenu_clicked_label_printoff_ind = "0";
...
function RenderPWxRefLabFrame() {
    ...
    var js_criterion = JSON.parse(m_criterionJSON);
    var start_ccl_timer = new Date();
    var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^" + pwx_reflab_global_from_date + "^", "^" + pwx_reflab_global_to_date + "^", "^0^", "^" + pwx_task_get_type + "^", pwx_current_set_location + ".0"];
    PWX_CCL_Request("AMB_CUST_MP_REFLAB_BY_PERSON", sendArr, true, function () {
        start_page_load_timer = new Date();
        ...
        RenderRefLabList(this, pwx_reflab_global_from_date, pwx_reflab_global_to_date);
    });
    //display frame header
    var headelement = document.getElementById('pwx_frame_head');
    var pwxheadHTML = [];
...
//display the list
function RenderRefLabList(pwxdata, from, to) {
    //clear the date ranges for the date range change function
    var start_filterbar_timer = new Date();
    json_task_start_number = 0;
    json_task_end_number = 0;
    ...
    var js_criterion = JSON.parse(m_criterionJSON);
    PWX_CCL_Request_User_Pref('amb_cust_mp_maintain_user_pref', js_criterion.CRITERION.PRSNL_ID, "PWX_MPAGE_PERSON_TASK_TAB_PREF", "REFLABS", true)
    from_date = '';
    to_date = '';
    if ($("#ref_location").length == 0) {
        if (pwxdata.LOC_LIST.length > 0) {
            var pwxloclistHTML = '<span class="pwx_location_list_lbl">' + amb_i18n.LOCATION + ': </span>';
			pwxloclistHTML += '<select id="ref_location" name="ref_location" style="width:300px;" data-placeholder="Choose a Location..." class="chzn-select"><option value=""></option>';
            if (pwx_current_set_location == 0) {
                pwxloclistHTML += '<option selected="selected" value="0">' + amb_i18n.ALL + '</option>'
            }
            else {
            ...
            $("#ref_location").on("multiselectclick", function (event, ui) {
                pwx_current_set_location = ui.value
               framecontentElem.empty();
               framecontentElem.html('<div id="pwx_loading_div"><span class="pwx_loading-spinner"></span><br/><span id="pwx_loading_div_time">0 ' + amb_i18n.SEC + '</span></div>');
                start_pwx_timer()
                var start_ccl_timer = new Date();
                var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^" + from + "^", "^" + to + "^", "^0^", "^" + pwx_reflab_get_type + "^", pwx_current_set_location];
                PWX_CCL_Request("AMB_CUST_MP_REFLAB_BY_PERSON", sendArr, true, function () {
                    var end_ccl_timer = new Date();
                    ccl_timer = (end_ccl_timer - start_ccl_timer) / 1000
                    start_page_load_timer = new Date();
                    RenderRefLabList(this, from, to);
                });
            });
			$('#ref_location').chosen({
				no_results_text : "No results matched"
    ...
    var pwxfilterbarHTML = [];
    pwxfilterbarHTML.push('<div id="pwx_frame_filter_bar"><div id="pwx_frame_filter_bar_container"><dl>');
    pwxfilterbarHTML.push('<dt id="pwx_reflab_subtabs_filter">')
    if (pwx_reflab_type_view == 1) {
    ...
    pwxfilterbarHTML.push('<dt id="pwx_task_get_filter" class="pwx_reflab_filter_bar_toppad" style="padding-left:16px;"><span style="vertical-align:30%;">',amb_i18n.DISPLAY,': </span><select id="task_get" name="task_get" multiple="multiple">');
    if (pwx_reflab_get_type_str == "All") {
        pwxfilterbarHTML.push('<option selected="selected" value="All">',amb_i18n.ALL,'</option>');
    }
    else {
        pwxfilterbarHTML.push('<option value="All">',amb_i18n.ALL,'</option>');
    }
    if (pwx_reflab_get_type_str == "By Date") {
        pwxfilterbarHTML.push('<option selected="selected" value="By Date">',amb_i18n.BY_DATE,'</option>');
    }
    else {
        pwxfilterbarHTML.push('<option value="By Date">',amb_i18n.BY_DATE,'</option>');
    }
    if (pwx_reflab_get_type_str == "This Visit") {
        pwxfilterbarHTML.push('<option selected="selected" value="This Visit">',amb_i18n.THIS_VISIT,'</option></select></dt>');
    }
    else {
        pwxfilterbarHTML.push('<option value="This Visit">',amb_i18n.THIS_VISIT,'</option></select></dt>');
    }
    pwxfilterbarHTML.push('<dt id="pwx_date_picker" class="pwx_reflab_filter_bar_toppad"><label for="from"><span style="vertical-align:20%;">',amb_i18n.ORDER_DATE,': </span><input type="text" id="from" name="from" class="pwx_date_box" /></label><label for="to"><span style="vertical-align:20%;"> ',amb_i18n.TO,' </span><input type="text" id="to" name="to" class="pwx_date_box" /></label></dt>');
    if (pwx_reflab_type_view == 2) {
        //pwxfilterbarHTML.push('<dt class="pwx_reflab_transfer_btn_dt"><button style="padding-left:5px;" id="pwx_reflab_transfer_btn" disabled="disabled">Transfer</button></dt>');
        pwxfilterbarHTML.push('<dt class="pwx_reflab_transfer_btn_dt"><div class="pwx_blue_button-cntrl_inactive" id="pwx_transfer_btn_cntrl"><div class="pwx_blue_buttonLeft"></div><div class="pwx_blue_buttonCenter">',amb_i18n.TRANSMIT,'</div><div class="pwx_blue_buttonRight"></div></div></dt>');
    }
    pwxfilterbarHTML.push('<dt class="pwx_task_filterbar_icon pwx_reflab_filter_bar_toppad" id="pwx_task_info_icon"></dt>');
    pwxfilterbarHTML.push('<dt class="pwx_task_filterbar_icon pwx_reflab_filter_bar_toppad" id="pwx_task_list_refresh_icon"><span class="pwx-refresh-icon" title="',amb_i18n.REFRESH_LIST,'"></span></dt>');
    //advanced filters for tabs 2 and 3
    if (pwx_reflab_type_view == 2) {
        pwxfilterbarHTML.push('<div id="pwx_frame_advanced_filters_container">')
        ...
        pwxfilterbarHTML.push('</dt>')
        pwxfilterbarHTML.push('<dt id="pwx_reflab_tolocation_filter" ></dt></div>')
        ...
        pwxfilterbarHTML.push('</select></dt></div>')
    }
    ...
    $('.pwx_lab_subtab-seg-cntrl').on('click', function () {
        ...
        refLabSubTab(pwxdata, from, to, tabId);
    })
    ...
    $('#pwx_task_list_refresh_icon').on('click', function () {
       ...
       framecontentElem.html('<div id="pwx_loading_div"><span class="pwx_loading-spinner"></span><br/><span id="pwx_loading_div_time">0 ' + amb_i18n.SEC + '</span></div>');
        start_pwx_timer()
        var start_ccl_timer = new Date();
        var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^" + pwx_reflab_global_from_date + "^", "^" + pwx_reflab_global_to_date + "^", "^0^", "^" + pwx_reflab_get_type + "^", pwx_current_set_location];
        PWX_CCL_Request("AMB_CUST_MP_REFLAB_BY_PERSON", sendArr, true, function () {
            var end_ccl_timer = new Date();
            ccl_timer = (end_ccl_timer - start_ccl_timer) / 1000
            start_page_load_timer = new Date();
            RenderRefLabList(this, from_date, to_date);
        });
    });
    if (pwx_reflab_type_view == 2) {
    ...
    function RenderDateRangeTaskList(selectedDate, dateId) {
        if (dateId == 'to') {
            to_date = selectedDate;
            pwx_reflab_global_to_date = selectedDate;
            $("#from").datepicker("option", "maxDate", selectedDate);
            //mindate = Date.parse(selectedDate).addDays(-7).toString("MM/dd/yyyy");
            // $("#from").datepicker("option", "minDate", mindate);
            if ($("#from").val() != "" && from_date == '') {
            ...
            from_date = selectedDate;
            pwx_reflab_global_from_date = selectedDate;
            $("#to").datepicker("option", "minDate", selectedDate);
            // maxdate = Date.parse(selectedDate).addDays(7).toString("MM/dd/yyyy");
            // $("#to").datepicker("option", "maxDate", maxdate);
            if ($("#to").val() != "" && to_date == '') {
        ...
        if (from_date != '' && to_date != '') {
            //both dates found relaunch list
            pwx_reflab_global_from_date = from_date;
            pwx_reflab_global_to_date = to_date;
           framecontentElem.empty();
           framecontentElem.html('<div id="pwx_loading_div"><span class="pwx_loading-spinner"></span><br/><span id="pwx_loading_div_time">0 ' + amb_i18n.SEC + '</span></div>');
            start_pwx_timer()
            var start_ccl_timer = new Date();
            var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^" + from_date + "^", "^" + to_date + "^", "^0^", "^0^", pwx_current_set_location];
            PWX_CCL_Request("AMB_CUST_MP_REFLAB_BY_PERSON", sendArr, true, function () {
                var end_ccl_timer = new Date();
                ccl_timer = (end_ccl_timer - start_ccl_timer) / 1000
                start_page_load_timer = new Date();
                this.TLIST.sort(pwx_sort_by_order_date)
                RenderRefLabList(this, from_date, to_date);
            });
        }
    }
    ...
    $("#task_get").on("multiselectclick", function (event, ui) {
        if (taskgetAr[0] != ui.value) {
            switch (ui.value) {
                case 'All':
                    pwx_reflab_get_type = "0"
                    pwx_reflab_get_type_str = "All"
                    pwx_reflab_global_from_date = "0";
                    pwx_reflab_global_to_date = "0";
                   framecontentElem.html('<div id="pwx_loading_div"><span class="pwx_loading-spinner"></span><br/><span id="pwx_loading_div_time">0 ' + amb_i18n.SEC + '</span></div>');
                    start_pwx_timer()
                    var start_ccl_timer = new Date();
                    var sendArr = ["^MINE^", js_criterion.CRITERION.PERSON_ID + ".0", js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ".0", js_criterion.CRITERION.PRSNL_ID + ".0", js_criterion.CRITERION.POSITION_CD + ".0", "^0^", "^0^", "^0^", "^0^", pwx_current_set_location];
                    ...
                    break;
                case 'This Visit':
                    pwx_reflab_get_type = "1"
                    pwx_reflab_get_type_str = "This Visit"
                    pwx_reflab_global_from_date = "0";
                    pwx_reflab_global_to_date = "0";
                    framecontentElem.html('<div id="pwx_loading_div"><span class="pwx_loading-spinner"></span><br/><span id="pwx_loading_div_time">0 ' + amb_i18n.SEC + '</span></div>');
                    start_pwx_timer()
                ...
                case 'By Date':
                    pwx_reflab_get_type = "0"
                    pwx_reflab_get_type_str = "By Date"
                    $('#pwx_date_picker').css('display', 'inline-block')
                    taskgetAr = 'By Date';
                    break;
            }
    ...
    $(window).on('resize', function () {
		...
		var contentrowsH = filterbarH + 19;
		$('#pwx_frame_content_rows').css('top', contentrowsH + 'px');
        $('span.pwx_fcr_content_type_name_dt, span.pwx_fcr_content_type_ordname_dt, dt.pwx_fcr_content_col_orderprov_dt').each(function (index) {
            if (this.clientWidth < this.scrollWidth) {
                var titleText = $(this).text()
                $(this).attr("title", titleText)
            }
   ...
   framecontentElem.on('mousedown', 'dl.pwx_content_row', function (e) {
    ...
    $.contextMenu({
        ...
        build: function ($trigger, e) {
            ...
            var uniqueLabelArr = []
            uniqueLabelArr = $.grep(taskInfo[8], function (v, k) {
            ...
            if (pwx_reflab_type_view == 1) {
                var options = {
                    items: {
                        "Done": { "name": amb_i18n.DONE, callback: function (key, opt) {
                            var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, taskIdlist, 'CHART');
                            ...
                            if (taskSuccess == true) {
                                ...
                                if (pwxdata.AUTOLOG_SPEC_IND == 1) { setTimeout(function () { PWX_CCL_Request_Specimen_Login("amb_cust_call_spec_auto_loc", taskIdlist, true) }, 1000); }
                            }
                            $('dl.pwx_row_selected').removeClass('pwx_row_selected')
                        }
                        },
   ...
   framecontentElem.on('click', 'span.pwx-icon_submenu_arrow-icon.pwx_task_need_chart_menu', function (event) {
        ...
        pwx_reflab_submenu_clicked_label_type = $(pwx_reflab_submenu_clicked_row_elem).children('dt.pwx_label_print_type').html();
        pwx_reflab_submenu_clicked_label_printoff_ind = $(pwx_reflab_submenu_clicked_row_elem).children('dt.pwx_label_print_auto_off').html();
        $(this).parents('dl.pwx_content_row').removeClass('pwx_row_selected')
        $('#pwx_task_chart_done_menu').css('display', 'none');
        var dt_pos = $(this).position();
        var test_var = document.documentElement.offsetHeight;
   ...
   framecontentElem.on('click', 'span.pwx_reflab_lab_results', function (e) {
        //var parameter_person_launch = '/PERSONID=' + js_criterion.CRITERION.PERSON_ID + ' /ENCNTRID=' + js_criterion.CRITERION.ENCNTRS[0].ENCNTR_ID + ' /FIRSTTAB=^Laboratory^'
        ...
        MP_DCP_REFLAB_GET_ORDER_RESULTS_Request("amb_cust_mp_get_order_results", resultorderId, js_criterion.CRITERION.PERSON_ID, true)
        $(this).parents('dl.pwx_content_row').removeClass('pwx_row_selected')
    });
...
function RenderRefLabListContent(pwxdata) {
    ...
    if (pwxdata.TLIST.length > 0) {
        ...
        if (pwx_reflab_type_view == 3) {
            ...
            if (pwx_reflab_trans_header_id == 'pwx_fcr_trans_header_orderdate_dt') {
                pwxcontentHTML.push('<dt id="pwx_fcr_trans_header_orderdate_dt">',amb_i18n.ORDER_DATE,'<span id="task_sort_tgl" class="', sort_icon, '" >&nbsp;</span></dt>');
            }
            else {
                pwxcontentHTML.push('<dt id="pwx_fcr_trans_header_orderdate_dt">',amb_i18n.ORDER_DATE,'</dt>');
            }
            ...
            for (var i = json_reflab_end_number; i < pwxdata.TLIST.length; i++) {
                ...
                if (pwxdata.TLIST[i].LAB_IND == pwx_reflab_type_view && pwxdata.TLIST[i].COLLECTED_IND == pwx_reflab_collection_type_view && toLocationMatch == 1 && resultMatch == 1) {
                    ...
                    if (pwxdata.TLIST[i].RESULTS_IND == 1) {
                        pwxcontentHTML.push('<span class="pwx_fcr_content_action_indicator_dt pwx_reflab_ready_trans"></span><span class="pwx_fcr_content_action_move_dt"><span class="pwx_reflab_lab_results"><a class="pwx_blue_link">',amb_i18n.RESULTS_REC,'</a></span></span>');
                    }
                    else if (pwxdata.TLIST[i].RESULTS_IND == 2) {
                        pwxcontentHTML.push('<span class="pwx_fcr_content_action_indicator_dt pwx_reflab_warning_trans"></span><span class="pwx_fcr_content_action_move_dt"><span class="pwx_reflab_lab_results"><a class="pwx_blue_link">',amb_i18n.PENDING_RESULTS,'</a></span></span>');
                    }
                    else {
	...
	//sm017997 current
            ...
            for (var i = json_reflab_end_number; i < pwxdata.TLIST.length; i++) {
                ...
                if (pwxdata.TLIST[i].LAB_IND == pwx_reflab_type_view && pwxdata.TLIST[i].COLLECTED_IND == pwx_reflab_collection_type_view && toLocationMatch == 1) {
                    ...
                    //add italic class if inprocess;
                    pwxcontentHTML.push('<dt class="pwx_fcr_content_labname_dt " ><span class="pwx_fcr_content_type_ordname_dt">', pwxdata.TLIST[i].ORDERED_AS_NAME);
                    pwxcontentHTML.push('</span><span class="pwx_grey pwx_fcr_content_type_ascname_dt">', pwxdata.TLIST[i].ASC_NUM, '</span><span class="pwx_fcr_content_type_detail_icon_dt" title="',amb_i18n.VIEW_TASK_DETAILS,'"><span class="pwx_task_json_index_hidden">', i, '</span><span class="ui-icon ui-icon-carat-1-e"></span></span>');
                    var task_row_lines = '';
                    var task_id_collect = '';
                    for (var cc = 0; cc < pwxdata.TLIST[i].CONTAIN_LIST.length; cc++) {
                        ...
                        pwxcontentHTML.push('<span class="pwx_task_lab_line_text_hidden">', pwxdata.TLIST[i].CONTAIN_LIST[cc].CONTAIN_SENT, '</span>');
                        pwxcontentHTML.push('<span class="pwx_task_lab_taskid_hidden">', pwxdata.TLIST[i].CONTAIN_LIST[cc].TASK_ID, '</span>');
                        pwxcontentHTML.push('<span class="pwx_task_lab_containid_hidden">', pwxdata.TLIST[i].CONTAIN_LIST[cc].CONTAINER_ID, '</span>');
                        pwxcontentHTML.push('</div>');
                        pwxcontentHTML.push('<div class="pwx_leftpad_20 pwx_grey  pwx_lab_container_line_div" >', pwxdata.TLIST[i].CONTAIN_LIST[cc].CONTAIN_SENT, '</div>');
                        task_row_lines += '<br />&nbsp;';
                        if (cc == 0) {
                    ...
                    if (pwxdata.TLIST[i].NO_LOGIN_LOCATION != 1) {
                        if (pwxdata.TLIST[i].NOT_LOGIN_LOC != 1) {
                                ...
                                if (pwxdata.TLIST[i].TRANSFER_LIST_ID == 0) {
                                    if (pwxdata.TLIST[i].TRANS_LOC.length > 0) {
                                        if (pwxdata.TLIST[i].TRANS_LOC.length == 1) {
                                            ...
                                            //for (var cc = 0; cc < pwxdata.TLIST[i].TRANS_LOC.length; cc++) {
                                            //    pwxcontentHTML.push('<option value="', pwxdata.TLIST[i].TRANS_LOC[cc].SR_RESOURCE_CD, '">', pwxdata.TLIST[i].TRANS_LOC[cc].LOCATION_DISP, '</option>')
                                            //}
                            ...
                            pwxcontentHTML.push('<span class="pwx_fcr_content_action_indicator_dt pwx_reflab_unable_trans"></span><span class="pwx_fcr_content_action_move_dt"><span title="',amb_i18n.SPEC_NOT_LOGIN_LOC,'">',amb_i18n.SPEC_NOT_LOGIN,'</span></br><span class="pwx_reflab_relogin_lab"><a class="pwx_blue_link">',amb_i18n.LOGIN_TO_SPEC_LOC,'</a></span></span>');
                        }
                    }
                    else {
            ...
            for (var i = json_reflab_end_number; i < pwxdata.TLIST.length; i++) {
                ...
                if (pwxdata.TLIST[i].LAB_IND == pwx_reflab_type_view) {
                    ...
                    pwxcontentHTML.push('</dt>');
                    //add italic class if inprocess;
                    pwxcontentHTML.push('<dt class="pwx_fcr_content_col_labname_dt " ><span class="pwx_fcr_content_type_ordname_dt">', pwxdata.TLIST[i].ORDERED_AS_NAME);
                    pwxcontentHTML.push('</span><span class="pwx_grey pwx_fcr_content_type_ascname_dt">', pwxdata.TLIST[i].ASC_NUM, '</span><span class="pwx_fcr_content_type_detail_icon_dt" title="',amb_i18n.VIEW_PT_DETAILS,'"><span class="pwx_task_json_index_hidden">', i, '</span><span class="ui-icon ui-icon-carat-1-e"></span></span>');
                    var task_row_lines = '';
                    var task_id_collect = '';
                    for (var cc = 0; cc < pwxdata.TLIST[i].CONTAIN_LIST.length; cc++) {
                        pwxcontentHTML.push('<div class="pwx_task_lab_container_hidden">');
    ...
    if (json_reflab_start_number > 0) {
        ...
        $('#pwx_task_filterbar_page_prev').on('click', function () {
            reflab_list_curpage--
            json_reflab_end_number = json_reflab_page_start_numbersAr[reflab_list_curpage - 1]
           framecontentElem.empty();
           framecontentElem.html('<div id="pwx_loading_div"><span class="pwx_loading-spinner"></span><br/><span id="pwx_loading_div_time">0 ',amb_i18n.SEC,'</span></div>');
            start_pwx_timer()
            start_page_load_timer = new Date();
    ...
    if (pwx_reflab_type_view == 1) {
        ...
        $('#pwx_task_chart_link').on('click', function (e) {
            var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, pwx_reflab_submenu_clicked_task_id, 'CHART');
            var labelType = $(this).parents('dl.pwx_content_row').children('dt.pwx_label_print_type').html();
            if (taskSuccess == true) {
                ...
                if (pwx_reflab_submenu_clicked_label_printoff_ind != "1") {
                    if (pwx_reflab_submenu_clicked_label_type == "BACKEND" || js_criterion.CRITERION.PWX_ADV_PRINT == 0) {
                        var taskSuccess = pwx_task_label_print_launch(js_criterion.CRITERION.PERSON_ID, pwx_reflab_submenu_clicked_task_id);
                    }
                    else if (pwx_reflab_submenu_clicked_label_type == "ZEBRA") {
                        var orderIdlist = pwx_reflab_submenu_clicked_order_id
                        var ccllinkparams = '^MINE^,^' + orderIdlist + '^'
                        window.location = "javascript:CCLLINK('AMB_CUST_MP_REFLAB_ZEBRA_LABEL','" + ccllinkparams + "',0)";
                    }
                    else if (pwx_reflab_submenu_clicked_label_type == "ZEBRASMALL") {
                        var orderIdlist = pwx_reflab_submenu_clicked_order_id
                        var ccllinkparams = '^MINE^,^' + orderIdlist + '^'
                        window.location = "javascript:CCLLINK('AMB_CUST_MP_REFLAB_ZEBRASMALL','" + ccllinkparams + "',0)";
                    }
        ...
        $('#pwx_task_chart_not_done_link2').on('click', function (e) {
            var taskSuccess = pwx_task_launch(js_criterion.CRITERION.PERSON_ID, pwx_reflab_submenu_clicked_task_id, 'CHART_NOT_DONE');
        ...
        if (uniqueLabLoc.length > 1) {
            var labLocHTML = []
            labLocHTML.push('<span style="vertical-align:30%;">',amb_i18n.LAB,': </span><select id="reflab_to_location" name="reflab_to_location" multiple="multiple" width="220px">');
...
function MP_DCP_REFLAB_TRANSFER_Request(program, blobIn, paramAr, async) {
    ...
    refTransmitModal.setBodyDataFunction(
                function (modalObj) {
                    modalObj.setBodyHTML('<div style="padding-top:30px;" style="float:left;width:100%;text-align:center;"><div class="pwx_loading-spinner" style="position:relative;width:32px;left:50%;margin-left:-16px;"></div></div>');
                });
    ...
    info.onreadystatechange = function () {
        ...
        if (info.readyState == 4 && info.status == 200) {
            ...
            if (recordData.STATUS_DATA.STATUS == "S") {
                ...
                MP_ModalDialog.deleteModalDialogObject("TaskActionFail")
                var taskFailModal = new ModalDialog("TaskActionFail")
                    .setHeaderTitle('<span class="pwx_alert">Error!</span>')
                    .setTopMarginPercentage(20)
                    .setRightMarginPercentage(35)
                    .setBottomMarginPercentage(30)
                    .setLeftMarginPercentage(35)
    ...
    info.onreadystatechange = function () {
        if (info.readyState == 4 && info.status == 200) {
            ...
            if (recordData.STATUS_DATA.STATUS == "S") {
                ...
                retransferbtn.setText("Retransmit").setCloseOnClick(true).setOnClickFunction(function () { MP_DCP_REFLAB_RETRANSFER_Request("amb_cust_mp_reflab_retransfer", param1, true) }); ;
...
function MP_DCP_REFLAB_GET_ORDER_RESULTS_Request(program, param1, param2, async) {
    var info = new XMLCclRequest();
    info.onreadystatechange = function () {
        if (info.readyState == 4 && info.status == 200) {
            var jsonEval = JSON.parse(this.responseText);
            ...
            if (recordData.STATUS_DATA.STATUS == "S") {
                ...
                for (var y = 0; y < recordData.ORDER_LIST.length; y++) {
					detailsHTML.push('<dl class="pwx_task_detail_line" style="padding-top:5px;"><dt class="pwx_no_wrap"><span class="pwx_order_info_title pwx_semi_bold">',amb_i18n.ORDER,' ', (y + 1), ':&nbsp;</span><span class="pwx_semi_bold" style="color:#000000;">', recordData.ORDER_LIST[y].ORDER_NAME,'</span></dt><div class="pwx_sub_sub-sec-hd">&nbsp;</div></dl>');
