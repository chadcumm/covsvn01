...
*******************************************************************************
	...
	Solution:			Radiology
	Source file name:  	cov_mammo_extract_sl.prg
	Object name:		cov_mammo_extract_sl
	CR#:				6139
...
drop program cov_mammo_extract_sl:dba go
create program cov_mammo_extract_sl:dba
...
declare FILENAME_VAR	= vc with constant(build("mammoservicelinedaily", ".txt"))
...
if (t_rec->output_file_ind = 1)
	...
	set t_rec->prompt_startdate = cnvtdatetime(datetimefind(cnvtlookbehind("1,Y",cnvtdatetime(curdate,curtime3)), 'Y', 'B', 'B'))
...
from OMF_RADMGMT_ORDER_ST oros
	...
	,(inner join ORDER_CATALOG oc on oc.catalog_cd = oros.catalog_cd
		...
		and oc.description in("MG*", "MG US*","Puncture Aspiration of Cyst of Breast; 19000",
			"MG Dig Diag Mammo Inc CAD Bilateral",
			"MG Post Procedure Mammo/Diff Mod Lt",
			"Biopsy of Breast; Open, Incisional 19101",
			"MRI Breast w/o Contrast Rt",
			"MRI Breast w/ + w/o Contrast Bil Inc CAD+",
			"MRI Breast Bx w/ MRI Guide 1st Site Lt",
			"MG US Biopsy Breast 1st Site Lt",
			"CHRG BIOPSY OF BREAST; OPEN, INCISIONAL 19101",
			"MG Dig Screen Mammo 2V Inc CAD Bilateral",
			"MG Dig Diag Mammo w/ CAD/Tomo Rt+",
			"US Breast Limited Right",
			"MG Dig Screen Mammo Limited Inc CAD Bil",
			"MRI Breast w/o + w/ Contrast w/ CAD Rt+",
			"US Breast Limited Bilateral",
			"US Biopsy Breast Each Addl Lt",
			"MG US Biopsy Breast 1st Site Rt",
			"MG US Breast Complete Bil",
			"MG Dig Screen Mammo Limited CAD/Tomo+",
			"MG Dig Diag Mammo Implant 4V CD/Tomo Lt+",
			"MG Dig Same Day DX/SCR w/ CAD Bil",
			"Biopsy of Breast; Percutaneous, Needle Core, Not Using Imaging Guidance 19100",
			"MG Dig Same Day DX/SCR w/ CAD Lt",
			"MRI Biopsy Breast Each Addl Site Rt",
			"MG US Breast Limited Lt",
			"MG Post Procedure Mammo/Diff Mod Bil",
			"MG Dig Screen Mammo Implant 8V w/CAD Bil",
			"MG Dig Diag Mammo Inc CAD Rt",
			"MG Dig Diag Mammo Implant 4V w/ CAD Lt",
			"MG Dig Diag Mammo Implant 8V CD/TM Bil+",
			"Biopsy Breast, w/Imaging of the Biopsy Specimen, First Lesion w/US Guidance 19083",
			"MRI Breast w/o Contrast Lt",
			"MRI Breast Bx w/ MRI Guide 1st Site Rt",
			"US Breast Biopsy w/ US Guide 1st Site Lt",
			"MG Duct or Galactogram Single+",
			"MG Stereo Biopsy Breast Each Addl Lt",
			"MG Stereo Biopsy Breast Each Addl Rt",
			"Biopsy Breast w/Image w/U/S Guild-1st lesion POC 19083",
			"Puncture Aspiration of Cyst of Breast; ea add'l Cyst 19001",
			"MG Dig Diag Mammo Implant 8V w/ CAD Bil",
			"MG Dig Screen Mammo Implant 4V w/ CAD Rt",
			"MG Dig Screen Mammo Implant 4V CD/TM Rt+",
			"MG Dig Screen Mammo Implant 4V w/ CAD Lt",
			"MG Dig Screen Mammo Implant 8V CD/TM Bl+",
			"MRI Breast w/o + w/ Contrast w/ CAD Lt+",
			"MG Breast Bx w/ Stereo Guide 1st Site Rt",
			"US Breast Biopsy w/ US Guide 1st Site Rt",
			"US Breast Cyst Aspiration 1st Site Left+",
			"MG US Biopsy Breast Each Addl Rt",
			"MG US Breast Complete Rt",
			"CHRG BIOPSY OF BREAST; PERCUTANEOUS, NEEDLE CORE, NOT USING IMAGING GUIDANCE 19100",
			"MG Dig Diag Mammo Implant 4V w/ CAD Rt",
			"MG Dig Screen Mammo Implant 4V CD/TM Lt+",
			"MG Post Procedure Mammo/Diff Mod Rt",
			"MG Dig Diag Mammo w/ CAD/Tomo Lt+",
			"Biopsy Breast, w/Imaging of the Biopsy Specimen, Ea Add Lesion w/US Guidance 19084",
			"US Breast Complete Bil",
			"MG Breast Bx w/ Stereo Guide 1st Site Lt",
			"US Breast Cyst Aspiration 1st Site Right+",
			"MG US Biopsy Breast Each Addl Lt",
			"MG US Breast Complete Lt",
			"CHRG BIOPSY BREAST, W/IMAGING OF THE BIOPSY SPECIMEN, FIRST LESION 19081",
			"CHRG BX, BREAST, W/PLACE OF BREAST LOCAL DEVICE AND IMAGING OF THE BIX SPECIMEN PERC EA ADD 19082",
			"MG Dig Same Day DX/SCR w/ CAD Rt",
			"MG Dig Diag Mammo Inc CAD Lt",
			"US Breast Complete Left",
			"US Breast Complete Right",
			"MG Dig Diag Mammo Implant 4V CD/Tomo Rt+",
			"MRI Breast w/o Contrast Bilateral",
			"US Biopsy Breast Each Addl Rt",
			"MG Duct or Galactogram Multiple+",
			"MG Dig Diag Mammo CAD/Tomo Bilateral+",
			"MG Dig Screen Mammo 2V CAD/Tomo Bil+",
			"US Breast Limited Left",
			"MG US Breast Limited Rt",
			"MRI Biopsy Breast Each Addl Site Lt",
			"MG US Breast Limited Bil",
			"CHRG PUNCTURE ASPIRATION OF CYST OF BREAST; 19000",
			"Biopsy Breast w/Image w/U/S Guild-ea add lesion POC 19084")
		and oc.active_ind = 1)
