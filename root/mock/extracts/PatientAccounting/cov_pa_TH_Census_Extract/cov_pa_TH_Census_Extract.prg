...
set enc_loc_data->end_datetime		= format(start_datetime, "mm/dd/yyyy;;d")
...
select 
	elh2.encntr_loc_hist_id
from
	ENCNTR_LOC_HIST elh2
	
where 1 = 1
	and elh2.encntr_type_cd in (
		309308.00,
		309312.00,
		19962820.00
	)
	and nullval(elh2.loc_bed_cd, 0.0) > 0.0
	and cnvtdatetime("05-AUG-2022 000000") between elh2.beg_effective_dt_tm and elh2.end_effective_dt_tm
;				and cnvtdatetime("02-SEP-2022 000000") between elh2.beg_effective_dt_tm and elh2.end_effective_dt_tm
	and elh2.end_effective_dt_tm != cnvtdatetime("31-DEC-2100 00:00:00")
