...
******************************************************************************
 	...
 	----------	--------------------	--------------------------------------
 	09/24/2018	Todd A. Blanchard		Changed logic to copy files directly to AStream.
...
declare end_datetime		= dq8 with noconstant(cnvtlookahead("8, d", cnvtdatetime(curdate, 235959)))
