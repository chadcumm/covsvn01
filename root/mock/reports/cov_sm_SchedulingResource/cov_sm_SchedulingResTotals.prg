...
004	12/07/2021	Todd A. Blanchard		Adjusted order by clause.
										...
										to be displayed.
005	09/07/2022	Todd A. Blanchard		Revised sort order for results.
 
******************************************************************************/
 
drop program cov_sm_SchedulingResTotals:DBA go
create program cov_sm_SchedulingResTotals:DBA
...
;	sched_obj->list[d1.seq].sch_obj_desc ;001
	;001 ;004
	if (cnvtupper(sched_obj->list[d1.seq].sch_obj_desc) in ("UNKNOWN*")) ;005
