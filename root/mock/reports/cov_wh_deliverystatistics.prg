...
with OUTDEV, pStartDate, pEndDate, org
 ...
 SUBROUTINE  titlesectionabs (ncalc ,offsetx ,offsety )
  ...
  DECLARE __start_date_lbl = vc WITH noconstant (build2 (captions->start_date ,char (0 ) ) ) ,
  protect
  ...
  DECLARE __executed_by_lbl = vc WITH noconstant (build2 (captions->executed_by ,char (0 ) ) ) ,
  protect
  DECLARE __executed_dt_tm_lbl = vc WITH noconstant (build2 (captions->execute_dt_tm ,char (0 ) ) ) ,
  protect
  DECLARE __executed_by = vc WITH noconstant (build2 (delivery->executed_by ,char (0 ) ) ) ,protect
  DECLARE __executed_dt_tm = vc WITH noconstant (build2 (delivery->executed_dt_tm ,char (0 ) ) ) ,
  protect
  IF ((ncalc = rpt_render ) )
 ...
 SUBROUTINE  summarycountsectionabs (ncalc ,offsetx ,offsety )
  ...
  DECLARE __mothers_delivered = vc WITH noconstant (build2 (captions->mothers_delivered ,char (0 ) )
   ) ,protect
  DECLARE __nul_mothers_lbl = vc WITH noconstant (build2 (captions->nuliparous_mothers ,char (0 ) )
   ) ,protect
  DECLARE __thirty_seven_lbl = vc WITH noconstant (build2 (captions->greater_37_wks ,char (0 ) ) ) ,
  protect
  DECLARE __fifteen_g_lbl = vc WITH noconstant (build2 (captions->less_1500_g ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result = vc WITH noconstant (build2 (delivery->num_births[1 ].count ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result9 = vc WITH noconstant (build2 (delivery->num_births[2 ].count ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result10 = vc WITH noconstant (build2 (delivery->num_births[3 ].count ,char (0 ) ) )
  ,protect
  DECLARE __sum_result11 = vc WITH noconstant (build2 (delivery->num_births[4 ].count ,char (0 ) ) )
  ,protect
  DECLARE __sum_result12 = vc WITH noconstant (build2 (delivery->num_mother_deliv[1 ].count ,char (0
     ) ) ) ,protect
  DECLARE __sum_result13 = vc WITH noconstant (build2 (delivery->num_mother_deliv[2 ].count ,char (0
     ) ) ) ,protect
  DECLARE __sum_result14 = vc WITH noconstant (build2 (delivery->num_mother_deliv[3 ].count ,char (0
     ) ) ) ,protect
  DECLARE __sum_result15 = vc WITH noconstant (build2 (delivery->num_mother_deliv[4 ].count ,char (0
     ) ) ) ,protect
  DECLARE __sum_result16 = vc WITH noconstant (build2 (delivery->num_nuliparous[1 ].count ,char (0 )
    ) ) ,protect
  DECLARE __sum_result17 = vc WITH noconstant (build2 (delivery->num_nuliparous[2 ].count ,char (0 )
    ) ) ,protect
  DECLARE __sum_result18 = vc WITH noconstant (build2 (delivery->num_nuliparous[3 ].count ,char (0 )
    ) ) ,protect
  DECLARE __sum_result19 = vc WITH noconstant (build2 (delivery->num_nuliparous[4 ].count ,char (0 )
    ) ) ,protect
  DECLARE __sum_result20 = vc WITH noconstant (build2 (delivery->greater_37_wks[1 ].count ,char (0 )
    ) ) ,protect
  DECLARE __sum_result21 = vc WITH noconstant (build2 (delivery->greater_37_wks[2 ].count ,char (0 )
    ) ) ,protect
  DECLARE __sum_result22 = vc WITH noconstant (build2 (delivery->greater_37_wks[3 ].count ,char (0 )
    ) ) ,protect
  DECLARE __sum_result23 = vc WITH noconstant (build2 (delivery->greater_37_wks[4 ].count ,char (0 )
    ) ) ,protect
  DECLARE __sum_result24 = vc WITH noconstant (build2 (delivery->less_1500_g[1 ].count ,char (0 ) )
   ) ,protect
  DECLARE __sum_result25 = vc WITH noconstant (build2 (delivery->less_1500_g[2 ].count ,char (0 ) )
   ) ,protect
  DECLARE __sum_result26 = vc WITH noconstant (build2 (delivery->less_1500_g[3 ].count ,char (0 ) )
   ) ,protect
  DECLARE __sum_result27 = vc WITH noconstant (build2 (delivery->less_1500_g[4 ].count ,char (0 ) )
   ) ,protect
  DECLARE __total_lbl = vc WITH noconstant (build2 (captions->total ,char (0 ) ) ) ,protect
  DECLARE __sum_result30 = vc WITH noconstant (build2 (delivery->tot_num_births ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result31 = vc WITH noconstant (build2 (delivery->tot_num_mother_deliv ,char (0 ) ) )
  ,protect
  DECLARE __sum_result32 = vc WITH noconstant (build2 (delivery->tot_num_nuliparous ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result33 = vc WITH noconstant (build2 (delivery->tot_greater_37_wks ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result34 = vc WITH noconstant (build2 (delivery->tot_less_1500_g ,char (0 ) ) ) ,
  protect
  IF ((ncalc = rpt_render ) )
   SET rptsd->m_flags = 32
   SET rptsd->m_borders = rpt_sdnoborders
   ...
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 1.313 ) ,(offsetx + 7.250 ) ,
    (offsety + 1.313 ) )
   SET rptsd->m_flags = 32
 ...
 SUBROUTINE  cesareansectionabs (ncalc ,offsetx ,offsety )
  ...
  DECLARE __cs_rate_lbl = vc WITH noconstant (build2 (captions->overall_cs_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result5 = vc WITH noconstant (build2 (delivery->tot_cs_rate ,char (0 ) ) ) ,protect
  DECLARE __repeat_vbac_lbl = vc WITH noconstant (build2 (captions->repeat_vbac ,char (0 ) ) ) ,
  protect
  ...
  DECLARE __live_37_lbl = vc WITH noconstant (build2 (captions->live_birth_beyond ,char (0 ) ) ) ,
  protect
  DECLARE __number_of_single_prior_cs_lbl = vc WITH noconstant (build2 (captions->num_single_prior_cs
     ,char (0 ) ) ) ,protect
  DECLARE __number_of_vbac_attempted_lbl = vc WITH noconstant (build2 (captions->num_vbac_attempt ,
    char (0 ) ) ) ,protect
  DECLARE __number_of_vbac_successful_lbl = vc WITH noconstant (build2 (captions->num_vbac_succ ,
    char (0 ) ) ) ,protect
  DECLARE __vbac_rate_prior_cs_lbl = vc WITH noconstant (build2 (captions->vbac_rate ,char (0 ) ) ) ,
  protect
  DECLARE __number_of_repeat_cs = vc WITH noconstant (build2 (captions->num_repeat_cs ,char (0 ) ) )
  ,protect
  DECLARE __sum_result15 = vc WITH noconstant (build2 (delivery->tot_prior_cs ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result16 = vc WITH noconstant (build2 (delivery->prior_single_cs ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result20 = vc WITH noconstant (build2 (delivery->prior_repeat_cs ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result23 = vc WITH noconstant (build2 (delivery->tot_prior_cs_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result24 = vc WITH noconstant (build2 (delivery->prior_repeat_cs_rate ,char (0 ) ) )
  ,protect
  DECLARE __sum_result25 = vc WITH noconstant (build2 (delivery->prior_single_cs_rate ,char (0 ) ) )
  ,protect
  DECLARE __primary_cesarean_section_lbl = vc WITH noconstant (build2 (captions->tot_primary_cs ,
    char (0 ) ) ) ,protect
  ...
  DECLARE __tot_prim_cs_lbl = vc WITH noconstant (build2 (captions->tot_primary_cs ,char (0 ) ) ) ,
  protect
  DECLARE __cpdftp_lbl = vc WITH noconstant (build2 (captions->cpd_ftp ,char (0 ) ) ) ,protect
  DECLARE __fetal_distress_lbl = vc WITH noconstant (build2 (captions->fetal_distress ,char (0 ) ) )
  ,protect
  DECLARE __malpresentation_lbl = vc WITH noconstant (build2 (captions->malpresentation ,char (0 ) )
   ) ,protect
  DECLARE __other_lbl = vc WITH noconstant (build2 (captions->other ,char (0 ) ) ) ,protect
  ...
  DECLARE __sum_result38 = vc WITH noconstant (build2 (delivery->tot_fetal_distress ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result39 = vc WITH noconstant (build2 (delivery->tot_malpresentation ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result40 = vc WITH noconstant (build2 (delivery->tot_reason_cs_other ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result41 = vc WITH noconstant (build2 (delivery->tot_prim_cs_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result42 = vc WITH noconstant (build2 (delivery->tot_cpd_ftp_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result43 = vc WITH noconstant (build2 (delivery->tot_fetal_distress_rate ,char (0 )
    ) ) ,protect
  DECLARE __sum_result44 = vc WITH noconstant (build2 (delivery->tot_malpresentation_rate ,char (0 )
    ) ) ,protect
  DECLARE __sum_result45 = vc WITH noconstant (build2 (delivery->tot_reason_cs_other_rate ,char (0 )
    ) ) ,protect
  DECLARE __sum_result0 = vc WITH noconstant (build2 (delivery->vbac_prior_cs_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result2 = vc WITH noconstant (build2 ((delivery->tot_vbac + delivery->tot_failed_vbac
     ) ,char (0 ) ) ) ,protect
  DECLARE __sum_result3 = vc WITH noconstant (build2 (delivery->vbac_attempt_rate ,char (0 ) ) ) ,
  protect
  ...
  DECLARE __c_singleton_lbl = vc WITH noconstant (build2 (captions->cs_del_sing ,char (0 ) ) ) ,
  protect
  DECLARE __c_rate_lbl = vc WITH noconstant (build2 (captions->cs_rate_sing ,char (0 ) ) ) ,protect
  DECLARE __stv_nopriorcs_lbl = vc WITH noconstant (build2 (captions->sing_vertext_no_prior ,char (0
     ) ) ) ,protect
  ...
  DECLARE __tot_births_lbl = vc WITH noconstant (build2 (captions->tot_births ,char (0 ) ) ) ,
  protect
  ...
  DECLARE __sum_result13 = vc WITH noconstant (build2 (delivery->live_birth_greater_37_wks ,char (0
     ) ) ) ,protect
  DECLARE __sum_result14 = vc WITH noconstant (build2 (delivery->cs_sing_term_ver_prim ,char (0 ) )
   ) ,protect
  DECLARE __sum_result17 = vc WITH noconstant (build2 (delivery->cs_sing_term_ver_prim_rt ,char (0 )
    ) ) ,protect
  DECLARE __sum_result7 = vc WITH noconstant (build2 (delivery->primips_tot_birth ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result8 = vc WITH noconstant (build2 (delivery->multips_tot_birth ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result9 = vc WITH noconstant (build2 (delivery->primips_tot_birth_cs ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result10 = vc WITH noconstant (build2 (delivery->multips_tot_birth_cs ,char (0 ) ) )
  ,protect
  DECLARE __sum_result11 = vc WITH noconstant (build2 (delivery->primips_tot_birth_cs_rate ,char (0
     ) ) ) ,protect
  DECLARE __sum_result12 = vc WITH noconstant (build2 (delivery->multips_tot_birth_cs_rate ,char (0
     ) ) ) ,protect
  DECLARE __number_prior_cs_lbl = vc WITH noconstant (build2 (captions->num_prior_cs ,char (0 ) ) ) ,
  protect
  IF ((ncalc = rpt_render ) )
   SET rptsd->m_flags = 32
   SET rptsd->m_borders = rpt_sdnoborders
   ...
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 0.344 ) ,(offsetx + 7.250 ) ,
    (offsety + 0.344 ) )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 3.282 ) ,(offsetx + 7.250 ) ,
    (offsety + 3.282 ) )
   SET _dummypen = uar_rptsetpen (_hreport ,_pen14s0c0 )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 0.657 ) ,(offsetx + 7.250 ) ,
    (offsety + 0.657 ) )
   ...
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 3.751 ) ,(offsety + 0.667 ) ,(offsetx + 3.751 ) ,
    (offsety + 3.271 ) )
   SET rptsd->m_y = (offsety + 0.438 )
   ...
   SET rptsd->m_height = 0.188
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,__sum_result25 )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 2.157 ) ,(offsetx + 7.250 ) ,
    (offsety + 2.157 ) )
   SET rptsd->m_flags = 32
   SET rptsd->m_y = (offsety + 0.750 )
   ...
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.251 ) ,(offsety + 0.333 ) ,(offsetx + 0.251 ) ,
    (offsety + 3.271 ) )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 7.240 ) ,(offsety + 0.344 ) ,(offsetx + 7.240 ) ,
    (offsety + 3.292 ) )
   SET rptsd->m_y = (offsety + 2.625 )
   SET rptsd->m_x = (offsetx + 3.250 )
   SET rptsd->m_width = 0.500
 ...
 SUBROUTINE  vaginal_sectionabs (ncalc ,offsetx ,offsety )
  ...
  DECLARE __tot_vag_lbl = vc WITH noconstant (build2 (captions->tot_vag_deliv ,char (0 ) ) ) ,
  protect
  ...
  DECLARE __tot_op_vag_del_lbl = vc WITH noconstant (build2 (captions->tot_op_vag_del ,char (0 ) ) )
  ,protect
  DECLARE __sum_result5 = vc WITH noconstant (build2 (delivery->num_vacuum_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result7 = vc WITH noconstant (build2 (delivery->num_forceps_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result9 = vc WITH noconstant (build2 (delivery->tot_op_vag_del_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result10 = vc WITH noconstant (build2 (delivery->tot_op_vag_del ,char (0 ) ) ) ,
  protect
  ...
  DECLARE __sum_result17 = vc WITH noconstant (build2 (delivery->num_for_vac_rate ,char (0 ) ) ) ,
  protect
  DECLARE __oxy_induct_lbl = vc WITH noconstant (build2 (captions->oxy_induct ,char (0 ) ) ) ,
  protect
  ...
  DECLARE __sum_result3 = vc WITH noconstant (build2 (delivery->oxytocin_inductions ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result4 = vc WITH noconstant (build2 (delivery->oxytocin_aug ,char (0 ) ) ) ,protect
  DECLARE __sum_result6 = vc WITH noconstant (build2 (delivery->oxytocin_total ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result8 = vc WITH noconstant (build2 (delivery->oxytocin_inductions_rate ,char (0 )
    ) ) ,protect
  DECLARE __sum_result12 = vc WITH noconstant (build2 (delivery->oxytocin_aug_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result14 = vc WITH noconstant (build2 (delivery->oxytocin_total_rate ,char (0 ) ) ) ,
  protect
  ...
  DECLARE __sum_result27 = vc WITH noconstant (build2 (delivery->3_degree_lac ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result28 = vc WITH noconstant (build2 (delivery->4_degree_lac ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result29 = vc WITH noconstant (build2 (delivery->tot_epid ,char (0 ) ) ) ,protect
  DECLARE __sum_result45 = vc WITH noconstant (build2 (delivery->tot_epis_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result30 = vc WITH noconstant (build2 (delivery->3_degree_lac_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result31 = vc WITH noconstant (build2 (delivery->4_degree_lac_rate ,char (0 ) ) ) ,
  protect
  DECLARE __sum_result32 = vc WITH noconstant (build2 (delivery->tot_epid_rate ,char (0 ) ) ) ,
  protect
  IF ((ncalc = rpt_render ) )
   SET rptsd->m_flags = 32
   SET rptsd->m_borders = rpt_sdnoborders
   ...
   SET _dummypen = uar_rptsetpen (_hreport ,_pen21s0c0 )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 0.407 ) ,(offsetx + 7.250 ) ,
    (offsety + 0.407 ) )
   SET rptsd->m_y = (offsety + 0.500 )
   ...
   SET rptsd->m_height = 0.188
   SET _fdrawheight = uar_rptstringdraw (_hreport ,rptsd ,__sum_result18 )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 0.730 ) ,(offsetx + 7.250 ) ,
    (offsety + 0.730 ) )
   SET rptsd->m_flags = 32
   SET rptsd->m_y = (offsety + 0.875 )
   SET rptsd->m_x = (offsetx + 0.313 )
   ...
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 0.406 ) ,(offsetx + 0.250 ) ,
    (offsety + 2.812 ) )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 7.240 ) ,(offsety + 0.396 ) ,(offsetx + 7.240 ) ,
    (offsety + 2.802 ) )
   SET _dummypen = uar_rptsetpen (_hreport ,_pen21s0c0 )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 0.250 ) ,(offsety + 2.791 ) ,(offsetx + 7.250 ) ,
    (offsety + 2.791 ) )
   SET _dummypen = uar_rptsetpen (_hreport ,_pen14s0c0 )
   SET _rptstat = uar_rptline (_hreport ,(offsetx + 3.750 ) ,(offsety + 0.740 ) ,(offsetx + 3.750 ) ,
    (offsety + 2.782 ) )
   SET rptsd->m_flags = 32
   SET rptsd->m_y = (offsety + 0.875 )
   SET rptsd->m_x = (offsetx + 3.813 )
 ...
 SET captions->csec_vbac = uar_i18ngetmessage (i18nhandle ,"cap19" ,
  "Cesarean Sections (C/S) and VBACs" )
 ...
 SET captions->num_vbac_attempt = uar_i18ngetmessage (i18nhandle ,"cap24" ,
  "Number of VBAC Attempted" )
 ...
 SET captions->live_birth_beyond = uar_i18ngetmessage (i18nhandle ,"cap29" ,
  "Live births beyond 37 weeks" )
 SET captions->cs_del_sing = uar_i18ngetmessage (i18nhandle ,"cap30" ,
  "C/S deliveries for Singleton, Term, Vertex, primips" )
 SET captions->cs_rate_sing = uar_i18ngetmessage (i18nhandle ,"cap31" ,
  "C/S rate for Singleton, Term, Vertex, primips" )
 ...
 SET captions->fetal_distress = uar_i18ngetmessage (i18nhandle ,"cap38" ,
  "Nonreassuring Fetal Status" )
 SET captions->malpresentation = uar_i18ngetmessage (i18nhandle ,"cap39" ,"Malpresentation" )
 SET captions->sing_vertext_no_prior = uar_i18ngetmessage (i18nhandle ,"cap40" ,
  "Singleton, Term, Vertex (No prior C/S)" )
 ...
 SET captions->num_for_vac = uar_i18ngetmessage (i18nhandle ,"cap49" ,
  "Number of Forceps with Vacuums*" )
 SET captions->num_forceps = uar_i18ngetmessage (i18nhandle ,"cap51" ,"Number of Forceps*" )
 SET captions->tot_op_vag_del = uar_i18ngetmessage (i18nhandle ,"cap52" ,
  "Total Operative Vaginal Deliveries*" )
 ...
 SET captions->epis_vag = uar_i18ngetmessage (i18nhandle ,"cap56" ,
  "Episiotomies (vaginal deliveries)" )
 ...
 DECLARE reason_for_csection = vc WITH protect ,constant (
 ...
 DECLARE augmentation_methods = vc WITH protect ,constant (
  "CERNER!6B69F0FC-5514-40A1-BBE4-EF20AAF35BE0" )
 DECLARE induction_methods = vc WITH protect ,constant (
  "CERNER!4D713327-956D-46E5-893B-8DAFA44336FE" )
 ...
 DECLARE labial_laceration = vc WITH protect ,constant (
  "CERNER!8CC89133-CAE8-4D22-AF0E-CE133E62B105" )
 DECLARE perineum_vaginal_laceration = vc WITH protect ,constant (
  "CERNER!1F964DAE-0971-46AA-B38C-B7710C1159D0" )
 DECLARE perineum_superficial_abrasion_laceration = vc WITH protect ,constant (
  "CERNER!6E9C03CA-CC3D-4D8E-BF6C-8B42A007083A" )
 DECLARE perineum_periurethral_laceration = vc WITH protect ,constant (
  "CERNER!F7BB6E59-D0EE-466B-AAAA-1524FDF7FBDC" )
 DECLARE perineum_perineal_laceration = vc WITH protect ,constant (
  "CERNER!6DEBAC89-5A20-4074-9698-EAD6A4E4ED0D" )
 DECLARE perineum_cervical_laceration = vc WITH protect ,constant (
 ...
 DECLARE episiotomy_other_information = vc WITH protect ,constant (
  "CERNER!919A00D1-41C2-4717-99E5-1D7147DF69A8" )
 DECLARE episiotomy_performed = vc WITH protect ,constant (
  "CERNER!155683DF-B118-4C15-B603-B750F3A6515F" )
 DECLARE episiotomy_mediolateral = vc WITH protect ,constant (
  "CERNER!D4413143-8122-45C7-BFB6-21608DAF7A1B" )
 DECLARE episiotomy_midline = vc WITH protect ,constant (
  "CERNER!1DD6481D-40C0-471C-8516-F8EE19469897" )
 DECLARE episiotomy_degree = vc WITH protect ,constant (
  "CERNER!93130FE6-0444-4DE2-90C4-DE2CD6A00493" )
 DECLARE cs_classical = vc WITH protect ,constant ("CERNER!1724ABB7-D497-435B-B75B-32551F5D81D5" )
 DECLARE cs_low_transverse = vc WITH protect ,constant (
  "CERNER!0FAD0F18-8F3E-4F64-9F4C-E60441303B90" )
 ...
 DECLARE cs_forcep_and_vacuum = vc WITH protect ,constant (
  "CERNER!72919051-F018-4D12-8227-A487C6893755" )
 ...
 DECLARE vag_forcep_and_vacuum = vc WITH protect ,constant (
  "CERNER!4419660E-009A-4448-B9BF-7EBD880E0943" )
 DECLARE vag_forcep_assist = vc WITH protect ,constant (
  "CERNER!B3426C74-7ABE-4F02-A42B-6AD6526C67C2" )
 DECLARE vag_vacuum_assist = vc WITH protect ,constant (
  "CERNER!02D13740-3BB0-4128-93A0-63A01335D2C4" )
 DECLARE live_birth = vc WITH protect ,constant ("CERNER!ASYr9AEYvUr1YoRYCqIGfQ" )
 DECLARE oxytocin_infusion = vc WITH protect ,constant (
  "CERNER!8305C18A-8356-4AAF-8AC2-385F3A15F4B4" )
 ...
 DECLARE placental_abruption = vc WITH protect ,constant (
  "CERNER!FAB4E54E-B9A5-46DE-960B-9280C9C40930" )
 DECLARE active_herpes = vc WITH protect ,constant ("CERNER!5A47205D-2007-4E9D-BC1C-80522A2E7727" )
 DECLARE multiple_gestation = vc WITH protect ,constant (
  "CERNER!1D2AA6BE-AD65-4018-AC99-FE5D39E64FAD" )
 DECLARE placenta_previa = vc WITH protect ,constant ("CERNER!716D2FC1-F633-4FCA-BD2C-9012442DB080"
  )
 DECLARE elective_repeat_csection = vc WITH protect ,constant (
  "CERNER!5D8BD6FD-2DE0-4135-98F9-E6C6F4ED5696" )
 DECLARE failed_vbac = vc WITH protect ,constant ("CERNER!84E7499B-5650-4866-84B3-F088EC2AA6C4" )
 DECLARE lack_of_descent_of_fetal_head = vc WITH protect ,constant (
  "CERNER!54BD0F94-EC0A-4814-B11D-6B0BB8ED77CA" )
 DECLARE lack_of_progressive_cervical_dilation = vc WITH protect ,constant (
  "CERNER!455A4910-20E2-4C37-881B-87A5CA612FF9" )
 DECLARE malpresentation = vc WITH protect ,constant ("CERNER!86A9AC4B-960C-48ED-AE9D-8499E2329F89"
  )
 DECLARE maternal_hemorrhage = vc WITH protect ,constant (
  "CERNER!3B6DF751-4DD2-49CB-863F-F9427DC7F6F6" )
 DECLARE nonreassuring_fetal_status = vc WITH protect ,constant (
  "CERNER!18F519CC-9A7E-4033-ACCF-FF0DA852BB3D" )
 DECLARE cephalopelvic_disproportion = vc WITH protect ,constant (
  "CERNER!2A855FF2-B346-446E-A28A-DC8D4A504364" )
 ...
 SELECT INTO "nl:"
  FROM (code_value cv )
  PLAN (cv
   WHERE (cv.code_set IN (birth_dt_tm_cs1 ,
   birth_dt_tm_cs2 ,
   birth_dt_tm_cs3 ) )
  ...
  SELECT
   IF ((preg_org_sec_ind = 1 ) )
    ...
    PLAN (pi
     ...
     AND expand (org_idx ,1 ,size (preg_sec_orgs->qual ,5 ) ,(e.organization_id + 0 ) ,preg_sec_orgs
      ->qual[org_idx ].org_id ) )
     JOIN (ced
   ...
   HEAD pi.pregnancy_id
    preg_cnt = (preg_cnt + 1 ) ,
    IF ((preg_cnt > size (delivery->rec ,5 ) ) ) stat1 = alterlist (delivery->rec ,(preg_cnt + 99 )
      )
    ENDIF
    ,
    IF ((preg_cnt > size (dcp_request->pregnancy_list ,5 ) ) ) stat2 = alterlist (dcp_request->
      pregnancy_list ,(preg_cnt + 99 ) )
    ENDIF
    ,delivery->rec[preg_cnt ].pregnancy_id = pi.pregnancy_id ,delivery->rec[preg_cnt ].person_id = pi
    .person_id ,delivery->rec[preg_cnt ].encntr_id = ce.encntr_id ,dcp_request->pregnancy_list[
   ...
   FOOT  pi.pregnancy_id
    IF ((del_cnt = 1 ) ) delivery->num_births[1 ].count = (delivery->num_births[1 ].count + del_cnt
     ) ,delivery->num_mother_deliv[1 ].count = (delivery->num_mother_deliv[1 ].count + 1 )
    ELSEIF ((del_cnt = 2 ) ) delivery->num_births[2 ].count = (delivery->num_births[2 ].count +
     del_cnt ) ,delivery->num_mother_deliv[2 ].count = (delivery->num_mother_deliv[2 ].count + 1 )
    ELSEIF ((del_cnt = 3 ) ) delivery->num_births[3 ].count = (delivery->num_births[3 ].count +
     del_cnt ) ,delivery->num_mother_deliv[3 ].count = (delivery->num_mother_deliv[3 ].count + 1 )
    ELSE delivery->num_births[4 ].count = (delivery->num_births[4 ].count + del_cnt ) ,delivery->
     num_mother_deliv[4 ].count = (delivery->num_mother_deliv[4 ].count + 1 )
    ENDIF
    ,delivery->tot_num_births = (delivery->tot_num_births + del_cnt ) ,delivery->tot_num_mother_deliv
     = (delivery->tot_num_mother_deliv + 1 )
   FOOT REPORT
  ...
  SELECT
   IF ((preg_org_sec_ind = 1 ) )
    ...
    PLAN (pi
     ...
     JOIN (e
     WHERE (e.encntr_id = ce.encntr_id )
     AND expand (org_idx ,1 ,size (org->rec ,5 ) ,(e.organization_id + 0 ) ,org->rec[org_idx ].
      organization_id )
     AND expand (org2_idx ,1 ,size (preg_sec_orgs->qual ,5 ) ,(e.organization_id + 0 ) ,preg_sec_orgs
      ->qual[org2_idx ].org_id ) )
     JOIN (ced
     WHERE (ced.ce_dynamic_label_id = ce.ce_dynamic_label_id ) )
     JOIN (cdt
     WHERE (cdt.event_id = ce.event_id )
 ...
 SELECT INTO "nl:"
  ...
  PLAN (d1
   ...
   AND (cv.code_set IN (birth_dt_tm_cs1 ,
   birth_dt_tm_cs2 ,
   birth_dt_tm_cs3 ) )
  ...
  HEAD d2.seq
   del_cnt = del_cnt
  HEAD ced.label_name
   IF ((ced.label_name = delivery->rec[d1.seq ].baby[d2.seq ].label_name ) ) del_cnt = (del_cnt + 1
    )
   ENDIF
  HEAD cv.concept_cki
   IF ((ced.label_name = delivery->rec[d1.seq ].baby[d2.seq ].label_name ) )
    IF ((cv.concept_cki = birth_weight ) )
     IF ((ce.result_units_cd = g_cd ) )
      IF ((cnvtreal (ce.result_val ) < 1500 ) ) wt_1500_cnt = (wt_1500_cnt + 1 )
      ENDIF
     ELSEIF ((ce.result_units_cd = kg_cd ) )
      IF (((cnvtreal (ce.result_val ) * 1000 ) < 1500 ) ) wt_1500_cnt = (wt_1500_cnt + 1 )
      ENDIF
     ELSEIF ((ce.result_units_cd = lb_cd ) )
      IF (((cnvtreal (ce.result_val ) * lb_to_kg ) < 1500 ) ) wt_1500_cnt = (wt_1500_cnt + 1 )
      ENDIF
     ENDIF
    ELSEIF ((cv.concept_cki = delivery_type ) )
     IF ((n.concept_cki = vag_forcep_assist ) ) delivery->tot_vag = (delivery->tot_vag + 1 ) ,
      delivery->num_forceps = (delivery->num_forceps + 1 ) ,delivery->tot_op_vag_del = (delivery->
      tot_op_vag_del + 1 ) ,delivery->rec[d1.seq ].baby[d2.seq ].vag_ind = 1
     ELSEIF ((n.concept_cki = vag_forcep_and_vacuum ) ) delivery->tot_vag = (delivery->tot_vag + 1 )
     ,delivery->num_for_vac = (delivery->num_for_vac + 1 ) ,delivery->tot_op_vag_del = (delivery->
      tot_op_vag_del + 1 ) ,delivery->rec[d1.seq ].baby[d2.seq ].vag_ind = 1
     ELSEIF ((n.concept_cki = vag_vacuum_assist ) ) delivery->tot_vag = (delivery->tot_vag + 1 ) ,
      delivery->num_vacuum = (delivery->num_vacuum + 1 ) ,delivery->tot_op_vag_del = (delivery->
      tot_op_vag_del + 1 ) ,delivery->rec[d1.seq ].baby[d2.seq ].vag_ind = 1
     ELSEIF ((n.concept_cki = vag ) ) delivery->tot_vag = (delivery->tot_vag + 1 ) ,delivery->rec[d1
      .seq ].baby[d2.seq ].vag_ind = 1
     ...
     cs_forcep_assist ,
     cs_j_incision ,
     cs_vacuum_assist ) ) ) delivery->rec[d1.seq ].baby[d2.seq ].cs_ind = 1 ,delivery->rec[d1.seq ].
      cs_ind = 1
     ENDIF
    ELSEIF ((cv.concept_cki = neonate_outcome ) )
     IF ((n.concept_cki = live_birth ) ) delivery->rec[d1.seq ].baby[d2.seq ].live_birth_ind = 1
     ENDIF
    ENDIF
   ENDIF
  ...
  DETAIL
   IF ((reas_ind = 0 ) )
    IF ((cv.concept_cki = reason_for_csection ) )
     IF ((n.concept_cki = failed_vbac ) ) delivery->tot_failed_vbac = (delivery->tot_failed_vbac + 1
      )
     ELSEIF ((n.concept_cki IN (lack_of_descent_of_fetal_head ,
     lack_of_progressive_cervical_dilation ,
     cephalopelvic_disproportion ) ) )
      IF ((cpd_ftp_ind = 0 ) ) delivery->tot_cpd_ftp = (delivery->tot_cpd_ftp + 1 )
      ENDIF
      ,cpd_ftp_ind = 1
     ELSEIF ((n.concept_cki = malpresentation ) ) delivery->tot_malpresentation = (delivery->
      tot_malpresentation + 1 )
     ELSEIF ((n.concept_cki = nonreassuring_fetal_status ) ) delivery->tot_fetal_distress = (delivery
      ->tot_fetal_distress + 1 )
    ...
    IF ((delivery->rec[d1.seq ].baby[d2.seq ].vag_ind = 1 ) )
     IF ((cv.concept_cki = augmentation_methods ) )
      IF ((n.concept_cki = oxytocin_infusion ) ) aug_oxy_ind = 1
      ENDIF
     ELSEIF ((cv.concept_cki = induction_methods ) )
      IF ((n.concept_cki = oxytocin_infusion ) ) ind_oxy_ind = 1
      ENDIF
     ENDIF
    ENDIF
   ENDIF
  FOOT  ce.event_end_dt_tm
   IF ((cv.concept_cki = reason_for_csection ) ) reas_ind = 1
   ENDIF
  FOOT  d1.seq
   IF ((del_cnt = 1 ) ) delivery->less_1500_g[1 ].count = (delivery->less_1500_g[1 ].count +
    wt_1500_cnt )
   ELSEIF ((del_cnt = 2 ) ) delivery->less_1500_g[2 ].count = (delivery->less_1500_g[2 ].count +
    wt_1500_cnt )
   ELSEIF ((del_cnt = 3 ) ) delivery->less_1500_g[3 ].count = (delivery->less_1500_g[3 ].count +
    wt_1500_cnt )
   ...
   IF ((aug_oxy_ind = 1 ) ) delivery->oxytocin_aug = (delivery->oxytocin_aug + 1 ) ,delivery->
    oxytocin_total = (delivery->oxytocin_total + 1 )
   ENDIF
   ,
   IF ((ind_oxy_ind = 1 ) ) delivery->oxytocin_inductions = (delivery->oxytocin_inductions + 1 ) ,
 ...
 SELECT INTO "nl:"
  ...
  HEAD cv.concept_cki
   IF ((n.concept_cki = epidural ) ) delivery->tot_epid = (delivery->tot_epid + 1 )
   ENDIF
   ,
  ...
  DETAIL
   IF ((size (delivery->rec[d1.seq ].baby ,5 ) > 0 ) )
    IF ((cv.concept_cki = para ) ) para_ind = 1 ,
     IF ((ce.event_end_dt_tm < delivery->rec[d1.seq ].baby[1 ].delivery_dt_tm ) )
      IF ((ce.result_val = "0" ) )
       IF ((size (delivery->rec[d1.seq ].baby ,5 ) = 1 ) ) delivery->num_nuliparous[1 ].count = (
        delivery->num_nuliparous[1 ].count + 1 )
       ELSEIF ((size (delivery->rec[d1.seq ].baby ,5 ) = 2 ) ) delivery->num_nuliparous[2 ].count = (
        delivery->num_nuliparous[2 ].count + 1 )
       ELSEIF ((size (delivery->rec[d1.seq ].baby ,5 ) = 3 ) ) delivery->num_nuliparous[3 ].count = (
        delivery->num_nuliparous[3 ].count + 1 )
       ELSEIF ((size (delivery->rec[d1.seq ].baby ,5 ) > 3 ) ) delivery->num_nuliparous[4 ].count = (
        delivery->num_nuliparous[4 ].count + 1 )
       ENDIF
      ENDIF
     ENDIF
    ENDIF
   ENDIF
   ,
   IF ((cv.concept_cki = gravida ) ) gravida_cnt = (gravida_cnt + 1 ) ,
    IF ((ce.result_val = "1" )
    AND (gravida_cnt = 1 ) ) delivery->rec[d1.seq ].primip_ind = 1
    ELSE delivery->rec[d1.seq ].primip_ind = 0
    ENDIF
   ENDIF
   ,
   IF ((cv.concept_cki = presenting_part ) )
    IF ((ver_ind = 0 ) )
     IF ((n.concept_cki = vertex ) )
      IF ((size (delivery->rec[d1.seq ].baby ,5 ) > 0 ) ) delivery->rec[d1.seq ].baby[1 ].vertex_ind
       = 1
      ENDIF
      ,ver_ind = 1
     ENDIF
   ...
   ENDIF
   ,
   IF ((cv.concept_cki = perineum_perineal_laceration ) )
   ...
   ENDIF
  FOOT  ce.encntr_id
   delivery->tot_epis = (delivery->tot_epis + epis_ind ) ,delivery->3_degree_lac = (delivery->
   3_degree_lac + 3d_ind ) ,delivery->4_degree_lac = (delivery->4_degree_lac + 4d_ind ) ,
   IF ((para_ind = 0 ) )
    IF ((size (delivery->rec[d1.seq ].baby ,5 ) = 1 ) ) delivery->num_nuliparous[1 ].count = (
     delivery->num_nuliparous[1 ].count + 1 )
    ELSEIF ((size (delivery->rec[d1.seq ].baby ,5 ) = 2 ) ) delivery->num_nuliparous[2 ].count = (
   ...
   ENDIF
  FOOT REPORT
   delivery->tot_num_nuliparous = (((delivery->num_nuliparous[1 ].count + delivery->num_nuliparous[2
   ].count ) + delivery->num_nuliparous[3 ].count ) + delivery->num_nuliparous[4 ].count )
  WITH nocounter
 ;end select
 ...
 ELSE
  EXECUTE pcm_wh_get_final_ega WITH replace ("REQUEST" ,dcp_request ) ,
  replace ("REPLY" ,dcp_reply )
 ENDIF
 ...
 SELECT INTO "nl:"
  ...
  HEAD pc.pregnancy_child_id
   ...
   AND (delivery->rec[d1.seq ].pregnancy_id = pc.pregnancy_id ) ) delivery->rec[d1.seq ].
    gest_age_grtr_37_ind = gest_age_37wk_ind
   ENDIF
   ,
  ...
  FOOT  d1.seq
   IF ((prev_cs_cnt = 1 ) ) delivery->prior_single_cs = (delivery->prior_single_cs + 1 ) ,delivery->
    tot_prior_cs = (delivery->tot_prior_cs + 1 )
   ELSEIF ((prev_cs_cnt > 1 ) ) delivery->prior_repeat_cs = (delivery->prior_repeat_cs + 1 ) ,
 ...
 FOR (current_cnt = 1 TO size (delivery->rec ,5 ) )
  ...
  AND (delivery->rec[current_cnt ].cs_ind = 1 ) )
   SET delivery->tot_prim_cs = (delivery->tot_prim_cs + 1 )
  ENDIF
  FOR (baby_cnt = 1 TO size (delivery->rec[current_cnt ].baby ,5 ) )
   IF ((delivery->rec[current_cnt ].baby[baby_cnt ].vag_ind = 1 )
   AND (delivery->rec[current_cnt ].prev_cs_ind > 0 ) )
 ...
 SET delivery->vbac_attempt_rate = rate_per ((delivery->tot_vbac + delivery->tot_failed_vbac ) ,
  delivery->tot_num_births )
 ...
 SET delivery->tot_fetal_distress_rate = rate_per (delivery->tot_fetal_distress ,delivery->
  tot_num_births )
 SET delivery->tot_malpresentation_rate = rate_per (delivery->tot_malpresentation ,delivery->
  tot_num_births )
 SET delivery->tot_reason_cs_other_rate = rate_per (delivery->tot_reason_cs_other ,delivery->
  tot_num_births )
 SET delivery->cs_sing_term_ver_prim_rt = rate_per (delivery->cs_sing_term_ver_prim ,delivery->
  tot_num_births )
 SET delivery->primips_tot_birth_cs_rate = rate_per (delivery->primips_tot_birth_cs ,delivery->
  primips_tot_birth )
 SET delivery->multips_tot_birth_cs_rate = rate_per (delivery->multips_tot_birth_cs ,delivery->
  multips_tot_birth )
