...
and ce.encntr_id = 125348890.00
;and ea.alias = '2118703131'
...
select ce.event_cd, ce.result_val, ce.event_end_dt_tm,ce.verified_prsnl_id, ce.*
 from clinical_event ce where ce.encntr_id = 125199206
...
where pa.encntr_id = 125359334 ;Devgrp               

select * ;pa.encntr_id, pa.alert_source, pa.alert_txt, pa.passive_alert_id, pa.updt_dt_tm
from passive_alert pa 
where pa.updt_dt_tm >= cnvtdatetime('28-JUN-2022 00:00:00')
...
select * from orders o where o.encntr_id = 125451665       
and o.updt_dt_tm >= cnvtdatetime('01-JUL-2022 00:00:00')
